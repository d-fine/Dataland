...
/**
 * This class handles responses for all errors that have not been handled yet. It implements a
 * fallback responder that responds with internal server errors
 */
@Order
@ControllerAdvice
class UnknownErrorControllerAdvice(
  @Value("\${dataland.expose-error-stack-trace-to-api:false}") val trace: Boolean
) {
  private val logger = LoggerFactory.getLogger(javaClass)

  /**
   * Handles all exceptions returning a generic Internal server error response. This is intended as
