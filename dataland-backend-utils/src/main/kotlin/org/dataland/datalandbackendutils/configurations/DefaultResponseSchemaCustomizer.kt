...
/**
 * This class ensures that the errorResponse is mapped as the default response for non-explicitly
 * set response codes as suggested in the swagger-docs (ref
...
class DefaultResponseSchemaCustomizer : OpenApiCustomizer {
  ...
  // All errors follow the default errorApiResponse except for the 401 error which only returns the
  // error in the
