...
/**
 * An InternalServerErrorApiException should be thrown if something went terribly wrong on Datalands
 * side. It will be returned as a 500 error. publicSummary and publicMessage will be displayed to
 * the user, internalMessage and internalCause will only be displayed in development mode
 */
