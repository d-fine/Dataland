...
/**
 * A ResourceNotFoundApiException should be thrown if a dataland-internal resource could not be
 * located Both message and summary are displayed to the user with a 404 status code
 */
