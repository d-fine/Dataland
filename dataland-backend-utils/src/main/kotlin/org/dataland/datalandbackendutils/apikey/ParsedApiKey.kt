...
/**
 * --- Non-API model --- Class for defining the values which are derived from a received API key
 *
 ...
 */
data class ParsedApiKey(val keycloakUserId: String, val apiKeySecret: String)
