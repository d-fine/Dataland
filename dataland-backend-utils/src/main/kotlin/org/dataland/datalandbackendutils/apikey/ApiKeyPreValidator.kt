...
class ApiKeyPreValidator { // TODO not too happy with that name
    ...
    val minPossibleCrc32Value = 0
    val maxPossibleCrc32Value = 4294967295
    ...
    val validateApiKeyDelimitersExceptionMessage = "The received Api key does not contain exactly two underscore characters " +
            "as it is expected."
    val validateKeycloakUserIdExceptionMessage = "The encoded user Id derived from the received Api key does not fulfill " +
            "the Base64 format."
    val validateApiKeySecretExceptionMessage = "The Api key secret derived from the received Api key either " +
            "contains non-Hex characters, or it does not have exactly 80 characters."
    val validateCrc32ValueNoValidNumberExceptionMessage = "The CRC-32 value derived from the received Api key is not a valid number."
    val validateCrc32ValueOutOfRangeExceptionMessage = "The CRC-32 value derived from the received Api key is out of the " +
            "expected range."
    val validateApiKeyChecksumWrongValueExceptionMessage = "The cyclic redundancy check for the provided Api-Key failed. " +
