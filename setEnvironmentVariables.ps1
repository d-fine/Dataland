...
# Only needed in CD.yaml - or if you are working on Grafana alerts [Environment]::SetEnvironmentVariable("TARGETSERVER_URL", "local-dev.dataland.com", [System.EnvironmentVariableTarget]::User)
