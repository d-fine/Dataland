...
[Environment]::SetEnvironmentVariable("NOTIFICATION_INTERNAL_RECEIVERS", "dummy.mail@dataland.com", [System.EnvironmentVariableTarget]::User)
[Environment]::SetEnvironmentVariable("NOTIFICATION_INTERNAL_CC", "dummy.mail2@dataland.com", [System.EnvironmentVariableTarget]::User)
