...
[Environment]::SetEnvironmentVariable("NOTIFICATION_INTERNAL_RECEIVERS_DATA_REQUEST", "dummy.mail@dataland.com", [System.EnvironmentVariableTarget]::User)
[Environment]::SetEnvironmentVariable("NOTIFICATION_INTERNAL_CC_DATA_REQUEST", "dummy.mail2@dataland.com", [System.EnvironmentVariableTarget]::User)
