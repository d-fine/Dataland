...
# If needed (to test EurDat Integration) - set to Value that can be found in internal wiki [Environment]::SetEnvironmentVariable("TARGETSERVER_STARTUP_URL", "${{ vars.TARGETSERVER_STARTUP_URL }}", [System.EnvironmentVariableTarget]::User)
