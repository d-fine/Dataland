...
# SET to an email address you can access or leave it as is [Environment]::SetEnvironmentVariable("NOTIFICATION_RECEIVERS_BULK_DATA_REQUEST", "dev.null@dataland.com", [System.EnvironmentVariableTarget]::User)
# SET to an email address you can access or leave it as is [Environment]::SetEnvironmentVariable("NOTIFICATION_RECEIVERS_CC_BULK_DATA_REQUEST", "dev.null@dataland.com", [System.EnvironmentVariableTarget]::User)
...
# Only needed in CD.yaml - no need to set locally [Environment]::SetEnvironmentVariable("TARGETSERVER_STARTUP_URL", "", [System.EnvironmentVariableTarget]::User)
