...
[Environment]::SetEnvironmentVariable("KEY_STORE_FILE_PASSWORD", "kjOsdlUas7129rdPjfskwLc12dcxiYj3", [System.EnvironmentVariableTarget]::User)
[Environment]::SetEnvironmentVariable("QUARKUS_HTTP_SSL_CERTIFICATE_KEY_STORE_PASSWORD", "kjOsdlUas7129rdPjfskwLc12dcxiYj3", [System.EnvironmentVariableTarget]::User)
[Environment]::SetEnvironmentVariable("QUARKUS_OIDC_CLIENT_CREDENTIALS_JWT_KEY_PASSWORD", "kjOsdlUas7129rdPjfskwLc12dcxiYj3", [System.EnvironmentVariableTarget]::User)
[Environment]::SetEnvironmentVariable("QUARKUS_OIDC_CLIENT_CREDENTIALS_JWT_KEY_STORE_PASSWORD", "kjOsdlUas7129rdPjfskwLc12dcxiYj3", [System.EnvironmentVariableTarget]::User)
[Environment]::SetEnvironmentVariable("QUARKUS_OIDC_CLIENT_TLS_TRUST_STORE_PASSWORD", "test@123s", [System.EnvironmentVariableTarget]::User)
[Environment]::SetEnvironmentVariable("QUARKUS_REST_CLIENT_TRUST_STORE_PASSWORD", "test@123", [System.EnvironmentVariableTarget]::User)
