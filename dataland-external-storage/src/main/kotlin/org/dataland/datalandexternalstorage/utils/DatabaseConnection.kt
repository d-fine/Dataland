...
object DatabaseConnection {
  ...
  /**
   * The method prepares and executes a sql statement to insert a pair of dataId data into an
   * external database
   *
  ...
  fun insertDataIntoSqlDatabase(
    ...
    val successFlag =
      executeSqlInsertStatement(preparedStatement, "Data for $dataId was inserted successfully.")
    conn.close()
    return successFlag
  }

  /**
   * The method prepares and executes a sql statement to insert a pair of documentId and document
