    ...
    <table role="presentation" style="border-collapse:separate;line-height:100%;">
        <tr>
            <td role="presentation"
                style="border:none;border-radius:6px;cursor:auto;padding:11px 20px;background:#ff6813;">
                <a href="${msg(link)}"
                   style="background:#ff6813;color:#ffffff;font-family:Helvetica, sans-serif;font-weight:600;line-height:120%;Margin:0;text-decoration:none;text-transform:none;"
                   target="_blank">
                    RESET PASSWORD
                </a>
            </td>
