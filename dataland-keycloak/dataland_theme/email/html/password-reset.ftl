...
<@layout.emailLayout>
    ...
    <p>Hi,<br>
        ...
        We received a request to reset the password for your Dataland account.<br>
        <br>
        To reset your password, click on the button below. This link is valid for ${msg(linkExpirationFormatter(linkExpiration))}.
    </p>
