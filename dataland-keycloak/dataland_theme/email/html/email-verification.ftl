<html>
<body>
${kcSanitize(msg("emailVerificationBodyHtml1", realmName))?no_esc}
...
${kcSanitize(msg("emailVerificationBodyHtml2", linkExpiration, linkExpirationFormatter(linkExpiration)))?no_esc}
</body>
</html>
