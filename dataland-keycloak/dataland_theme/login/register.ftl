        ...
        <form id="kc-register-form" class="${properties.kcFormClass!}" action="${url.registrationAction}" method="post">
            <div class="${properties.kcFormGroupClass!}">
				...
				<div class="input-group">
					<input type="text" id="firstName" class="${properties.kcInputClass!}" name="firstName"
                           value="${(register.formData.firstName!'')}" required type="text"
                           aria-invalid="<#if messagesPerField.existsError('firstName')>true</#if>"
					/>
					<span class="highlight"></span>
					<span class="bar"></span>
					<label for="firstName" class="${properties.kcLabelClass!} control-label">${msg("firstName")}</label>
            ...
            <div class="${properties.kcFormGroupClass!}">                
				<div class="input-group">
					...
					<span class="highlight"></span>
					<span class="bar"></span>
					<label for="lastName" class="${properties.kcLabelClass!} control-label">${msg("lastName")}</label>
            ...
            <div class="${properties.kcFormGroupClass!}">
                ...
                <div id="kc-form-buttons" class="${properties.kcFormButtonsClass!}">
                    <input class="${properties.kcButtonClass!} ${properties.kcButtonPrimaryClass!} ${properties.kcButtonBlockClass!} ${properties.kcButtonLargeClass!}" style="width: 300px; margin:auto" type="submit" value="${msg("doRegister")}"/>
                </div>
