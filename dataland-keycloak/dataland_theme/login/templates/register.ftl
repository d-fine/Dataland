...
<@layout.registrationLayout displayMessage=!messagesPerField.existsError('email','username','password','password-confirm'); section>
    ...
    <#elseif section = "form">
        ...
        <script>
            ...
            let previousAutoGeneratedUsername = "";

            function usernameIsPreviousAutoUsername() {
                return previousAutoGeneratedUsername
                    === undefined || username.value === previousAutoGeneratedUsername;
            }

            function updateUserNameFromFirstNameLastName () {
                if (firstName.value !== "" && lastName.value !== "") {
                    if (usernameIsPreviousAutoUsername()) {
                        username.value = firstName.value + "_" + lastName.value;
                        previousAutoGeneratedUsername = username.value;
                    }
