...
<@layout.registrationLayout displayMessage=false; section>
    ...
    <#elseif section = "form">
        ...
        <div class="text-left mt-4 flex align-items-center">
            ...
            <label for="accept_terms" class="tex-sm ml-2">*I agree with the <a class="text-primary" href="/terms" target="_blank">Terms and Conditions</a></label>
        </div>
        ...
        <div class="text-left mt-4 flex align-items-center">
            ...
            <label for="accept_privacy" class="tex-sm ml-2">*I accept the <a class="text-primary" href="/dataprivacy" target="_blank">Privacy Policy</a></label>
        </div>
