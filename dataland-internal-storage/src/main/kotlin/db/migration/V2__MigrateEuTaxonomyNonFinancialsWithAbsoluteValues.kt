...
/**
 * This migration script updates the EU Taxonomy for non-financials data model switching from a
 * field called value for percentages only to a structure holding the absolute value of a cash flow
 * type as well
 */
class V2__MigrateEuTaxonomyNonFinancialsWithAbsoluteValues : BaseJavaMigration() {
  ...
  private val fieldsToMigrate =
    mapOf("alignedPercentage" to "alignedData", "eligiblePercentage" to "eligibleData")
  ...
  override fun migrate(context: Context?) {
    migrateCompanyAssociatedDataOfDatatype(
      ...
      this::migrateEuTaxonomyNonFinancialsData,
    )
  }
}
