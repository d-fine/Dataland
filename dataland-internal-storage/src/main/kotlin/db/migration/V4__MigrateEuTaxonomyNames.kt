...
/**
 * This migration script updates the existing eutaxonomy datasets to be in line again with the
 * dataDictionary after two fields have been renamed
 */
class V4__MigrateEuTaxonomyNames : BaseJavaMigration() {
  ...
  private val dataTypesToMigrate = listOf("eutaxonomy-non-financials", "eutaxonomy-financials")
