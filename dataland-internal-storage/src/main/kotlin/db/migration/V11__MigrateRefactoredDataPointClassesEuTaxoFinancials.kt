...
/**
 * Performs the migration of the refactored data point classes for the eu taxonomy non fiancials
 * framework
 */
class V11__MigrateRefactoredDataPointClassesEuTaxoFinancials : BaseJavaMigration() {
  ...
  fun migrateRefactoredDataPointClasses(dataTableEntity: DataTableEntity) {
    ...
    migrationHelper.migrateAssurance(
      ...
      migrationHelper,
      framework = "euTaxonomyFinancials",
    )
    ...
    accessTwoLayeredDataSourceForMultipleMigrations(
      dataObject,
      oldToNewFieldNamesForDocuments,
      migrationHelper,
    )
    accessThreeLayeredDataSourceForMultipleMigrations(
      dataObject,
      oldToNewFieldNamesForDocuments,
      migrationHelper,
    )
