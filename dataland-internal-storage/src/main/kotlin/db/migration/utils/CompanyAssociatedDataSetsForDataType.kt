  ...
  while (getQueryResultSet.next()) {
    companyAssociatedDatasets.add(
      DataTableEntity(
        ...
        JSONObject(objectMapper.readValue(getQueryResultSet.getString("data"), String::class.java)),
      )
    )
  }
 ...
 *
 * @context the context of the migration script @dataType the data type string for the data to
 *   modify
