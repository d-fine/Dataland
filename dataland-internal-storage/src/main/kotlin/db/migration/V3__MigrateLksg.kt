...
/**
 * This migration script updates the existing LkSG datasets to be in line again with the
 * dataDictionary
 */
class V3__MigrateLksg : BaseJavaMigration() {
  private val mapOfOldToNewFieldNames =
    mapOf(
      ...
      "employmentUnderLocalMinimumAgePrevention" to
  ...
  private val newFieldsWithUploadButtonIfYes =
    listOf("smetaSocialAuditConcept", "codeOfConduct", "policyStatement")
  ...
  private fun writeToTemporaryDataset(
    ...
    subcategories.forEach { subcategory ->
      val subcategoryObject =
        (categoryObject.getOrJavaNull(subcategory) ?: return@forEach) as JSONObject
