  ...
  fun `check migration script for Non Financial with no changes`() {
    TestUtils()
      .testMigrationOfSingleDataset(
        ...
        { dataTableEntity ->
          V18__CompleteListOfReferencedReports()
            .migrateReferencedReports(dataTableEntity, EUTAXONOMY_NON_FINANCIALS)
        },
      )
  }
  ...
  fun `check migration script for Financial with no changes`() {
    TestUtils()
      .testMigrationOfSingleDataset(
        ...
        { dataTableEntity ->
          V18__CompleteListOfReferencedReports()
            .migrateReferencedReports(dataTableEntity, EUTAXONOMY_FINANCIALS)
        },
      )
  }
