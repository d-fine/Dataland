...
class DatabaseCredentialController(
  @Value("\${dummy.eurodat.db.postgres-db}") private val postgresDb: String,
  @Value("\${dummy.eurodat.db.postgres-user}") private val postgresUser: String,
  @Value("\${dummy.eurodat.db.postgres-password}") private val postgresPassword: String,
  ...
  override fun apiV1ClientControllerCredentialServiceDatabaseSafedepositAppIdGet(
    appId: String
  ): ResponseEntity<Credentials> {
    return ResponseEntity.ok(credentials)
  }

  override fun apiV1ClientControllerCredentialServiceDatabaseExternalTransactionIdGet(
