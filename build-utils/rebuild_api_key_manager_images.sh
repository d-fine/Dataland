...
./build-utils/base_rebuild_single_docker_image.sh dataland_api_key_manager_base ./dataland-api-key-manager/DockerfileBase "dataland-api-key-manager:assemble" $dependencies
