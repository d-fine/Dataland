...
./build-utils/base_rebuild_single_docker_image.sh dataland_api_key_manager_base ./dataland-api-key-manager/DockerfileBase \
         ./dataland-api-key-manager/ ./dataland-backend-utils/ ./build.gradle.kts ./gradle.properties ./settings.gradle.kts ./environments/.env.uncritical ./versions.properties
...
./build-utils/base_rebuild_single_docker_image.sh dataland_api_key_manager_production ./dataland-api-key-manager/Dockerfile ./dataland-api-key-manager/ \
          ./dataland-backend-utils/ ./build.gradle.kts ./gradle.properties ./settings.gradle.kts ./environments/.env.uncritical ./versions.properties
