...
./build-utils/base_rebuild_single_docker_image.sh dataland_internal_storage_base ./dataland-internal-storage/DockerfileBase "dataland-internal-storage:assemble" $dependencies
