...
dependencies="./dataland-batch-manager/ ./dataland-backend-utils/ ./dataland-backend/backendOpenApi.json ./build.gradle.kts ./gradle.properties ./settings.gradle.kts ./versions.properties"
