...
./build-utils/base_rebuild_single_docker_image.sh dataland_batch_manager_base ./dataland-batch-manager/DockerfileBase "dataland-batch-manager:assemble" $dependencies
