...
./build-utils/base_rebuild_single_docker_image.sh dataland_email_service_base ./dataland-email-service/DockerfileBase "dataland-email-service:assemble" $dependencies
