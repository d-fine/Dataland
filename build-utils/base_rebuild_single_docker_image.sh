...
docker_build_args=(     --build-arg PROXY_ENVIRONMENT="${PROXY_ENVIRONMENT:-}" \
                        ...
                        --build-arg DATALAND_POSTGRES_VERSION_ONE_VERSION="${DATALAND_POSTGRES_V1_VERSION:-}" \
                        --build-arg DATALAND_POSTGRES_VERSION_TWO_VERSION="${DATALAND_POSTGRES_V2_VERSION:-}" \
