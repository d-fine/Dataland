 ...
 */
@RequestMapping("/public/data/eutaxonomy-non-financials")
@RestController
class EuTaxonomyDataForNonFinancialsController(
    ...
    override fun getAllCompanyData(companyId: String): ResponseEntity<List<EuTaxonomyDataForNonFinancials>> {
