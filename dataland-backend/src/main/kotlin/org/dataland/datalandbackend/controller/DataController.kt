...
abstract class DataController<T>(
  ...
  override fun postCompanyAssociatedData(
    ...
    logger.info(
      logMessageBuilder.postCompanyAssociatedDataMessage(
        userId,
        dataType,
        companyId,
        reportingPeriod,
    ...
    val correlationId =
      generateCorrelationId(companyId = companyAssociatedData.companyId, dataId = null)
    val dataIdOfPostedData =
      dataManager.processDataStorageRequest(datasetToStore, bypassQa, correlationId)
      ...
      CompanyAssociatedData(
        ...
        data =
          objectMapper.readValue(
            dataManager.getPublicDataSet(dataId, dataType, correlationId).data,
            clazz,
          ),
      )
    logger.info(
  ...
  override fun getFrameworkDatasetsForCompany(
    ...
    logger.info(
      logMessageBuilder.getFrameworkDatasetsForCompanyMessage(
        dataType,
        companyId,
        reportingPeriodInLog,
      )
    )
    val metaInfos =
    ...
    metaInfos
      ...
      .forEach {
        ...
        val dataAsString =
          dataManager.getPublicDataSet(it.dataId, DataType.valueOf(it.dataType), correlationId).data
