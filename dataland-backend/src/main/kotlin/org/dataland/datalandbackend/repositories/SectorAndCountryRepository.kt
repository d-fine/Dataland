...
/**
 * A JPA repository for accessing countries and sectors of StoredCompany Entities
 */
interface SectorAndCountryRepository : JpaRepository<StoredCompanyEntity, String> {
    /**
