...
interface DataIdAndHashToEurodatIdMappingRepository :
  JpaRepository<DataIdAndHashToEurodatIdMappingEntity, String> {
  /**
   * Retrieves the eurodatId of a document, which is uniquely identified by the combination of
   * dataId and hash
   */
