...
/**
 * A temporary table class used in different repository interfaces which allows convenient usage of
 * temporary tables in the query
 */
class TemporaryTables private constructor() {
  ...
  companion object {
    ...
    // Select company_id, company_name, match_quality, dataset_rank based on searchString as
