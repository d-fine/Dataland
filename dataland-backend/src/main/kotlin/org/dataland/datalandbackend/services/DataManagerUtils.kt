...
class DataManagerUtils(
  ...
  /**
   * This method asserts that the expected data type for a dataset corresponds with the data type
   * stored in the meta information for this dataset
   *
   ...
   * @param datasetJsonStringGetter the function which specifies from which storage the dataset
   *   should be retrieved
  ...
  fun getDatasetAsJsonStringFromStorageService(
    dataId: String,
    correlationId: String,
    datasetJsonStringGetter: (String, String) -> String,
  ): String {
   ...
   * @param datasetJsonStringGetter the function to retrieve the dataset from the respective storage
   *   service
