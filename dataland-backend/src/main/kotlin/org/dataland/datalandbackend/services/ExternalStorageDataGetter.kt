...
class ExternalStorageDataGetter(
  ...
  /**
   * This method retrieves a document by using the external storage client and returns the document
   * as an inputstream
   *
  ...
  /**
   * This method retrieves a dataset by using the external storage client and returns the dataset as
   * a string
   *
   * @param dataId the dataId of the dataset to be retrieved
   * @param correlationId the correlationId of the corresponding process
   */
  fun getJsonFromExternalStorage(dataId: String, correlationId: String): String {
