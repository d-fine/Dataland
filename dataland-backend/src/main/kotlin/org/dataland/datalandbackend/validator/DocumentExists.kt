...
@Constraint(validatedBy = [DocumentReferenceExistsValidator::class])
...
/**
 * Class holding the validation logic for an BaseDocumentReference. It checks if the referenced
 * document is valid
 */
class DocumentReferenceExistsValidator(
  @Qualifier("getDocumentControllerApi") @Autowired val documentControllerApi: DocumentControllerApi
