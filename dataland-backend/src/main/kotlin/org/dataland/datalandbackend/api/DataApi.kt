...
interface DataApi<T> {
    ...
    @PreAuthorize(
        "hasRole('ROLE_UPLOADER') or " +
            ...
            "@CompanyRoleChecker.doesCurrentUserHaveGivenRoleForCompany(#companyAssociatedData.companyId, T(org.dataland.datalandcommunitymanager.model.companyRoles.CompanyRole).CompanyOwner))",
    )
