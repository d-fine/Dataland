...
fun interface UserUploadsApi {
  /**
   * A method to retrieve dataset meta information uploaded by a specific user for the "My Datasets"
   * page
   *
  ...
  @GetMapping(value = ["/{userId}/uploads"], produces = ["application/json"])
