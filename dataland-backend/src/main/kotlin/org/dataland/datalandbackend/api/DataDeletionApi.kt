...
fun interface DataDeletionApi {
  ...
  @ApiResponses(
    value = [ApiResponse(responseCode = "200", description = "Successfully deleted the dataset.")]
  )
  @DeleteMapping()
  @PreAuthorize(
  ...
  fun deleteCompanyAssociatedData(@PathVariable("dataId") @Valid @RequestBody dataId: String)
}
