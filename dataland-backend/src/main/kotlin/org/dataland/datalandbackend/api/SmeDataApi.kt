...
interface SmeDataApi {
    ...
    @PreAuthorize(
        "(hasRole('ROLE_USER') " +
            "and @NameToDo.isCurrentUserDataOwnerForCompany(#companyAssociatedSmeData.companyId))",
    )
    ...
    @PreAuthorize(
        "(hasRole('ROLE_USER') " +
            "and @NameToDo.isCurrentUserDataOwnerForCompanyOfDataId(#dataId))",
    )
    ...
    @PreAuthorize(
        "(hasRole('ROLE_USER') " +
            "and @NameToDo.isCurrentUserDataOwnerForCompany(#companyId))",
    )
