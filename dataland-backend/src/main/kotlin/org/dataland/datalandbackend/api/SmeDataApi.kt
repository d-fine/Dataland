...
interface SmeDataApi {
    ...
    @PreAuthorize(
        "(hasRole('ROLE_USER') " +
            "and @DataOwnershipChecker.isCurrentUserDataOwnerForCompany(#companyAssociatedSmeData.companyId))",
    )
    ...
    @PreAuthorize(
        "(hasRole('ROLE_USER') " +
            "and @DataOwnershipChecker.isCurrentUserDataOwnerForCompanyOfDataId(#dataId))",
    )
    ...
    @PreAuthorize(
        "(hasRole('ROLE_USER') " +
            "and @DataOwnershipChecker.isCurrentUserDataOwnerForCompany(#companyId))",
    )
