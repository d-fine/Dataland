...
/**
 * This class customises the generated open api docs by setting the nullable flag to properties that
 * are nullable in the API model
 */
@Component
class NullableIfNotRequiredOpenApiCustomizer : OpenApiCustomizer {
  ...
  private fun setPropertyNullable(property: Schema<*>) {
    ...
    if (
      property.`$ref` != null && property.`$ref`.split("/").dropLast(1).joinToString("/") == prefix
    ) {
