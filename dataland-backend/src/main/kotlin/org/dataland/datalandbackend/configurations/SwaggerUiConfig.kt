...
/**
 * This class is used to configure the appearance of the swagger-ui to exclude all internal
 * endpoints
 */
@Configuration
class SwaggerUiConfig {
  ...
  @Bean
  fun publicApi(
    esgQuestionnaireCustomizer: OpenApiEsgQuestionnaireExampleCustomizer
  ): GroupedOpenApi? {
    return GroupedOpenApi.builder()
      .group("public")
      .pathsToExclude("/internal/**")
      .addOpenApiCustomizer(DataTypeSchemaCustomizer())
