...
object JsonExampleFormattingConstants {
  ...
  const val SUBCONTRACTING_COMPANIES_DEFAULT_VALUE =
    "{" + "\"DE\": [\"NaceCodeA, NaceCodeB\"]," + "\"GB\": [\"NaceCodeC\"]" + "}"
  ...
  private const val driveMix =
    "{" + "\"driveMixPerFleetSegmentInPercent\": 0," + "\"totalAmountOfVehicles\": 0" + "}"
  ...
  const val REFERENCED_REPORTS_DEFAULT_VALUE: String = "{" + "\"string\": $companyReport" + "}"
}
