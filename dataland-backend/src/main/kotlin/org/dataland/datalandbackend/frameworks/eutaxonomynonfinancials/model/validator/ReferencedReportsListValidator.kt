...
class ReferencedReportsListConstraintValidator :
    ...
    private fun getExtendedDocumentReferences(dataset: EutaxonomyNonFinancialsData): List<String?> {
        return listOf(
            ...
            dataset.revenue?.alignedActivities?.dataSource?.fileReference,
            ...
            dataset.capex?.nonAlignedActivities?.dataSource?.fileReference,
            ...
            dataset.capex?.alignedActivities?.dataSource?.fileReference,
            ...
            dataset.opex?.nonAlignedActivities?.dataSource?.fileReference,
            ...
            dataset.opex?.alignedActivities?.dataSource?.fileReference,
