...
package org.dataland.datalandbackend.frameworks.eutaxonomyfinancials202673.model.creditInstitution.turnoverBasedGreenAssetRatioStock
...
data class EutaxonomyFinancials202673CreditinstitutionTurnoverBasedGreenAssetRatioStock(
    ...
    @Suppress("ktlint:standard:max-line-length")
    @field:Schema(
        description = """Proportion of Revenue-based Green Asset Ratio of which non-assessed exposures""",
        example = """{
      "value" : 13.52, 
      "quality" : "Reported",
      "comment" : "The value is reported by the company."
