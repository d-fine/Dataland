...
data class EutaxonomyNonFinancialsOpexNonAlignedShare(
    ...
    @field:Schema(
        description = """Relative share of the OpEx that is associated with non taxonomy-aligned but eligible activities""",
        example = """
            {
            "value" : 13.52, 
            "quality" : "Reported",
    ...
    @Suppress("ktlint:standard:max-line-length")
    @field:Schema(
        description = """Absolute value of the OpEx that is associated with non taxonomy-aligned but eligible activities""",
        example = """
        {
        "value" : 100.5,
        "currency" : "USD",
