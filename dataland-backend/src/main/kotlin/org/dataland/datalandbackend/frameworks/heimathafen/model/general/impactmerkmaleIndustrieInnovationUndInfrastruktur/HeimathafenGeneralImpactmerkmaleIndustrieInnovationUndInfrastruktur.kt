...
package org.dataland.datalandbackend.frameworks.heimathafen.model.general.impactmerkmaleIndustrieInnovationUndInfrastruktur
...
/**
 * The data-model for the ImpactmerkmaleIndustrieInnovationUndInfrastruktur section
 */
@Suppress("MaxLineLength")
data class HeimathafenGeneralImpactmerkmaleIndustrieInnovationUndInfrastruktur(
    @Suppress("ktlint:standard:max-line-length")
    @field:Schema(
        description = """Kann mit der Methodik ein Beitrag zum SDG "Industrie, Innovation und Infrastruktur" gemessen werden?""",
        example = """ "Yes"  """,
    )
