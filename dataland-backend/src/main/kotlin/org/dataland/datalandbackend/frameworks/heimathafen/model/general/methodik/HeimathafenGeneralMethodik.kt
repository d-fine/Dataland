...
data class HeimathafenGeneralMethodik(
    ...
    val wieIstIhreBewertungsskalaDefiniert: String? = null,
    val bewertungAktuell: String? = null,
    val sindIhreBewertungenUnabhaengig: String? = null,
    val datenerfassung: String? = null,
    val dieMethodikUmfasstUmweltSozialesUndGovernance: YesNo? = null,
    ...
    val minimierenOderVerhindernSieSubjektiveFaktoren: String? = null,
    ...
    val quelleDerPaiSammlung: String? = null,
    ...
    val kontroversenUmDieQuellenerfassung: String? = null,
)
