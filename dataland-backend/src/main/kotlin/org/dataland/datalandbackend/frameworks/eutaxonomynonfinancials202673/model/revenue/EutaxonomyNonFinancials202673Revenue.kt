...
data class EutaxonomyNonFinancials202673Revenue(
    ...
    @Suppress("ktlint:standard:max-line-length")
    @field:Schema(
        description = """Relative share of the revenue that is associated with taxonomy-eligible nuclear activities (referred to in Sections 4.26, 4.27 and 4.28 of Annexes I and II to Delegated Regulation (EU) 2021/2139)""",
        example = """{
      "value" : 13.52, 
      "quality" : "Reported",
      "comment" : "The value is reported by the company."
    ...
    @Suppress("ktlint:standard:max-line-length")
    @field:Schema(
        description = """Relative share of the revenue that is associated with taxonomy-aligned nuclear activities (referred to in Sections 4.26, 4.27 and 4.28 of Annexes I and II to Delegated Regulation (EU) 2021/2139)""",
        example = """{
      "value" : 13.52, 
      "quality" : "Reported",
      "comment" : "The value is reported by the company."
    ...
    @Suppress("ktlint:standard:max-line-length")
    @field:Schema(
        description = """Relative share of the revenue that is associated with taxonomy-eligible fossil gas activities (referred to in Sections 4.29, 4.30 and 4.31 of Annexes I and II to Delegated Regulation (EU) 2021/2139)""",
        example = """{
      "value" : 13.52, 
      "quality" : "Reported",
      "comment" : "The value is reported by the company."
    ...
    @Suppress("ktlint:standard:max-line-length")
    @field:Schema(
        description = """Relative share of the revenue that is associated with taxonomy-aligned fossil gas activities (referred to in Sections 4.29, 4.30 and 4.31 of Annexes I and II to Delegated Regulation (EU) 2021/2139)""",
        example = """{
      "value" : 13.52, 
      "quality" : "Reported",
      "comment" : "The value is reported by the company."
