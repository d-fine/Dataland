...
package org.dataland.datalandbackend.frameworks.eutaxonomyfinancials202673.model.investmentFirms.otherServicesTurnoverBased
...
data class EutaxonomyFinancials202673InvestmentfirmsOtherServicesTurnoverBased(
    ...
    @Suppress("ktlint:standard:max-line-length")
    @field:Schema(
        description = """Total Revenue (i.e. fees, commissions and other monetary benefits) from investment and services and activities other than dealing on own account (as per Section A of Annex I to Directive 2014/65/EU) of which covered by the Turnover""",
        example = """{
      "value" : 100.5,
      "currency" : "USD",
      "quality" : "Reported",
    ...
    @Suppress("ktlint:standard:max-line-length")
    @field:Schema(
        description = """Turnover-based Proportion of Revenue (Fees, Commissions and other Monetary Services) from Investments and Services and Activities of which Non-Assessed Exposures""",
        example = """{
      "value" : 13.52, 
      "quality" : "Reported",
      "comment" : "The value is reported by the company."
    ...
    @Suppress("ktlint:standard:max-line-length")
    @field:Schema(
        description = """Taxonomy-eligible Turnover-based Proportion of Revenue from Operation of an OTF which are exposed towards Nuclear Activities""",
        example = """{
      "value" : 13.52, 
      "quality" : "Reported",
      "comment" : "The value is reported by the company."
    ...
    @field:Valid()
    val turnoverBasedProportionOfRevenueFromOperationOfAnOtfOfWhichFossilGasActivitiesAligned: ExtendedDataPoint<BigDecimal?>? = null,
)
