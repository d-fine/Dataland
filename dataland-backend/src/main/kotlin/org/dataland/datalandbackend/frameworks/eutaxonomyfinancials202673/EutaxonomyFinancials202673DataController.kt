...
package org.dataland.datalandbackend.frameworks.eutaxonomyfinancials202673
...
/**
 * Controller for the eutaxonomy-financials-2026-73 framework endpoints
...
@RestController
class EutaxonomyFinancials202673DataController
    @Autowired
    constructor(
        datasetStorageService: AssembledDataManager,
        dataMetaInformationManager: DataMetaInformationManager,
        @Qualifier("AssembledExportService") dataExportService: DataExportService<EutaxonomyFinancials202673Data>,
        dataExportStore: DataExportStore,
        companyQueryManager: CompanyQueryManager,
    ) : DataController<EutaxonomyFinancials202673Data>(
            datasetStorageService,
            dataMetaInformationManager,
            dataExportService,
            dataExportStore,
            companyQueryManager,
            EutaxonomyFinancials202673Data::class.java,
        ) {
        @Operation(operationId = "getCompanyAssociatedEutaxonomyFinancials202673Data")
        override fun getCompanyAssociatedData(dataId: String): ResponseEntity<CompanyAssociatedData<EutaxonomyFinancials202673Data>> =
            super.getCompanyAssociatedData(dataId)

        @Operation(operationId = "getCompanyAssociatedEutaxonomyFinancials202673DataByDimensions")
        override fun getCompanyAssociatedDataByDimensions(
            reportingPeriod: String,
            companyId: String,
        ): ResponseEntity<CompanyAssociatedData<EutaxonomyFinancials202673Data>> =
            super
                .getCompanyAssociatedDataByDimensions(reportingPeriod, companyId)

        @Operation(operationId = "postCompanyAssociatedEutaxonomyFinancials202673Data")
        override fun postCompanyAssociatedData(
            companyAssociatedData: CompanyAssociatedData<EutaxonomyFinancials202673Data>,
            bypassQa: Boolean,
        ): ResponseEntity<DataMetaInformation> = super.postCompanyAssociatedData(companyAssociatedData, bypassQa)

        @Operation(operationId = "postExportJobCompanyAssociatedEutaxonomyFinancials202673DataByDimensions")
        ...
        @Operation(operationId = "postExportLatestJobCompanyAssociatedEutaxonomyFinancials202673DataByDimensions")
        ...
        @Operation(operationId = "getAllCompanyEutaxonomyFinancials202673Data")
        override fun getFrameworkDatasetsForCompany(
            companyId: String,
            showOnlyActive: Boolean,
            reportingPeriod: String?,
        ): ResponseEntity<List<DataAndMetaInformation<EutaxonomyFinancials202673Data>>> =
            super
                .getFrameworkDatasetsForCompany(companyId, showOnlyActive, reportingPeriod)

        @Operation(operationId = "getLatestAvailableCompanyAssociatedEutaxonomyFinancials202673Data")
        override fun getLatestAvailableCompanyAssociatedData(
            identifier: String,
        ): ResponseEntity<CompanyAssociatedData<EutaxonomyFinancials202673Data>> = super.getLatestAvailableCompanyAssociatedData(identifier)
    }
