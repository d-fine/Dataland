...
/**
 * --- API model --- This class represents an activity related to the EU taxonomy framework with
 * fields regarding the fulfillment of criteria regarding the alignment to EU taxonomy regulation
 */
data class EuTaxonomyAlignedActivity(
  @JsonProperty(required = true) val activityName: Activity,
