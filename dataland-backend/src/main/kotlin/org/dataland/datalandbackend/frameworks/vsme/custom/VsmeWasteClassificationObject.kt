...
/** --- API model --- Subsidiaries class for vsme framework */
data class VsmeWasteClassificationObject(
  @field:JsonProperty(required = true) val wasteClassification: WasteClassifications,
  @field:JsonProperty(required = true) val typeOfWaste: String,
