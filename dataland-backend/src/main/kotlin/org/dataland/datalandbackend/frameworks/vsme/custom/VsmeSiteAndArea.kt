...
/** --- API model --- Sites and area class for vsme framework */
data class VsmeSiteAndArea(
  @field:JsonProperty(required = true) val siteName: String,
  @field:JsonProperty(required = true) val siteAddress: Address,
  ...
  @field:JsonProperty(required = true) val areaAddress: Address,
  val areaGeocoordinateLongitude: BigDecimal?,
  val areaGeocoordinateLatitude: BigDecimal?,
  @field:JsonProperty(required = true) val specificationOfAdjointness: AreaAdjointness,
)
