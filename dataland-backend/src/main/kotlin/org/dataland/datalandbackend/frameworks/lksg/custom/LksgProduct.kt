...
/**
 * --- API model --- Fields of the LKSG questionnaire regarding a single product for the "Most
 * Important Products" field
 */
data class LksgProduct(
  @field:JsonProperty(required = true) override val name: String,
