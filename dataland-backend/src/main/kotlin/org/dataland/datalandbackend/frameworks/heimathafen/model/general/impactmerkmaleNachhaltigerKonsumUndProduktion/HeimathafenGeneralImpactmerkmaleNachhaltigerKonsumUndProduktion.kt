...
package org.dataland.datalandbackend.frameworks.heimathafen.model.general.impactmerkmaleNachhaltigerKonsumUndProduktion
...
/**
 * The data-model for the ImpactmerkmaleNachhaltigerKonsumUndProduktion section
 */
@Suppress("MaxLineLength")
data class HeimathafenGeneralImpactmerkmaleNachhaltigerKonsumUndProduktion(
    @Suppress("ktlint:standard:max-line-length")
    @field:Schema(
        description = """Kann mit der Methodik ein Beitrag zum SDG "Nachhaliger Konsum und Produktion" gemessen werden?""",
        example = """ "Yes"  """,
    )
