...
class ReferencedReportsListConstraintValidator :
    ...
    private fun getExtendedDocumentReferences(dataset: SfdrData): List<String?> {
        return listOf(
            ...
            dataset.environmental?.greenhouseGasEmissions?.carbonFootprintInTonnesPerCurrencyMillionRevenue?.dataSource?.fileReference,
            dataset.environmental?.greenhouseGasEmissions?.ghgIntensityInTonnesPerCurrencyMillionRevenue?.dataSource?.fileReference,
            dataset.environmental?.greenhouseGasEmissions?.ghgIntensityScope1InTonnesPerCurrencyMillionRevenue?.dataSource?.fileReference,
            dataset.environmental?.greenhouseGasEmissions?.ghgIntensityScope2InTonnesPerCurrencyMillionRevenue?.dataSource?.fileReference,
            dataset.environmental?.greenhouseGasEmissions?.ghgIntensityScope3InTonnesPerCurrencyMillionRevenue?.dataSource?.fileReference,
            dataset.environmental?.greenhouseGasEmissions?.ghgIntensityScope4InTonnesPerCurrencyMillionRevenue?.dataSource?.fileReference,
            ...
            dataset.environmental?.water?.relativeWaterUsageInCubicMetersPerCurrencyMillionRevenue?.dataSource?.fileReference,
            ...
            dataset.social?.socialAndEmployeeMatters?.excessiveCeoPayRatio?.dataSource?.fileReference,
