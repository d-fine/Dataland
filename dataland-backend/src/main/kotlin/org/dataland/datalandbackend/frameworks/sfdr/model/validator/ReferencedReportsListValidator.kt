...
class ReferencedReportsListConstraintValidator :
    ...
    private fun getExtendedDocumentReferences(dataset: SfdrData): List<String?> {
        return listOf(
            ...
            dataset.environmental?.greenhouseGasEmissions?.carbonFootprintInTonnesPerMillionRevenue?.dataSource?.fileReference,
            dataset.environmental?.greenhouseGasEmissions?.ghgIntensityInTonnesPerMillionRevenue?.dataSource?.fileReference,
            dataset.environmental?.greenhouseGasEmissions?.ghgIntensityScope1InTonnesPerMillionRevenue?.dataSource?.fileReference,
            dataset.environmental?.greenhouseGasEmissions?.ghgIntensityScope2InTonnesPerMillionRevenue?.dataSource?.fileReference,
            dataset.environmental?.greenhouseGasEmissions?.ghgIntensityScope3InTonnesPerMillionRevenue?.dataSource?.fileReference,
            dataset.environmental?.greenhouseGasEmissions?.ghgIntensityScope4InTonnesPerMillionRevenue?.dataSource?.fileReference,
            ...
            dataset.environmental?.water?.relativeWaterUsageInCubicMetersPerMillionRevenue?.dataSource?.fileReference,
