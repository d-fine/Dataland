...
class ReferencedReportsListConstraintValidator :
    ...
    private fun getExtendedDocumentReferences(dataset: SfdrData): List<String?> {
        return listOf(
            ...
            dataset.social?.socialAndEmployeeMatters?.femaleBoardMembers?.dataSource?.fileReference,
            dataset.social?.socialAndEmployeeMatters?.maleBoardMembers?.dataSource?.fileReference,
            dataset.social?.socialAndEmployeeMatters?.boardGenderDiversityInPercent?.dataSource?.fileReference,
