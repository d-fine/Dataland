...
class ReferencedReportsListConstraintValidator :
    ...
    private fun getExtendedDocumentReferences(dataset: EutaxonomyNonFinancials202673Data): List<String?> {
        return listOf(
            ...
            dataset.revenue?.relativeShareOfNuclearActivitiesInPercentEligible?.dataSource?.fileReference,
            dataset.revenue?.relativeShareOfNuclearActivitiesInPercentAligned?.dataSource?.fileReference,
            dataset.revenue?.relativeShareOfFossilGasActivitiesInPercentEligible?.dataSource?.fileReference,
            dataset.revenue?.relativeShareOfFossilGasActivitiesInPercentAligned?.dataSource?.fileReference,
            dataset.revenue?.nonAssessedShare?.relativeShareInPercent?.dataSource?.fileReference,
            dataset.revenue?.eligibleOrAlignedActivities?.dataSource?.fileReference,
            ...
            dataset.capex?.relativeShareOfNuclearActivitiesInPercentEligible?.dataSource?.fileReference,
            dataset.capex?.relativeShareOfNuclearActivitiesInPercentAligned?.dataSource?.fileReference,
            dataset.capex?.relativeShareOfFossilGasActivitiesInPercentEligible?.dataSource?.fileReference,
            dataset.capex?.relativeShareOfFossilGasActivitiesInPercentAligned?.dataSource?.fileReference,
            dataset.capex?.nonAssessedShare?.relativeShareInPercent?.dataSource?.fileReference,
            dataset.capex?.eligibleOrAlignedActivities?.dataSource?.fileReference,
            ...
            dataset.opex?.eligibleOrAlignedActivities?.dataSource?.fileReference,
        )
    }
}