...
data class HeimathafenGeneral(
  @field:Valid() val unternehmen: HeimathafenGeneralUnternehmen? = null,
  @field:Valid() val methodik: HeimathafenGeneralMethodik? = null,
  @field:Valid() val impactmerkmaleKeineArmut: HeimathafenGeneralImpactmerkmaleKeineArmut? = null,
  @field:Valid() val impactmerkmaleKeinHunger: HeimathafenGeneralImpactmerkmaleKeinHunger? = null,
  @field:Valid()
  val impactmerkmaleGesundheitUndWohlergehen:
  ...
  @field:Valid()
  val impactmerkmaleGeschlechtergleichheit:
  ...
  val impactmerkmaleSauberesWasserUndSanitaereEinrichtungen:
    ...
    null,
  @field:Valid()
  val impactmerkmaleBezahlbareUndSaubereEnergie:
  ...
  val impactmerkmaleIndustrieInnovationUndInfrastruktur:
    ...
    null,
  @field:Valid()
  val impactmerkmaleWenigerUngleichheiten: HeimathafenGeneralImpactmerkmaleWenigerUngleichheiten? =
    null,
  @field:Valid()
  ...
  val impactmerkmaleNachhaltigerKonsumUndProduktion:
    ...
    null,
  @field:Valid()
  val impactmerkmaleMassnahmenZumKlimaschutz:
  ...
  val impactmerkmalePartnerschaftenZurErreichungDerZiele:
    ...
    null,
  @field:Valid() val implementierung: HeimathafenGeneralImplementierung? = null,
)
