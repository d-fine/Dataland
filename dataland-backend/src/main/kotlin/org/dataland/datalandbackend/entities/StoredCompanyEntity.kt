...
data class StoredCompanyEntity(
  ...
  @Column(name = "company_legal_form") var companyLegalForm: String?,
  @Column(name = "headquarters") var headquarters: String,
  @Column(name = "headquarters_postal_code") var headquartersPostalCode: String?,
  @Column(name = "sector") var sector: String?,
  @Column(name = "sector_code_wz") var sectorCodeWz: String?,
  @OneToMany(mappedBy = "company") var identifiers: MutableList<CompanyIdentifierEntity>,
  @Column(name = "parent_company_lei") var parentCompanyLei: String?,
  @OneToMany(mappedBy = "company")
  val dataRegisteredByDataland: MutableList<DataMetaInformationEntity>,
  @Column(name = "country_code") var countryCode: String,
  @Column(name = "is_teaser_company") var isTeaserCompany: Boolean,
  @Column(name = "website") var website: String?,
  ...
  override fun toApiModel(viewingUser: DatalandAuthentication?): StoredCompany {
    ...
    return StoredCompany(
      ...
      dataRegisteredByDataland =
        dataRegisteredByDataland.map { it.toApiModel(viewingUser) }.toMutableList(),
    )
  }
