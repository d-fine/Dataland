...
/**
 * Canonical backend persistence entity for non-sourceability lifecycle records.
 */
@Entity
@Table(
    name = "non_sourceability_information",
    indexes = [
        Index(name = "idx_non_sourceability_dimensions", columnList = "company_id,data_type,reporting_period"),
    ],
)
