...
/**
 * --- API model --- Fields of the subcategory "Emissions from manure and fertiliser and livestock"
 * belonging to the category "Livestock farming" of the p2p framework.
 */
