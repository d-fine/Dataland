...
/** --- API model --- Fields of the category "General" of the p2p framework. */
data class P2pGeneral(
  @field:JsonProperty(required = true) val general: P2pGeneralGeneral,
  @field:Valid val governance: P2pGeneralGovernance? = null,
