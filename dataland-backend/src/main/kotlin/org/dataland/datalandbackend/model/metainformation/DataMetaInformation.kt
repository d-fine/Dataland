...
/**
 * --- API model --- Meta information associated to data in the data store
 *
 ...
 * @param reportingPeriod marks a period - e.g. a year or a specific quarter in a year - for which
 *   the data is valid
 */
data class DataMetaInformation(
  ...
  @field:JsonProperty(required = true) val dataType: DataType,
  val uploaderUserId: String? = null,
  @field:JsonProperty(required = true) val uploadTime: Long,
  @field:JsonProperty(required = true) val reportingPeriod: String,
  @field:JsonProperty(required = true) val currentlyActive: Boolean,
  @field:JsonProperty(required = true) var qaStatus: QaStatus,
)
