...
/** --- API model --- Fields of the questionnaire for the EuTaxonomyForFinancials framework */
...
data class EuTaxonomyDataForFinancials(
  ...
  @field:Valid() val creditInstitutionKpis: CreditInstitutionKpis? = null,
  @field:Valid() val investmentFirmKpis: InvestmentFirmKpis? = null,
  @field:Valid() val insuranceKpis: InsuranceKpis? = null,
  ...
  @field:Valid() val assurance: AssuranceDataPoint? = null,
