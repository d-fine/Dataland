...
/** --- API model --- Fields of the p2p framework. */
@Suppress("MagicNumber")
@DataType("p2p", 4)
data class PathwaysToParisData(
  @field:JsonProperty(required = true) @field:Valid() val general: P2pGeneral,
  ...
  @field:Valid val livestockFarming: P2pLivestockFarming? = null,
