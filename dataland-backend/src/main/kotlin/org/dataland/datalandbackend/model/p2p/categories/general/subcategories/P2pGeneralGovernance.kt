...
/**
 * --- API model --- Fields of the subcategory "Governance" belonging to the category "General" of
 * the p2p framework.
 */
data class P2pGeneralGovernance(
  ...
  @field:Valid val upstreamSupplierProcurementPolicy: BaseDataPoint<YesNo>? = null,
