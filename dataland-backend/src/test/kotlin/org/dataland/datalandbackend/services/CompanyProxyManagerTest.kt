...
class CompanyProxyManagerTest
    ...
    constructor(
        ...
        @Test
        fun `addProxyRelation allows to add non conflicting relation for framework is null`() {
        ...
        @Test
        fun `addProxyRelation allows to add non conflicting relation for reportingPeriod is null`() {
