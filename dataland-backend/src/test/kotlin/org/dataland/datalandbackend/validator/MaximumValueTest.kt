...
class MaximumValueTest : NumberValidationTestBase() {
  private data class NumberFieldHolder(@MaximumValue(0) val value: Number?)

  private data class DataPointFieldHolder(@MaximumValue(0) val dataPoint: BaseDataPoint<*>)
      ...
      validator.validate(
        when (value) {
          ...
          is BaseDataPoint<*> -> DataPointFieldHolder(value)
            ...
            throw IllegalArgumentException("Argument was neither null nor Number nor BaseDataPoint")
        }
      )
