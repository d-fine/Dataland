...
class MinimumValueTest : NumberValidationTestBase() {
  private data class NumberFieldHolder(@MinimumValue(0) val value: Number?)

  private data class DataPointFieldHolder(@MinimumValue(0) val dataPoint: BaseDataPoint<*>)
