...
class PropertyStyleEmailBuilderTest {
  ...
  private val receiverEmails = listOf("receiver1@example.com", "receiver2@example.com")
  ...
  fun `validate that the output of the property style email builder is correctly formatted`() {
    val properties = mapOf("first" to "1", "leftOut" to null, "second" to "2")
    val email =
      object :
  ...
  private fun validateEmailContent(expectedProperties: Map<String, String?>, email: Email) {
