...
class DataRequestClosedEmailFactoryTest {
  ...
  private fun validateEmailHtmlFormat(email: Email) {
    ...
    assertTrue(
      email.content.htmlContent.contains("Your answered data request has been automatically closed")
    )
  ...
  private fun validateTextOfDefaultEmail(email: Email) {
    ...
    assertTrue(email.content.textContent.contains("as no action was taken within the last "))
  }
}
