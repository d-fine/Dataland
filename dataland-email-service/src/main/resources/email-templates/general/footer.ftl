...
<table id="footer" style="background-color: #1b1b1b; width: 600px; font-family: Arial, Helvetica, sans-serif; font-size: 18px; text-align: left; border-collapse: collapse; padding: 0; margin: 0">
    <tbody>
    <tr>
        <td rowspan="14" style="width: 20px;"></td>
        <td colspan="2" style="width: 560px;">&nbsp;</td>
        <td rowspan="14" style="width: 20px;"></td>
    </tr>
    <@spacerRow/>
    <tr>
    ...
    <@spacerRow/>
    <tr>
        <td style="color: #c0c0c0; width: 200px; font-size: 14px">Tech Hub</td>
        <td style="color: #c0c0c0; width: 200px; font-size: 14px">ESG Frameworks</td>
        <td></td>
    </tr>
    <@spacerRowSmall/>
    <tr>
    ...
    <tr>
        <td colspan="3" style="padding: 0">
            <table style="background-color: #1b1b1b; width: 600px; font-family: Arial, Helvetica, sans-serif; font-size: 18px; text-align: left; border-collapse: collapse; padding: 0 40px; margin: 0">
                <tbody>
                <tr>
                ...
                <tr>
                    <td colspan="3" style="border-top: 1px solid #c0c0c0; height: 20px; font-size:10px">&nbsp;</td>
                </tr>
                <tr>
                    <td><a href="${baseUrl}/terms" target="_blank" style="border: 0 none; font-weight: bolder; font-size: 16px; color: #ffffff; text-decoration: none;">LEGAL</a></td>
                    <td><a href="${baseUrl}/imprint" target="_blank" style="border: 0 none; font-weight: bolder; font-size: 16px; color: #ffffff; text-decoration: none;">IMPRINT</a></td>
                    <td><a href="${baseUrl}/dataprivacy" target="_blank" style="border: 0 none; font-weight: bolder; font-size: 16px; color: #ffffff; text-decoration: none;">DATA PRIVACY</a></td>
                </tr>
                <@spacerRow/>
                <tr>
                    <td colspan="3" style="height: 20px; font-size: 16px; color: #ffffff; text-decoration: none;">Copyright &copy; 2024 Dataland</td>
                </tr>
                </tbody>
                <@spacerRow/>
            </table>
