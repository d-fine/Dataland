<table id="displayedDataRequest" style="background-color: #f6f6f6; border-collapse: collapse; padding: 0; margin: 0; width: 520px">
    <tbody>
    <tr>
    ...
    <tr>
        <td style="font-weight: bold; font-size:19px"><#if dataTypeDescription??>${dataTypeLabel}<#else>${dataType}</#if></td>
    </tr>
    <tr>
        <td style="height: 20px">&nbsp;</td>
    </tr>
