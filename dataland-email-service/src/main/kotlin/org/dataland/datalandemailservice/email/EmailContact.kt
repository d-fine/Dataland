...
data class EmailContact(val emailAddress: String, val name: String? = null) {
  /**
...
/**
 * Integrates the provided list of EmailContact objects as receivers into the build of a
 * TransactionalEmail
 */
...
/**
 * Integrates the provided list of EmailContact objects as cc receivers into the build of a
 * TransactionalEmail
 */
