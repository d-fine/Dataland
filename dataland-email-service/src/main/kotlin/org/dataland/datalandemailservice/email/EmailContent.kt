...
data class EmailContent(val subject: String, val textContent: String, val htmlContent: String)
...
fun TransactionalEmail.TransactionalEmailBuilder.integrateContentIntoTransactionalEmailBuilder(
  ...
  return this.subject(content.subject).textPart(content.textContent).htmlPart(content.htmlContent)
}
