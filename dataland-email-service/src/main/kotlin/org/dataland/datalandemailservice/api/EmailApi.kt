...
// import org.dataland.datalandemailservice.org.dataland.datalandqaservice.model.ReviewInformationResponse
// import org.dataland.datalandemailservice.org.dataland.datalandqaservice.model.ReviewQueueResponse
...
interface EmailApi {
    ...
    @PatchMapping(
        value = ["/mail/updates/unsubscribe/{subscriptionUuid}"],
        produces = ["application/json"],
    )
    @PreAuthorize(
    ...
    fun unsubscribe(@PathVariable subscriptionUuid: String): String {
        // Call the function to unsubscribe this UUID
        val emailSubscriptionService = EmailSubscriptionService(emailSubscriptionRepository = )
        emailSubscriptionService.unsubscribeEmailWithUuid(uuid)
    }
