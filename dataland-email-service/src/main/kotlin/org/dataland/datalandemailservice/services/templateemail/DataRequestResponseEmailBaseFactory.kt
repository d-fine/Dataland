...
abstract class DataRequestResponseEmailBaseFactory
protected constructor(proxyPrimaryUrl: String, senderEmail: String, senderName: String) :
  ...
  override val requiredProperties =
    setOf(
      ...
      Keys.COMPANY_NAME,
      Keys.DATA_TYPE,
      Keys.REPORTING_PERIOD,
      Keys.CREATION_DATE,
      Keys.DATA_REQUEST_ID,
      Keys.CLOSED_IN_DAYS,
    )
