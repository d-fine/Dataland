...
class SuccessfullyClaimedOwnershipEmailFactory(
  ...
  override val requiredProperties =
    setOf(keys.companyId, keys.companyName, keys.numberOfOpenDataRequestsForCompany)
  ...
  override fun buildTextContent(properties: Map<String, String?>): String {
    return StringBuilder()
      .append("Great news!\n")
      .append(
        "You've successfully claimed company ownership for " + "${properties[keys.companyName]}\n\n"
      )
      .append(
