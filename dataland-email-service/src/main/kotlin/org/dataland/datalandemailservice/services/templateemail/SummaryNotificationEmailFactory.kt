...
class SummaryNotificationEmailFactory(
  ...
  override val requiredProperties =
    setOf(keys.companyId, keys.companyName, keys.frameworks, keys.baseUrl, keys.numberOfDays)
  ...
  override fun buildTextContent(properties: Map<String, String?>): String {
    ...
    return StringBuilder()
      .apply {
        ...
        append(
          "Multiple datasets for ${properties[keys.companyName]} have been uploaded to Dataland\n"
        )
