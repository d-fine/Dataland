...
abstract class TemplateEmailFactory(
  ...
  senderEmail: String,
  senderName: String,
) : BaseEmailBuilder(senderEmail = senderEmail, senderName = senderName) {
   ...
   */
  fun buildEmail(receiverEmail: String, properties: Map<String, String?>): Email {
  ...
  private fun buildHtmlContent(properties: Map<String, String?>): String {
    ...
    val freemarkerTemplate = FreeMarker.configuration.getTemplate(templateFile)
