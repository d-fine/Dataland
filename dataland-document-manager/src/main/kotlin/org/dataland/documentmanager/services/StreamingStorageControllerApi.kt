...
/**
 * An interface to the document endpoint of the internal storage service that allows raw access to
...
class StreamingStorageControllerApi(
  ...
  /**
   * Retrieves the blob identified by the blobId from the internal storage and returns the input
