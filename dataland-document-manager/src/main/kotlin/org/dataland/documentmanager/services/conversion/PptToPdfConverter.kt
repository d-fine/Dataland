...
@Component
class PptToPdfConverter(@Value("\${dataland.libreoffice.path}") val pathToLibre: String) :
  MsOfficeToPdfConverterBase(
    ...
    allowedMimeTypesPerFileExtension =
      mapOf("ppt" to setOf("application/vnd.ms-powerpoint", "application/x-tika-msoffice")),
  ) {
