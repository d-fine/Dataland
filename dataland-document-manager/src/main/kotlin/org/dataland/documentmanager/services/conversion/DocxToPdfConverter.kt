...
@Component
class DocxToPdfConverter(@Value("\${dataland.libreoffice.path}") private val pathToLibre: String) :
  ...
  override fun validateFileContent(file: MultipartFile, correlationId: String) {
    file.inputStream.use { inputStream ->
      XWPFDocument(inputStream).use { document -> validateDocumentContent(document) }
    }
  }
