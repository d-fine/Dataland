...
class FileProcessor(
     ...
     */
    fun processFile(file: MultipartFile, correlationId: String): Pair<ByteArray, Boolean> {
        ...
        return Pair(matchingConverter.convertFile(file, correlationId), matchingConverter.usesVirusScan)
    }
}
