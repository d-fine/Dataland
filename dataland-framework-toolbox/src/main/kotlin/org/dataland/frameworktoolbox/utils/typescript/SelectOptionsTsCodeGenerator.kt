...
/**
 * Generates a string containing typescript code for a mapping object. This mapping object contains
 * technical names of select options as keys, and the respective literal names as values.
 *
 ...
 * This default behaviour is useful for cases where custom population of the option field is not
 * required.
 *
