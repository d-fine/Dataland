...
/**
 * The DatalandRepositoryGradleInterface manages the interaction with the gradle project of a
 * Dataland repository
 */
class DatalandRepositoryGradleInterface(val repository: DatalandRepository) {
