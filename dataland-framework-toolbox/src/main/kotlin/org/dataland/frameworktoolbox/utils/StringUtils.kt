...
/**
 * Return the string while ensuring that the first letter is capitalized with respect to the english
 * alphabet
 */
fun String.capitalizeEn(): String {
  return replaceFirstChar { if (it.isLowerCase()) it.titlecase(Locale.ENGLISH) else it.toString() }
}
