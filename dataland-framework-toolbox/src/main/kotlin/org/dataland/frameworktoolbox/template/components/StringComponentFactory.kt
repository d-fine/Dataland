...
@Component
class StringComponentFactory(@Autowired val templateDiagnostic: TemplateDiagnostic) :
  ...
  override fun generateComponent(
    ...
    return componentGroup.create<StringComponent>(utils.generateFieldIdentifierFromRow(row)) {
