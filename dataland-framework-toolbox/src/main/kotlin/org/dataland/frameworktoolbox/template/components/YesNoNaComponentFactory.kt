...
@Component
class YesNoNaComponentFactory(@Autowired val templateDiagnostic: TemplateDiagnostic) :
  ...
  override fun generateComponent(
    ...
    return componentGroup.create<YesNoNaComponent>(utils.generateFieldIdentifierFromRow(row)) {
