...
@Component
class DateComponentFactory(@Autowired val templateDiagnostic: TemplateDiagnostic) :
  ...
  override fun generateComponent(
    ...
    return componentGroup.create<DateComponent>(utils.generateFieldIdentifierFromRow(row)) {
