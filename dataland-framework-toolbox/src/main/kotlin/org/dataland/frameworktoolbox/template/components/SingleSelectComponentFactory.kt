...
@Component
class SingleSelectComponentFactory(@Autowired val templateDiagnostic: TemplateDiagnostic) :
  ...
  override fun generateComponent(
    ...
    return componentGroup.create<SingleSelectComponent>(utils.generateFieldIdentifierFromRow(row)) {
