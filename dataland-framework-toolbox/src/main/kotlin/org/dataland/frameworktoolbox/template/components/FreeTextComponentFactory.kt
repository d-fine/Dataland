...
@Component
class FreeTextComponentFactory(@Autowired val templateDiagnostic: TemplateDiagnostic) :
  ...
  override fun generateComponent(
    ...
    return componentGroup.create<FreeTextComponent>(utils.generateFieldIdentifierFromRow(row)) {
