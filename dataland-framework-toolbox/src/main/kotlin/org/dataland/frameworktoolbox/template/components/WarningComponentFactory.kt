...
/**
 * A component factory with the lowest precedence that issues warnings alerting users to the absence
 * of a suitable component factory
 */
@Order(0)
@Component
class WarningComponentFactory(@Autowired val diagnostic: DiagnosticManager) :
