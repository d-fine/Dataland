...
@Component
class CurrencyComponentFactory(@Autowired val templateDiagnostic: TemplateDiagnostic) :
  ...
  override fun generateComponent(
    ...
    return componentGroup.create<CurrencyComponent>(utils.generateFieldIdentifierFromRow(row)) {
