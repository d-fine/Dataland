...
@Component
class MultiSelectComponentFactory(@Autowired val templateDiagnostic: TemplateDiagnostic) :
  TemplateComponentFactory {
  override fun canGenerateComponent(row: TemplateRow): Boolean =
    row.component == "Multi-Select Dropdown"
  ...
  override fun generateComponent(
    ...
    return componentGroup.create<MultiSelectComponent>(utils.generateFieldIdentifierFromRow(row)) {
