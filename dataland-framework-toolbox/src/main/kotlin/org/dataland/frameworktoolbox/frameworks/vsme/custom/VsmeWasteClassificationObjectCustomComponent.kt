...
/**
 * Describes a custom component for classification of waste including several fields with additional
 * information
 */
class VsmeWasteClassificationObjectCustomComponent(identifier: String, parent: FieldNodeParent) :
