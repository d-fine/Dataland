...
class LksgMostImportantProductsComponent(identifier: String, parent: FieldNodeParent) :
  ...
  override fun generateDefaultDataModel(dataClassBuilder: DataClassBuilder) {
    ...
    dataClassBuilder.addProperty(
      ...
      TypeReference(
        ...
        isNullable,
        listOf(
          TypeReference("org.dataland.datalandbackend.frameworks.lksg.custom.LksgProduct", false)
        ),
      ),
    )
  }
