...
/**
 * You may choose to use the InDevelopmentPavedRoadFramework as a basis for any frameworks that are
 * currently in development. It turns a large amount of errors into warnings that make the
 * development experience more pleasant
 */
