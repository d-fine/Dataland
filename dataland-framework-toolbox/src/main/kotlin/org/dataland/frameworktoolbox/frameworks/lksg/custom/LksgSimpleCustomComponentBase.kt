 ...
 * @param viewFormattingFunctionName the name of the formatting function for the view page in LksgDisplayValueGetters.ts
 */
open class LksgSimpleCustomComponentBase(
    identifier: String,
