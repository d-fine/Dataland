...
import org.dataland.frameworktoolbox.intermediate.components.JsonExamples.EXAMPLE_PLAIN_NUCLEAR_AND_GAS_NON_ELIGIBLE_COMPONENT
...
class NuclearAndGasNonEligibleComponent(
    ...
    override fun generateDefaultDataModel(dataClassBuilder: DataClassBuilder) {
        dataClassBuilder.addPropertyWithDocumentSupport(
            ...
            getSchemaAnnotationWithSuppressMaxLineLength(
                ...
                getExample(EXAMPLE_PLAIN_NUCLEAR_AND_GAS_NON_ELIGIBLE_COMPONENT),
            ),
        )
    }
    ...
    override fun generateDefaultSpecification(specificationCategoryBuilder: CategoryBuilder) {
        ...
        specificationCategoryBuilder.addDefaultDatapointAndSpecification(
            this,
            "NuclearAndGasNonEligibleComponent",
        )
    }
}
