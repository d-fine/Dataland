...
class VsmeSiteAndAreaComponent(identifier: String, parent: FieldNodeParent) :
  VsmeSimpleCustomComponentBase(
    ...
    guaranteedFixtureExpression =
      "dataGenerator.randomArray(() => dataGenerator.generateVsmeSiteAndArea(), 0, 5)",
  ...
  override fun generateDefaultDataModel(dataClassBuilder: DataClassBuilder) {
    ...
    dataClassBuilder.addProperty(
      ...
      TypeReference(
        ...
        isNullable,
        listOf(
          TypeReference("org.dataland.datalandbackend.frameworks.vsme.custom.VsmeSiteAndArea", true)
        ),
      ),
    )
  }
