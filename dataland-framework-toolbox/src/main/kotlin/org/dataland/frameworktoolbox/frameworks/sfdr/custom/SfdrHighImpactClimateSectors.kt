...
class SfdrHighImpactClimateSectors(identifier: String, parent: FieldNodeParent) :
  ...
  override fun generateDefaultQaModel(dataClassBuilder: DataClassBuilder) {
    ...
    dataClassBuilder.addProperty(
      ...
      TypeReference(
        ...
        listOf(
          TypeReference(
            "org.dataland.datalandqaservice.frameworks.sfdr." + "custom.HighImpactClimateSector",
            false,
          ),
          TypeReference(
