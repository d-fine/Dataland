...
class VsmePollutionEmissionComponent(identifier: String, parent: FieldNodeParent) :
  VsmeSimpleCustomComponentBase(
    ...
    guaranteedFixtureExpression =
      "dataGenerator.randomArray(() => " + "dataGenerator.generateVsmePollutionEmission(), 0, 3)",
