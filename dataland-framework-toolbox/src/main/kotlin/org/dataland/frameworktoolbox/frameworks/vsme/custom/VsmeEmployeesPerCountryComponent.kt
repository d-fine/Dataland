...
class VsmeEmployeesPerCountryComponent(identifier: String, parent: FieldNodeParent) :
  VsmeSimpleCustomComponentBase(
    ...
    guaranteedFixtureExpression =
      "dataGenerator.randomArray(() => dataGenerator.generateVsmeEmployeesPerCountry()," + " 0, 5)",
