package org.dataland.frameworktoolbox.frameworks.heimathafen.custom
 ...
 */
class HeimathafenListOfBaseDataPointComponent(
    identifier: String,
            ...
            FrameworkDisplayValueLambda(
                ...
                setOf(
                    "import { formatListOfBaseDataPoint } from " +
                        "\"@/components/resources/dataTable/conversion/heimathafen/Heimathafen" +
                        "ListOfBaseDataPointGetterFactory\";",
                ),
            ),
        )
    }
