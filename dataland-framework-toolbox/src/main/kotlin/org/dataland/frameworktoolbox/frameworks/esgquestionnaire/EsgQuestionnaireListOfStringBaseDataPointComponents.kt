...
/**
 * This object contains implementations for the list of base datapoint components of the ESG
...
object EsgQuestionnaireListOfStringBaseDataPointComponents {
  ...
  fun aktuelleBerichte(componentGroupAllgemein: ComponentGroup) {
    componentGroupAllgemein.get<ComponentGroup>("esgBerichte").edit<
      ListOfStringBaseDataPointComponent
    >(
      "aktuelleBerichte"
    ) {
  ...
  fun weitereAkkreditierungen(componentGroupAllgemein: ComponentGroup) {
    componentGroupAllgemein.get<ComponentGroup>("akkreditierungen").edit<
      ListOfStringBaseDataPointComponent
    >(
  ...
  fun richtlinienZurEinhaltungDerUngcp(componentGroupAllgemein: ComponentGroup) {
    componentGroupAllgemein.get<ComponentGroup>("unGlobalConceptPrinzipien").edit<
      ListOfStringBaseDataPointComponent
    >(
  ...
  fun richtlinienZurEinhaltungDerOecdLeitsaetze(componentGroupAllgemein: ComponentGroup) {
    componentGroupAllgemein.get<ComponentGroup>("oecdLeitsaetze").edit<
      ListOfStringBaseDataPointComponent
    >(
