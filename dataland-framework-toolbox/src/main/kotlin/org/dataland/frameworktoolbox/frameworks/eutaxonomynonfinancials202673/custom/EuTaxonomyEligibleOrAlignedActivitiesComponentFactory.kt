...
/**
 * Generates EuTaxonomyEligibleOrAlignedActivities from the corresponding component
 */
@Component
class EuTaxonomyEligibleOrAlignedActivitiesComponentFactory(
    @Autowired val templateDiagnostic: TemplateDiagnostic,
) : TemplateComponentFactory {
    override fun canGenerateComponent(row: TemplateRow): Boolean =
        row.component.trim() == "Custom EuTaxonomyEligibleOrAlignedActivitiesComponent"
    ...
    override fun generateComponent(
        ...
        return componentGroup.create<EuTaxonomyEligibleOrAlignedActivitiesComponent>(
