...
class ReportPreuploadComponent(identifier: String, parent: FieldNodeParent) :
  ComponentBase(identifier, parent) {

  private val companyReportType =
  ...
  override fun generateDefaultDataModel(dataClassBuilder: DataClassBuilder) {
    ...
    dataClassBuilder.addProperty(
      identifier,
      TypeReference("Map", isNullable, listOf(TypeReference("String", false), companyReportType)),
      listOf(
        Annotation(
          ...
          additionalImports =
            setOf("org.dataland.datalandbackend.utils.JsonExampleFormattingConstants"),
        ),
        ValidAnnotation,
      ),
    )
  ...
  override fun generateDefaultFixtureGenerator(sectionBuilder: FixtureSectionBuilder) {
    requireDocumentSupportIn(setOf(NoDocumentSupport))
    sectionBuilder.addAtomicExpression(identifier, "dataGenerator.reports")
  }
}
