...
class CurrencyComponent(identifier: String, parent: FieldNodeParent) :
  ...
  override fun generateDefaultQaModel(dataClassBuilder: DataClassBuilder) {
    ...
    dataClassBuilder.addProperty(
      ...
      TypeReference(
        ...
        true,
        listOf(backendCurrencyDatapoint.getBackendClientTypeReference()),
      ),
    )
  }
  ...
  override fun generateDefaultFixtureGenerator(sectionBuilder: FixtureSectionBuilder) {
    ...
    sectionBuilder.addAtomicExpression(identifier, expression)
  }
}
