...
class ComponentGroup(
  ...
  override fun generateDefaultDataModel(dataClassBuilder: DataClassBuilder) {
    ...
    children.forEach { it.generateDataModel(groupClass) }
  ...
  override fun generateDefaultQaModel(dataClassBuilder: DataClassBuilder) {
    ...
    children.forEach { it.generateQaModel(groupClass) }
  ...
  override fun generateDefaultViewConfig(sectionConfigBuilder: SectionConfigBuilder) {
    ...
    children.forEach { it.generateViewConfig(containerSection) }
  }
  ...
  override fun generateDefaultUploadConfig(uploadCategoryBuilder: UploadCategoryBuilder) {
    ...
    children.forEach { it.generateUploadConfig(containerSection) }
  }

  override fun generateDefaultFixtureGenerator(sectionBuilder: FixtureSectionBuilder) {
    val groupSection = sectionBuilder.addSection(identifier)
    children.forEach { it.generateFixtureGenerator(groupSection) }
  }
