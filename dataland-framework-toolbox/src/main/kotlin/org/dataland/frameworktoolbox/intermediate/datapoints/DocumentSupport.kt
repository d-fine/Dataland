...
/**
 * A DocumentSupport implementation specified to which degrees evidence is desired / required for
 * this datapoint This has a large impact on the generated datamodel.
 */
sealed interface DocumentSupport {
  companion object {
    /**
     * Obtain a DocumentSupport implementation from a TemplateDocumentSupport instance from the
     * template CSV
     */
  ...
  /**
   * Calculate the JVM type-reference for a datapoint of type innerType given the current
  ...
  /**
   * Calculate the JVM type-reference for a QA-DataPoint of type innerType given the current
   * DocumentSupport requirements
   *
   * @param innerType the type of the datapoint
   * @param nullable true iff the datapoint should be nullable
  ...
  /**
   * Calculate a Framework Display Lambda for a datapoint with original lambda innerLambda given the
   * current DocumentSupport requirements
   *
  ...
  /**
   * Calculate a TS-Accessor for getting the value of a datapoint with the current DocumentSupport
   * requirements
   *
   * @param dataPointAccessor a TS-Accessor to the containing datapoint
  ...
  /**
   * Calculate a Fixture-Expression for generating the value of a datapoint with the current
   * DocumentSupport requirements
   *
   * @param nullableFixtureExpression a fixture expression that generates a possibly null value for
   *   the data-element
   * @param fixtureExpression a fixture expression that generates a non-nullable value for the
   *   data-element
   * @param nullable true iff the datapoint is nullable
   */
