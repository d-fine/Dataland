...
/**
 * The NumberBaseComponent serves as base-class for any number component (percentage, decimal,
 * integer...) and offers some standard functionality.
 */
open class NumberBaseComponent(identifier: String, parent: FieldNodeParent) :
  ...
  /**
   * Returns the parameter list for the fake fixture generation to respect minimum and maximum
   * bounds
   */
