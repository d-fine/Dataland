...
/**
 * A ReferencedReportValidatorBuilder is an in-memory Representation of a Kotlin class that supports
 * the generation of a validator for the referenced report list. This validator checks whether all
 * extendedDocumentReferences are also in the referencedReports stored in referencedReportsPath for
 * a dataClass specified by dataClass. The validator will be placed in the parent package and the
 * framework identifier is used to create the template. Note: This builder only creates the
 * validator class. The annotation needs to be added to the dataClass to be effective.
 */
