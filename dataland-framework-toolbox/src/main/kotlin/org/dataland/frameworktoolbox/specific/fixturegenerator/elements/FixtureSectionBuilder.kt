...
/**
 * A FixtureSectionBuilder is an in-memory Representation of fixture generator for a JS Object
 *
...
class FixtureSectionBuilder(
  ...
  override val imports: Set<TypeScriptImport>
    get() = elements.foldRight(emptySet()) { element, imports -> imports + element.imports }
