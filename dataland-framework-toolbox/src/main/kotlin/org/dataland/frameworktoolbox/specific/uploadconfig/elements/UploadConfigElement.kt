...
sealed interface UploadConfigElement {
  ...
  /**
   * When this function passes without errors, it is guaranteed that this config element is
   * compliant with the limitations of the legacy upload page and code generation can proceed
   */
  fun assertComplianceWithLegacyUploadPage()

  /**
   * Traverses the component tree in pre-order fashion and execute the provided function for every
   * element
   */
