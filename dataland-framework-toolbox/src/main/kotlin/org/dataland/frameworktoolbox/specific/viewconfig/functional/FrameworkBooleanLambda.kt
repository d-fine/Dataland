...
class FrameworkBooleanLambda(lambdaBody: String, imports: Set<TypeScriptImport> = emptySet()) :
  FrameworkLambda(lambdaBody = lambdaBody, returnParameter = "boolean", imports = imports) {
  companion object {
