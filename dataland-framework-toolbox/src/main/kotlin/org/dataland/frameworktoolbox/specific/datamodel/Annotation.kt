 ...
 * @param rawParameterSpec the parameters for the annotation (annotation will get compiled
 *   to @FQN(rawParameterSpec)
 * @param applicationTargetPrefix a prefix applied before the annotation that specifies the target
 *   (e.g., field:)
 */
