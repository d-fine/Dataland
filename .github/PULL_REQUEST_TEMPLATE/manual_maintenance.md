...
## Check e-mails send by keycloak
- [ ] Check that the verification e-mail is send and displayed correctly
- [ ] Check that the reset password e-mail is send and displayed correctly
