  ...
  server: {
    ...
    proxy: {
      '^/(api|documents|qa|community|users|specifications)': {
        ...
        changeOrigin: true,
        headers: {
          authorization: 'Bearer MTM2YTkzOTQtNDg3My00YTYxLWEyNWItNjViMWU4ZTdjYzJm_1c326ae0271d9361b2301e526bdf3c21acf5bb7d067ba59de3bcaf64e9f8d537a78954af4c398030_707118578',
        },
      },
    },
  },
