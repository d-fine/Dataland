...
tasks.register("generateBackendClient", org.openapitools.generator.gradle.plugin.tasks.GenerateTask::class) {
    ...
    inputSpec.set(project.file(backendOpenApiFile).toString())
...
tasks.register("generateApiKeyManagerClient", org.openapitools.generator.gradle.plugin.tasks.GenerateTask::class) {
    ...
    inputSpec.set(project.file("${project.rootDir}/dataland-api-key-manager/apiKeyManagerOpenApi.json").toString())
    outputDir.set(
        layout.buildDirectory
...
tasks.register("generateQaServiceClient", org.openapitools.generator.gradle.plugin.tasks.GenerateTask::class) {
    ...
    inputSpec.set(project.file("${project.rootDir}/dataland-qa-service/qaServiceOpenApi.json").toString())
    outputDir.set(
        layout.buildDirectory
...
tasks.register("generateEmailServiceClient", org.openapitools.generator.gradle.plugin.tasks.GenerateTask::class) {
    ...
    inputSpec.set(project.file("${project.rootDir}/dataland-email-service/emailServiceOpenApi.json").toString())
    outputDir.set(
        layout.buildDirectory
...
tasks.register("generateUserServiceClient", org.openapitools.generator.gradle.plugin.tasks.GenerateTask::class) {
    ...
    inputSpec.set(project.file("${project.rootDir}/dataland-user-service/userServiceOpenApi.json").toString())
    outputDir.set(
        layout.buildDirectory
...
tasks.register("generateAccountingServiceClient", org.openapitools.generator.gradle.plugin.tasks.GenerateTask::class) {
    ...
    inputSpec.set(project.file("${project.rootDir}/dataland-accounting-service/accountingServiceOpenApi.json").toString())
    outputDir.set(
        layout.buildDirectory
