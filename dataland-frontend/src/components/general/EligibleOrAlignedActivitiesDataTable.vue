...
import {
  type Activity,
  type EuTaxonomyEligibleOrAlignedActivity,
...
export default defineComponent({
  ...
  data() {
    return {
      listOfRowContents: [] as Array<EuTaxonomyEligibleOrAlignedActivity>,
  ...
  mounted() {
    ...
    if (typeof dialogRefData.listOfRowContents[0] === 'string') {
      ...
      this.listOfRowContents = dialogRefData.listOfRowContents as Array<EuTaxonomyEligibleOrAlignedActivity>;
    }
...
/**
 * @param activity targeted activity object
 * @returns list of enabling activity data items
 */
function createEnablingActivityGroupData(activity: EuTaxonomyEligibleOrAlignedActivity): ActivityFieldValueObject[] {
  return [
    {
...
/**
 * @param activity targeted activity object
 * @returns list of transitional activity data items
 */
function createTransitionalActivityGroupData(
  activity: EuTaxonomyEligibleOrAlignedActivity
): ActivityFieldValueObject[] {
  return [
    {
