  ...
  <div class="form-field">
    ...
    <div class="">
      ...
      >
        {{ element }}
        <em
            @click="removeItemFromListOfGoodsOrServices(element)"
...
export default defineComponent( {
  ...
  components: {FreeTextFormField, InputTextFormField, AddressFormField, RadioButtonsFormField, UploadFormHeader, FormKit },
  props: {
    item: {
  ...
  methods: {
    ...
    addNewItemsToListOfGoodsOrServices() {
      ...
      this.item.listOfGoodsOrServices = [
        ...this.item.listOfGoodsOrServices,
        ...items,
      ];
