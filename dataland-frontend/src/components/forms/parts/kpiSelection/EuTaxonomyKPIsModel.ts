...
export const euTaxonomyKpiNameMappings = {
  ...
  eligibleAmountRevenue: "Eligible Revenue",
  alignedPercentageRevenue: "Aligned Revenue (%)",
  alignedAmountRevenue: "Aligned Revenue",
  totalRevenue: "Total Revenue",
  eligiblePercentageCapEx: "Eligible CapEx (%)",
  eligibleAmountCapEx: "Eligible CapEx",
  alignedPercentageCapEx: "Aligned CapEx (%)",
  alignedAmountCapEx: "Aligned CapEx",
  totalCapEx: "Total CapEx",
  eligiblePercentageOpEx: "Eligible OpEx (%)",
  eligibleAmountOpEx: "Eligible OpEx",
  alignedPercentageOpEx: "Aligned OpEx (%)",
  alignedAmountOpEx: "Aligned OpEx",
...
export const euTaxonomyKpiInfoMappings = {
  ...
  eligibleAmountRevenue:
    "Amount of the revenue where the economic activity meets taxonomy criteria for substantial contribution to climate change mitigation and does no serious harm to the other environmental objectives (DNSH criteria).",
  alignedPercentageRevenue:
  ...
  alignedAmountRevenue:
    "Amount of the revenue that is taxonomy-aligned, i.e., generated by an eligible economic activity that is making a substantial contribution to at least one of the climate and environmental objectives, while also doing no significant harm to the remaining objectives and meeting minimum standards on human rights and labour standards.",
  totalRevenue:
  ...
  eligibleAmountCapEx:
    "Amount of the CapEx that is part of a plan to meet taxonomy criteria for substantial contribution to climate change adaptation and relevant DNSH criteria",
  alignedPercentageCapEx:
  ...
  alignedAmountCapEx:
    "Amount of the CapEx that is either already taxonomy-aligned or is part of a credible plan to extend or reach taxonomy alignment. I.e., an eligible economic activity that is making a substantial contribution to at least one of the climate and environmental objectives, while also doing no significant harm to the remaining objectives and meeting minimum standards on human rights and labour standards.",
  totalCapEx:
  ...
  eligibleAmountOpEx:
    "Amount of the OpEx that is part of a plan to meet taxonomy criteria for substantial contribution to climate change adaptation and relevant DNSH criteria.",
  alignedPercentageOpEx:
  ...
  alignedAmountOpEx:
    "Amount of the OpEx that is associated with taxonomy-aligned activities. I.e., for an eligible economic activity that is making a substantial contribution to at least one of the climate and environmental objectives, while also doing no significant harm to the remaining objectives and meeting minimum standards on human rights and labour standards.",
  totalOpEx:
