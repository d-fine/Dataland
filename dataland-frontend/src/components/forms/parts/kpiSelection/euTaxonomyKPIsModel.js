...
export const euTaxonomyKpiNameMappings = {
  ...
  ExposuresToTaxonomyEligibleEconomicActivitiesCreditInstitution: "Exposures To Taxonomy-eligible Economic Activities Credit Institution",
  ExposuresToTaxonomyNonEligibleEconomicActivitiesCreditInstitution: "Exposures To Taxonomy Non-eligible Economic Activities Credit Institution",
  ExposuresToCentralGovernmentsCentralBanksSupranationalIssuersCreditInstitution: "Exposures To Central Governments, Central Banks, Supranational Issuers Credit Institution",
  ...
  ExposuresToTaxonomyEligibleEconomicActivitiesInvestmentFirm: "Exposures To Taxonomy-eligible Economic Activities Investment Firm",
  ExposuresToTaxonomyNonEligibleEconomicActivitiesInvestmentFirm: "Exposures To Taxonomy Non-eligible Economic Activities Investment Firm",
...
export const euTaxonomyKpiInfoMappings = {
  ...
  alignedRevenue: "Percentage of the Revenue that is taxonomy-aligned, i.e., generated by an eligible economic activity that is making a substantial contribution to at least one of the climate and environmental objectives, while also doing no significant harm to the remaining objectives and meeting minimum standards on human rights and labour standards",
  ...
  eligibleCapEx: "Percentage of the CapEx that is part of a plan to meet taxonomy criteria for substantial contribution to climate change adaptation and relevant DNSH criteria",
  ...
  totalCapEx: "Total CapEx in MM (Millions) for the financial year. A capital expenditure (CapEx) is a payment for goods or services recorded, or capitalized, on the balance sheet instead of expensed on the income statement",
  eligibleOpEx: "Percentage of the OpEx that is part of a plan to meet taxonomy criteria for substantial contribution to climate change adaptation and relevant DNSH criteria",
  alignedOpEx: "Percentage of the OpEx that is associated with taxonomy-aligned activities. i.e., for an eligible economic activity that is making a substantial contribution to at least one of the climate and environmental objectives, while also doing no significant harm to the remaining objectives and meeting minimum standards on human rights and labour standards",
  totalOpEx: "Total OpEx in MM (Millions) for the financial year. Operating expenses (OpEx) are shorter term expenses required to meet the ongoing operational costs of running a business",

  ExposuresToTaxonomyEligibleEconomicActivitiesCreditInstitution: "For financial companies (FS), the percentage of total assets exposed to taxonomy-eligible economic activities",
  ExposuresToTaxonomyNonEligibleEconomicActivitiesCreditInstitution: "For financial companies (FS), the percentage of total assets exposed to taxonomy non-eligible economic activities. i.e., to types of economic activity that is not described and does not have technical screening criteria set out in the EU Taxonomy Regulation",
  ...
  ExposuresToDerivativesAssetManagementCompany: "For financial companies (FS), the percentage of total assets exposed to derivatives",
  ExposuresToNonNfdrEntitiesAssetManagementCompany: "For financial companies (FS), the percentage of total assets exposed to non-NFRD entities",

  ExposuresToTaxonomyEligibleEconomicActivitiesInvestmentFirm: "For financial companies (FS), the percentage of total assets exposed to taxonomy-eligible economic activities",
  ExposuresToTaxonomyNonEligibleEconomicActivitiesInvestmentFirm: "For financial companies (FS), the percentage of total assets exposed to taxonomy non-eligible economic activities. i.e., to types of economic activity that is not described and does not have technical screening criteria set out in the EU Taxonomy Regulation",
