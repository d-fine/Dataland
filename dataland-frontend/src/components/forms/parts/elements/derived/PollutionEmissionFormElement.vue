<template>
  <FreeTextFormField
    ...
    description="Please describe the pollution type"
    validation="required"
  />
  <NumberFormField
    :name="'emissionInKilograms'"
    validation-label="emission in kilograms"
    label="Mass of pollutant in kg"
    description="Please specify the mass of the pollutant in kg"
    validation="min:0"
