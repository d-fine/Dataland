          ...
          <Card class="d-card">
            ...
            <template #content>
              <p class="text-gray-800 text-left">
                Preview Dataland by looking at <strong>EU Taxonomy</strong> data
                from more than <strong>300</strong> Germany public companies.
              </p>
              <div class="grid">
                <div class="col-3 col-offset-4 p-fluid pl-0">
                  <router-link to="/searchtaxonomy" class="no-underline">
                    ...
                    >
                      ...
                      <i class="material-icons pl-1" aria-hidden="true"
                        >chevron_right</i
                      >
                    </Button>
                  </router-link>
