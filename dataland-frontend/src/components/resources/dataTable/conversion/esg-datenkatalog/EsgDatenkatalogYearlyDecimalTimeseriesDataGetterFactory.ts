...
import EsgDatenkatalogYearlyDecimalTimeseriesModal from '@/components/resources/dataTable/modals/EsgDatenkatalogYearlyDecimalTimeseriesModal.vue';

/**
 * Formtas a EsgDatenkatalogYearlyDecimalTimeseries for display in the table using a modal
 ...
 */
export function formatEsgDatenkatalogYearlyDecimalTimeseriesDataForTable<KeyList extends string>(
  input: YearlyTimeseriesData<MappedOptionalDecimal<KeyList>> | null | undefined,
  options: EsgDatenkatalogYearlyDecimalTimeseriesDataConfiguration<KeyList>,
  fieldLabel: string
  ...
  if (
    ...
    return <MLDTDisplayObject<MLDTDisplayComponentName.ModalLinkDisplayComponent>>{
      ...
      displayValue: {
        label: `Show data`,
        modalComponent: EsgDatenkatalogYearlyDecimalTimeseriesModal,
        modalOptions: {
          props: {
            header: fieldLabel,
            modal: true,
