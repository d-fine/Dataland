...
export const p2pDataModel = [ {
  ...
  subcategories : [ {
    ...
    fields : [ {
      ...
      description : "Whether or not the organisational responsibility for Paris compatibility in the company lies with the Executive Board/Management",
      unit : "",
      ...
      description : "Share of executive managers with variable pay for meeting climate targets and transformation plans",
      unit : "Percentage",
      ...
      description : "Share of employees who have been trained, at least once, on how to integrate a Paris-compatible strategy into everyday work processes",
      unit : "Percentage",
      component : "PercentageFormField",
      evidenceDesired : false,
      required : false,
      ...
      description : "Qualification requirements and/or mandatory Paris-compatibility training for top management and employees",
      unit : "",
      component : "YesNoFormField",
      evidenceDesired : false,
      required : false,
      ...
      description : "Existence of a fit-for-purpose engagement strategy with relevant processes for the upstream supply chain",
      unit : "",
      component : "YesNoFormField",
      evidenceDesired : false,
      required : false,
      ...
      description : "Lobbying/advocacy: support for Paris-compatible lobbying activities in industry and business associations",
      unit : "",
      component : "YesNoFormField",
      evidenceDesired : false,
      required : false,
    ...
    fields : [ {
      ...
      description : "Use of a science-based, sector-specific Paris-compatible GHG emission reduction trajectory (Scopes 1-3) to meet climate targets and net-zero commitments represented in absolute emissions",
      unit : "Percentage",
      component : "PercentageFormField",
      evidenceDesired : false,
      required : false,
      ...
      description : "Use of a science-based, sector-specific Paris-compatible GHG emission reduction trajectory (Scopes 1-3) to meet climate targets and net-zero commitments represented in relative emissions (if applicable)",
      ...
      description : "Transparent accounting & disclosure of all greenhouse gas emissions (Scope 1, Scope 2, Scope 3) along the following metric: absolute emissions",
      unit : "t CO2e",
      component : "NumberFormField",
      evidenceDesired : false,
      required : false,
      ...
      description : "Transparent accounting & disclosure of all greenhouse gas emissions (Scope 1, Scope 2, Scope 3) along the following metric: relative emissions (if applicable)",
      ...
      description : "The internal/imputed/shadow carbon price and its dynamic structure should be derived from science-based models and scenarios that are consistent with the Paris targets.",
      unit : "",
      component : "YesNoFormField",
      evidenceDesired : false,
      required : false,
  ...
  label : "Ammonia",
  color : "green",
  showIf : (dataModel: PathwaysToParisData): boolean => dataModel.general.general.sector.some(p2pSector => p2pSector === P2pSector.Ammonia),
  subcategories : [ {
  ...
  label : "Automotive",
  color : "green",
  showIf : (dataModel: PathwaysToParisData): boolean => dataModel.general.general.sector.some(p2pSector => p2pSector === P2pSector.Automotive),
  subcategories : [ {
    name : "energy",
    label : "Energy",
    fields : [ {
    ...
    fields : [ {
      name : "driveMix",
      label : "Drive mix",
      description : "For manufacturers: Share of zero emission vehicles in new vehicles registered. For suppliers: Target use of the drive-relevant technologies",
      unit : "Percentage",
      component : "PercentageFormField",
      evidenceDesired : false,
      required : false,
  ...
  label : "HVC Plastics",
  color : "green",
  showIf : (dataModel: PathwaysToParisData): boolean => dataModel.general.general.sector.some(p2pSector => p2pSector === P2pSector.HvcPlastics),
  subcategories : [ {
    name : "decarbonisation",
    label : "Decarbonisation",
    fields : [ {
  ...
  label : "Commercial Real Estate",
  color : "green",
  showIf : (dataModel: PathwaysToParisData): boolean => dataModel.general.general.sector.some(p2pSector => p2pSector === P2pSector.CommercialRealEstate),
  subcategories : [ {
    ...
    fields : [ {
      ...
      description : "Share of buildings with a building-specific refurbishment roadmap that corresponds to the GHG emission reduction trajectory in total commercial buildings portfolio",
      unit : "Percentage",
      component : "PercentageFormField",
      evidenceDesired : false,
      required : false,
  ...
  label : "Residential Real Estate",
  color : "green",
  showIf : (dataModel: PathwaysToParisData): boolean => dataModel.general.general.sector.some(p2pSector => p2pSector === P2pSector.ResidentialRealEstate),
  subcategories : [ {
    name : "buildingEfficiency",
    label : "Building efficiency",
    fields : [ {
      name : "buildingSpecificReburbishmentRoadmap",
      label : "Building-specific reburbishment roadmap",
      description : "Share of buildings with a building-specific refurbishment roadmap that corresponds to the GHG emission reduction trajectory in total residential buildings portfolio",
      unit : "Percentage",
      component : "PercentageFormField",
      evidenceDesired : false,
      required : false,
  ...
  label : "Steel",
  color : "green",
  showIf : (dataModel: PathwaysToParisData): boolean => dataModel.general.general.sector.some(p2pSector => p2pSector === P2pSector.Steel),
  subcategories : [ {
    name : "energy",
    label : "Energy",
    fields : [ {
      ...
      description : "Use of green hydrogen according to the EU Taxonomy (only for hydrogen-based steel production)",
      unit : "",
      component : "YesNoFormField",
      evidenceDesired : false,
      required : false,
    ...
    fields : [ {
      ...
      description : "Phase-out pathway: Share of steel produced without CCS in steel production of the blast furnace route",
      unit : "Percentage",
      component : "PercentageFormField",
      evidenceDesired : false,
      required : false,
  ...
  label : "Freight transport by road",
  color : "green",
  showIf : (dataModel: PathwaysToParisData): boolean => dataModel.general.general.sector.some(p2pSector => p2pSector === P2pSector.FreightTransportByRoad),
  subcategories : [ {
    name : "technology",
    label : "Technology",
    fields : [ {
  ...
  label : "Electricity generation",
  color : "green",
  showIf : (dataModel: PathwaysToParisData): boolean => dataModel.general.general.sector.some(p2pSector => p2pSector === P2pSector.ElectricityGeneration),
  subcategories : [ {
    name : "technology",
    label : "Technology",
    fields : [ {
  ...
  label : "Livestock farming",
  color : "green",
  showIf : (dataModel: PathwaysToParisData): boolean => dataModel.general.general.sector.some(p2pSector => p2pSector === P2pSector.LivestockFarming),
  subcategories : [ {
    ...
    fields : [ {
      ...
      description : "Share of composted or fermented manure n the total amount of manure produced in indoor livestock systems",
      unit : "Percentage",
      component : "PercentageFormField",
      evidenceDesired : false,
      required : false,
      ...
      description : "Share of emission-proof storage of fertiliser in the total amount of fertiliser from indoor livestock systems",
      unit : "Percentage",
      component : "PercentageFormField",
      evidenceDesired : false,
      required : false,
    ...
    fields : [ {
      ...
      description : "Qualitative assessment of regional risks of origin (e.g. deforestation of rainforest, displacement of indigenous peoples for feed production) and the transport route.",
      unit : "",
      ...
      description : "Share of climate-friendly proteins farmed in the total amount of protein in the concentrated feed used",
      unit : "Percentage",
      component : "PercentageFormField",
      evidenceDesired : false,
      required : false,
  ...
  label : "Cement",
  color : "green",
  showIf : (dataModel: PathwaysToParisData): boolean => dataModel.general.general.sector.some(p2pSector => p2pSector === P2pSector.Cement),
  subcategories : [ {
    name : "energy",
    label : "Energy",
    fields : [ {
