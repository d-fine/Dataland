...
export default defineComponent({
  ...
  //  yes, previously we imported DetailsCompanyDataTable (which I now had to add again to to fix a bug when opening non-aligned modals)
  //  I understand the problem. Discussion needed how to fix.
  directives: {
    tooltip: Tooltip,
  },
  data() {
