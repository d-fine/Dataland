...
export const euTaxonomyForNonFinancialsDataModel = [ {
  ...
  subcategories : [ {
    ...
    fields : [ {
      ...
      description : "Absolute value and share of the revenue where the economic activity meets taxonomy criteria for substantial contribution to climate change mitigation and does no serious harm to the other environmental objectives (DNSH criteria)",
      unit : "(Percentage)",
  ...
  subcategories : [ {
    ...
    fields : [ {
      ...
      description : "Absolute value and share of the CapEx that is part of a plan to meet taxonomy criteria for substantial contribution to either climate change mitigation or climate change adaptation",
      unit : "",
      component : "FinancialShareFormField",
      evidenceDesired : false,
      required : false,
  ...
  subcategories : [ {
    ...
    fields : [ {
      ...
      description : "Absolute value and share of the OpEx that is part of a plan to meet the taxonomy criteria for substantial contribution to climate change adaptation and relevant DNSH criteria",
      unit : "(Percentage)",
      component : "FinancialShareFormField",
      evidenceDesired : false,
      required : false,
