    ...
    subcategories: [
      {
        ...
        fields: [
          ...
          {
            showIf: (dataModel): boolean => dataModel.general.masterData.groupOfCompanies === "Yes",
      ...
      },
      {
        ...
        fields: [
          ...
          {
            showIf: (dataModel): boolean => dataModel.general.productionSpecific.listOfProductionSites === "Yes",
            name: "capacity",
          ...
          {
            showIf: (dataModel): boolean =>
              dataModel.general.productionSpecific.isInHouseProductionOrIsContractProcessing === "Yes",
          ...
          {
            showIf: (dataModel): boolean => dataModel.general.productionSpecific.productionSites === "Yes",
      ...
      },
      {
        ...
        fields: [
          ...
          {
            showIf: (dataModel): boolean =>
              dataModel.general.riskManagementOwnOperations.adequateAndEffectiveRiskManagementSystem === "Yes",
          ...
          {
            showIf: (dataModel): boolean =>
              dataModel.general.riskManagementOwnOperations.riskManagementSystemFiscalYear === "Yes",
          ...
          {
            showIf: (dataModel): boolean =>
              dataModel.general.riskManagementOwnOperations.riskManagementSystemRisks === "Yes",
          ...
          {
            showIf: (dataModel): boolean =>
              dataModel.general.riskManagementOwnOperations.riskManagementSystemCounteract === "Yes",
          ...
          {
            showIf: (dataModel): boolean =>
              dataModel.general.riskManagementOwnOperations.environmentalManagementSystem === "Yes",
      ...
      },
      {
        ...
        fields: [
          ...
          {
            showIf: (dataModel): boolean =>
              dataModel.general.grievanceMechanismOwnOperations.grievanceHandlingMechanism === "Yes",
          ...
          {
            showIf: (dataModel): boolean =>
              dataModel.general.grievanceMechanismOwnOperations.grievanceMechanismComplaints === "Yes",
          ...
          {
            showIf: (dataModel): boolean =>
              dataModel.general.grievanceMechanismOwnOperations.grievanceMechanismComplaintsAction === "Yes",
    ...
    subcategories: [
      ...
      },
      {
        ...
        fields: [
          ...
          {
            showIf: (dataModel): boolean => dataModel.governance.humanRights.codeOfConduct === "Yes",
          ...
          {
            showIf: (dataModel): boolean => dataModel.governance.humanRights.policyStatement === "Yes",
          ...
          {
            showIf: (dataModel): boolean => dataModel.governance.humanRights.humanRightsViolation === "Yes",
          ...
          {
            showIf: (dataModel): boolean => dataModel.governance.humanRights.humanRightsViolationAction === "Yes",
          ...
          {
            showIf: (dataModel): boolean => dataModel.governance.humanRights.highRiskCountriesRawMaterials === "Yes",
          ...
          {
            showIf: (dataModel): boolean => dataModel.governance.humanRights.highRiskCountriesAcivitiy === "Yes",
          ...
          {
            showIf: (dataModel): boolean => dataModel.governance.humanRights.highRiskCountriesProcurement === "Yes",
    ...
    subcategories: [
      {
        ...
        fields: [
          ...
          {
            showIf: (dataModel): boolean => dataModel.social.childLabor.employeeUnder18 === "Yes",
          ...
          {
            showIf: (dataModel): boolean => dataModel.social.childLabor.worstFormsOfChildLabor === "Yes",
      ...
      },
      {
        ...
        fields: [
          ...
          {
            showIf: (dataModel): boolean => dataModel.social.disregardForOccupationalHealthSafety.oshPolicy === "Yes",
      ...
      },
      {
        ...
        fields: [
          ...
          {
            showIf: (dataModel): boolean =>
              dataModel.social.contaminationOfSoilWaterAirNoiseEmissionsExcessiveWaterConsumption.harmfulSoilChange ===
              "Yes",
    ...
    subcategories: [
      {
        ...
        fields: [
          ...
          {
            showIf: (dataModel): boolean =>
              dataModel.environmental.useOfMercuryMercuryWasteMinamataConvention.mercuryAddedProductsHandling === "Yes",
