        ...
        subcategories: [
          {
            ...
            fields: [
              ...
              },
              {
                ...
                name: "address",
                description:
                  "Enter the address of your company (format: street, house number, zip code, city, country)",
                label: "Address",
                component: "AddressFormField",
              },
              {
            ...
            fields: [
              ...
              },
              {
                showIf: (dataModel: LksgData): boolean =>
                  dataModel?.general?.productionSpecific?.listOfProductionSites === "Yes",
                name: "capacity",
              ...
              {
                showIf: (dataModel: LksgData): boolean =>
                  dataModel?.general?.productionSpecific?.productionSites === "Yes",
          ...
          },
          {
            ...
            fields: [
              ...
              },
              {
                ...
                description:
                  "State the number of direct suppliers per procurement category and country (own operations)",
          ...
          },
          {
            ...
            fields: [
              ...
              },
              {
                ...
                description:
                  "Is the necessary support provided so that the target groups can actually use the procedure?",
        ...
        subcategories: [
          ...
          },
          {
            ...
            fields: [
              ...
              {
                showIf: (dataModel: LksgData): boolean => dataModel?.governance?.humanRights?.codeOfConduct === "Yes",
              ...
              {
                showIf: (dataModel: LksgData): boolean => dataModel?.governance?.humanRights?.policyStatement === "Yes",
              ...
              {
                showIf: (dataModel: LksgData): boolean =>
                  dataModel?.governance?.humanRights?.humanRightsViolation === "Yes",
              ...
              {
                showIf: (dataModel: LksgData): boolean =>
                  dataModel?.governance?.humanRights?.humanRightsViolationAction === "Yes",
              ...
              {
                showIf: (dataModel: LksgData): boolean =>
                  dataModel?.governance?.humanRights?.highRiskCountriesRawMaterials === "Yes",
              ...
              {
                showIf: (dataModel: LksgData): boolean =>
                  dataModel?.governance?.humanRights?.highRiskCountriesAcivitiy === "Yes",
              ...
              {
                showIf: (dataModel: LksgData): boolean =>
                  dataModel?.governance?.humanRights?.highRiskCountriesProcurement === "Yes",
        ...
        subcategories: [
          {
            ...
            fields: [
              ...
              {
                showIf: (dataModel: LksgData): boolean =>
                  dataModel?.social?.childLabor?.worstFormsOfChildLabor === "Yes",
            ...
            fields: [
              {
                ...
                name: "adequatWage",
                description:
                  "Is your company currently withholding adequate wages (adequate in the sense of local laws)?",
                label: "Adequat Wage",
                component: "YesNoFormField",
              },
              {
          ...
          },
          {
            ...
            fields: [
              ...
              },
              {
                ...
                description:
                  "Does your company have a Health And Safety Policy? (If yes, please share the policy with us)",
        ...
        subcategories: [
          {
            ...
            fields: [
              ...
              {
                showIf: (dataModel: LksgData): boolean =>
                  dataModel?.environmental?.useOfMercuryMercuryWasteMinamataConvention
          ...
          },
          {
            ...
            fields: [
              ...
              {
                showIf: (dataModel: LksgData): boolean =>
                  dataModel?.environmental?.exportImportOfHazardousWasteBaselConvention?.hazardousWasteDisposal ===
                  "Yes",
