...
export const lksgFieldComponentTypes = {
  dataDate: "YesNoComponent",
  name: "YesNoComponent",
  address: "YesNoComponent",
  headOffice: "YesNoComponent",
  commercialRegister: "YesNoComponent",
  groupOfCompanies: "YesNoComponent",
  groupOfCompaniesName: "YesNoComponent",
  industry: "YesNoComponent",
  numberOfEmployees: "YesNoComponent",
  seasonalOrMigrantWorkers: "YesNoComponent",
  shareOfTemporaryWorkers: "YesNoComponent",
  totalRevenueCurrency: "YesNoComponent",
  totalRevenue: "YesNoComponent",
  fixedAndWorkigCapital: "YesNoComponent",
  listOfProductionSites: "YesNoComponent",
  capacity: "YesNoComponent",
  isInhouseProductionOrIsContractProcessing: "YesNoComponent",
  subcontractingCompaniesCountries: "YesNoComponent",
  subcontractingCompaniesIndustries: "YesNoComponent",
  productionSites: "YesNoComponent",
  numberOfProductionSites: "YesNoComponent",
  nameOfProductionSites: "YesNoComponent",
  addressesOfProductionSites: "YesNoComponent",
  listOfGoodsOrServices: "YesNoComponent",
  market: "YesNoComponent",
  specificProcurement: "YesNoComponent",
  mostImportantProducts: "YesNoComponent",
  productionSteps: "YesNoComponent",
  relatedCorporateSupplyChain: "YesNoComponent",
  productCategories: "YesNoComponent",
  definitionProductTypeservice: "YesNoComponent",
  sourcingCountryPerCategory: "YesNoComponent",
  numberOfDirectSuppliers: "YesNoComponent",
  orderVolumePerProcurement: "YesNoComponent",
  adequateAndEffectiveRiskManagementSystem: "YesNoComponent",
  riskManagementSystemFiscalYear: "YesNoComponent",
  riskManagementSystemRisks: "YesNoComponent",
  riskManagementSystemIdentifiedRisks: "YesNoComponent",
  riskManagementSystemCounteract: "YesNoComponent",
  riskManagementSystemMeasures: "YesNoComponent",
  riskManagementSystemResponsibility: "YesNoComponent",
  environmentalManagementSystem: "YesNoComponent",
  environmentalManagementSystemInternationalCertification: "YesNoComponent",
  environmentalManagementSystemNationalCertification: "YesNoComponent",
  grievanceHandlingMechanism: "YesNoComponent",
  grievanceHandlingMechanismUsedForReporting: "YesNoComponent",
  grievanceMechanismInformationProvided: "YesNoComponent",
  grievanceMechanismSupportProvided: "YesNoComponent",
  grievanceMechanismAccessToExpertise: "YesNoComponent",
  grievanceMechanismComplaints: "YesNoComponent",
  grievanceMechanismComplaintsNumber: "YesNoComponent",
  grievanceMechanismComplaintsReason: "YesNoComponent",
  grievanceMechanismComplaintsAction: "YesNoComponent",
  grievanceMechanismComplaintsActionUndertaken: "YesNoComponent",
  grievanceMechanismPublicAccess: "YesNoComponent",
  grievanceMechanismProtection: "YesNoComponent",
  grievanceMechanismDueDiligenceProcess: "YesNoComponent",
  sa8000Certification: "YesNoComponent",
  smetaSocialAuditConcept: "YesNoComponent",
  betterWorkProgramCertificate: "YesNoComponent",
  iso45001Certification: "YesNoComponent",
  iso14000Certification: "YesNoComponent",
  emasCertification: "YesNoComponent",
  iso37001Certification: "YesNoComponent",
  iso37301Certification: "YesNoComponent",
  riskManagementSystemCertification: "YesNoComponent",
  amforiBsciAuditReport: "YesNoComponent",
  responsibleBusinessAssociationCertification: "YesNoComponent",
  fairLaborAssociationCertification: "YesNoComponent",
  additionalAudits: "YesNoComponent",
  codeOfConduct: "YesNoComponent",
  codeOfConductTraining: "YesNoComponent",
  supplierCodeOfConduct: "YesNoComponent",
  policyStatement: "YesNoComponent",
  humanRightsStrategy: "YesNoComponent",
  environmentalImpactPolicy: "YesNoComponent",
  fairWorkingConditionsPolicy: "YesNoComponent",
  responsibilitiesForFairWorkingConditions: "YesNoComponent",
  responsibilitiesForTheEnvironment: "YesNoComponent",
  responsibilitiesForOccupationalSafety: "YesNoComponent",
  legalProceedings: "YesNoComponent",
  humanRightsViolation: "YesNoComponent",
  humanRightsViolationLocation: "YesNoComponent",
  humanRightsViolationAction: "YesNoComponent",
  humanRightsViolationActionMeasures: "YesNoComponent",
  highRiskCountriesRawMaterials: "YesNoComponent",
  highRiskCountriesRawMaterialsLocation: "YesNoComponent",
  highRiskCountriesAcivitiy: "YesNoComponent",
  highRiskCountries: "YesNoComponent",
  highRiskCountriesProcurement: "YesNoComponent",
  highRiskCountriesProcurementName: "YesNoComponent",
  employeeUnder18: "YesNoComponent",
  employeeUnder18Under15: "YesNoComponent",
  employeeUnder18Apprentices: "YesNoComponent",
  worstFormsOfChildLabor: "YesNoComponent",
  worstFormsOfChildLaborForms: "YesNoComponent",
  employmentUnderLocalMinimumAgePrevention: "YesNoComponent",
  employmentUnderLocalMinimumAgePreventionEmploymentContracts: "YesNoComponent",
  employmentUnderLocalMinimumAgePreventionJobDescription: "YesNoComponent",
  employmentUnderLocalMinimumAgePreventionIdentityDocuments: "YesNoComponent",
  employmentUnderLocalMinimumAgePreventionTraining: "YesNoComponent",
  employmentUnderLocalMinimumAgePreventionCheckingOfLegalMinimumAge: "YesNoComponent",
  childLaborMeasures: "YesNoComponent",
  childLaborPolicy: "YesNoComponent",
  forcedLaborAndSlaveryPrevention: "YesNoComponent",
  forcedLaborAndSlaveryPreventionPractices: "YesNoComponent",
  forcedLaborAndSlaveryPreventionMeasures: "YesNoComponent",
  forcedLaborAndSlaveryPreventionEmploymentContracts: "YesNoComponent",
  forcedLaborAndSlaveryPreventionIdentityDocuments: "YesNoComponent",
  forcedLaborAndSlaveryPreventionFreeMovement: "YesNoComponent",
  forcedLaborAndSlaveryPreventionProvisionSocialRoomsAndToilets: "YesNoComponent",
  forcedLaborAndSlaveryPreventionTraining: "YesNoComponent",
  forcedLaborAndSlaveryMeasures: "YesNoComponent",
  forcedLaborPolicy: "YesNoComponent",
  adequatWage: "YesNoComponent",
  adequatWageBeingWithheld: "YesNoComponent",
  documentedWorkingHoursAndWages: "YesNoComponent",
  adequateLivingWage: "YesNoComponent",
  regularWagesProcessFlow: "YesNoComponent",
  fixedHourlyWages: "YesNoComponent",
  fixedPieceworkWages: "YesNoComponent",
  adequateWageMeasures: "YesNoComponent",
  lowSkillWork: "YesNoComponent",
  hazardousMachines: "YesNoComponent",
  oshPolicy: "YesNoComponent",
  oshPolicyPersonalProtectiveEquipment: "YesNoComponent",
  oshPolicyMachineSafety: "YesNoComponent",
  oshPolicyDisasterBehaviouralResponse: "YesNoComponent",
  oshPolicyAccidentsBehaviouralResponse: "YesNoComponent",
  oshPolicyWorkplaceErgonomics: "YesNoComponent",
  oshPolicyAccessToWork: "YesNoComponent",
  oshPolicyHandlingChemicalsAndOtherHazardousSubstances: "YesNoComponent",
  oshPolicyFireProtection: "YesNoComponent",
  oshPolicyWorkingHours: "YesNoComponent",
  oshPolicyTrainingAddressed: "YesNoComponent",
  oshPolicyTraining: "YesNoComponent",
  oshManagementSystem: "YesNoComponent",
  oshManagementSystemInternationalCertification: "YesNoComponent",
  oshManagementSystemNationalCertification: "YesNoComponent",
  workplaceAccidentsUnder10: "YesNoComponent",
  oshTraining: "YesNoComponent",
  healthAndSafetyPolicy: "YesNoComponent",
  freedomOfAssociation: "YesNoComponent",
  representedEmployees: "YesNoComponent",
  discriminationForTradeUnionMembers: "YesNoComponent",
  freedomOfOperationForTradeUnion: "YesNoComponent",
  freedomOfAssociationTraining: "YesNoComponent",
  worksCouncil: "YesNoComponent",
  umequalTreatmentOfEmployment: "YesNoComponent",
  diversityAndInclusionRole: "YesNoComponent",
  preventionOfMistreatments: "YesNoComponent",
  equalOpportunitiesOfficer: "YesNoComponent",
  fairAndEthicalRecruitmentPolicy: "YesNoComponent",
  equalOpportunitiesAndNondiscriminationPolicy: "YesNoComponent",
  harmfulSoilChange: "YesNoComponent",
  soilDegradation: "YesNoComponent",
  soilErosion: "YesNoComponent",
  soilBornDiseases: "YesNoComponent",
  soilContamination: "YesNoComponent",
  soilSalinisation: "YesNoComponent",
  harmfulWaterPollution: "YesNoComponent",
  fertilisersOrPollutants: "YesNoComponent",
  wasteWaterFiltration: "YesNoComponent",
  harmfulAirPollution: "YesNoComponent",
  airFiltration: "YesNoComponent",
  harmfulNoiseEmission: "YesNoComponent",
  reduceNoiseEmissions: "YesNoComponent",
  excessiveWaterConsumption: "YesNoComponent",
  waterSavingMeasures: "YesNoComponent",
  waterSavingMeasuresName: "YesNoComponent",
  pipeMaintaining: "YesNoComponent",
  waterSources: "YesNoComponent",
  contaminationMeasures: "YesNoComponent",
  unlawfulEvictionAndTakingOfLand: "YesNoComponent",
  unlawfulEvictionAndTakingOfLandRisk: "YesNoComponent",
  unlawfulEvictionAndTakingOfLandStrategies: "YesNoComponent",
  unlawfulEvictionAndTakingOfLandStrategiesName: "YesNoComponent",
  voluntaryGuidelinesOnTheResponsibleGovernanceOfTenure: "YesNoComponent",
  useOfPrivatePublicSecurityForces: "YesNoComponent",
  useOfPrivatePublicSecurityForcesAndRiskOfViolationOfHumanRights: "YesNoComponent",
  instructionOfSecurityForces: "YesNoComponent",
  humanRightsTraining: "YesNoComponent",
  stateSecurityForces: "YesNoComponent",
  privateSecurityForces: "YesNoComponent",
  useOfPrivatePublicSecurityForcesMeasures: "YesNoComponent",
  mercuryAndMercuryWasteHandling: "YesNoComponent",
  mercuryAndMercuryWasteHandlingPolicy: "YesNoComponent",
  mercuryAddedproductsHandling: "YesNoComponent",
  mercuryAddedproductsHandlingRiskOfExposure: "YesNoComponent",
  mercuryAddedproductsHandlingRiskOfDisposal: "YesNoComponent",
  mercuryAndMercuryCompoundsProductionAndUse: "YesNoComponent",
  mercuryAndMercuryCompoundsProductionAndUseRiskOfExposure: "YesNoComponent",
  persistentOrganicPollutantsProductionAndUse: "YesNoComponent",
  persistentOrganicPollutantsUsed: "YesNoComponent",
  persistentOrganicPollutantsProductionAndUseRiskOfExposure: "YesNoComponent",
  persistentOrganicPollutantsProductionAndUseRiskOfDisposal: "YesNoComponent",
  legalRestrictedWasteProcesses: "YesNoComponent",
  persistentOrganicPollutantsProductionAndUseTransboundaryMovements: "YesNoComponent",
  persistentOrganicPollutantsProductionAndUseRiskForImportingState: "YesNoComponent",
  hazardousWasteTransboundaryMovementsLocatedOecdEuLiechtenstein: "YesNoComponent",
  hazardousWasteTransboundaryMovementsOutsideOecdEuLiechtenstein: "YesNoComponent",
  hazardousWasteDisposal: "YesNoComponent",
