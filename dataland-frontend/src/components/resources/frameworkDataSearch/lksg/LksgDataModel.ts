...
export const lksgDataModel = [ {
  ...
  subcategories : [ {
    ...
    fields : [ {
      ...
      description : "What is the total number of employees (including temporary workers with assignment duration >6 months)?",
    ...
    fields : [ {
      ...
      required : false,
      showIf : (dataModel: LksgData): boolean => dataModel?.general?.productionSpecific?.isContractProcessing === 'Yes',
    ...
    fields : [ {
      ...
      description : "Please give an overview of the most important products or services in terms of sales that your company manufactures and/or distributes or offers (own operations)",
  ...
  subcategories : [ {
    ...
    fields : [ {
      ...
      component : "YesNoFormField",
      required : false,
      showIf : (dataModel: LksgData): boolean => dataModel?.governance?.riskManagementOwnOperations?.adequateAndEffectiveRiskManagementSystem === 'Yes',
      certificateRequiredIfYes : false
    }, {
      ...
      description : "Is the responsibility for the Risk Management in your company regulated, for example by appointing a human rights officer?",
      component : "YesNoFormField",
      required : false,
      showIf : (dataModel: LksgData): boolean => dataModel?.governance?.riskManagementOwnOperations?.adequateAndEffectiveRiskManagementSystem === 'Yes',
      certificateRequiredIfYes : false
    ...
    fields : [ {
      ...
      description : "Has your company implemented a grievance mechanism (e.g., anonymous whistleblowing system) to protect human and environmental rights in your business?",
      component : "YesNoFormField",
      required : false,
      showIf : (): boolean => true,
      certificateRequiredIfYes : false
      ...
      description : "Can all affected stakeholders and rights holders, i.e. both internal (e.g. employees) and external stakeholders (e.g. suppliers and their employees, NGOs) use the grievance channel/whistleblowing system for reporting?",
      component : "YesNoFormField",
      required : false,
      ...
      description : "Is information about the process provided in a way that is adapted to the context and target groups?",
      component : "YesNoFormField",
      required : false,
      showIf : (dataModel: LksgData): boolean => dataModel?.governance?.grievanceMechanismOwnOperations?.grievanceHandlingMechanism === 'Yes',
      certificateRequiredIfYes : false
    ...
    fields : [ {
      ...
      description : "Is your company SA8000 certified? If yes, please share the certificate with us. (Corporate Social Responsibility)",
      component : "YesNoFormField",
      required : false,
      showIf : (): boolean => true,
      certificateRequiredIfYes : true
      ...
      description : "Does your company apply a social audit concept as defined by SMETA (Sedex Members Ethical Trade Audit)? (social audit)",
      component : "YesNoFormField",
      required : false,
      showIf : (): boolean => true,
      certificateRequiredIfYes : false
      ...
      description : "Is your company ISO45001 certified? If yes, please share the certificate with us. (Management Systems of Occupational Health and Safety)",
      component : "YesNoFormField",
      required : false,
      showIf : (): boolean => true,
      certificateRequiredIfYes : true
      ...
      description : "Is your company certified according to EMAS? If yes, please share the certificate with us. (Voluntary environmental management)",
      component : "YesNoFormField",
      required : false,
      showIf : (): boolean => true,
      certificateRequiredIfYes : true
      ...
      description : "Is your company ISO37001 certified? If yes, please share the certificate with us. (Anti-bribery management systems)",
      component : "YesNoFormField",
      required : false,
      showIf : (): boolean => true,
      certificateRequiredIfYes : true
      ...
      description : "Is your company ISO37301 certified? If yes, please share the certificate with us. (Compliance Management System)",
      component : "YesNoFormField",
      required : false,
      showIf : (): boolean => true,
      certificateRequiredIfYes : true
      ...
      description : "Is your company Responsible Business Association (RBA) certified? If yes, please share the certificate with us. (Social Responsibility)",
      component : "YesNoFormField",
      required : false,
      showIf : (): boolean => true,
      certificateRequiredIfYes : true
      ...
      description : "Is your company Fair Labor Association (FLA) certified? If yes, please share the certificate with us. (Adherence to international and national labor laws)",
      component : "YesNoFormField",
      required : false,
      showIf : (): boolean => true,
      certificateRequiredIfYes : true
      ...
      description : "Has your company implemented and enforced (e.g., within the Code Of Conducts) internal behavioural guidelines that address the issues of human rights protection and respect for the environment?",
      component : "YesNoFormField",
      required : false,
      showIf : (): boolean => true,
      certificateRequiredIfYes : false
      ...
      description : "Are your employees regularly made aware of the internal rules of conduct and trained on them?",
      component : "YesNoFormField",
      required : false,
      ...
      description : "Does your company have a Environmental Impact Policy? (If yes, please share the policy with us)",
      component : "YesNoFormField",
      required : false,
      showIf : (): boolean => true,
      certificateRequiredIfYes : true
    ...
    fields : [ {
      ...
      description : "Has your company established, according to the nature and extent of the enterprise’s business activities, official responsibilities for the topic of fair working conditions?",
      component : "YesNoFormField",
      required : false,
      showIf : (): boolean => true,
      certificateRequiredIfYes : false
      ...
      description : "Has your company established, according to the nature and extent of the enterprise’s business activities, official responsibilities for the topic of the environment?",
      component : "YesNoFormField",
      required : false,
      showIf : (): boolean => true,
      certificateRequiredIfYes : false
      ...
      description : "Has your company established, according to the nature and extent of the enterprise’s business activities, official responsibilities for the topic of occupational safety?",
      component : "YesNoFormField",
      required : false,
      showIf : (): boolean => true,
      certificateRequiredIfYes : false
      ...
      description : "Has your company been involved in the last 5 years, in legal disputes (including currently ongoing disputes) with third parties regarding human rights and environmental violations?",
      component : "YesNoFormField",
      required : false,
      showIf : (): boolean => true,
      certificateRequiredIfYes : false
      ...
      description : "Have there been any violations of human rights or environmental aspects on your part in the last 5 years?",
      component : "YesNoFormField",
      required : false,
      showIf : (): boolean => true,
      certificateRequiredIfYes : false
      ...
      component : "InputTextFormField",
      required : false,
      showIf : (dataModel: LksgData): boolean => dataModel?.governance?.generalViolations?.humanRightsViolation === 'Yes'
    }, {
      ...
      description : "Does your company have activities in countries where there are high risks for human rights and/or the environment?",
      component : "YesNoFormField",
      required : false,
      showIf : (): boolean => true,
      certificateRequiredIfYes : false
  ...
  subcategories : [ {
    ...
    fields : [ {
      ...
      description : "Are the employees under 18 years of age exclusively apprentices within the meaning of the locally applicable laws?",
      component : "YesNoFormField",
      required : false,
      showIf : (dataModel: LksgData): boolean => dataModel?.social?.childLabor?.employeeUnder18 === 'Yes',
      certificateRequiredIfYes : false
      ...
      component : "InputTextFormField",
      required : false,
      showIf : (dataModel: LksgData): boolean => dataModel?.social?.childLabor?.worstFormsOfChildLaborProhibition === 'Yes'
    }, {
      ...
      description : "Is a formal recruitment process including the conclusion of employment contracts such a measure?",
      component : "YesNoFormField",
      required : false,
      showIf : (dataModel: LksgData): boolean => dataModel?.social?.childLabor?.employmentUnderLocalMinimumAgePrevention === 'Yes',
      certificateRequiredIfYes : false
    }, {
      ...
      description : "Is a clear job description for employees under the local minimum age in the hiring process and employment contracts such a measure? (group of people between 15 and 18 years)",
      component : "YesNoFormField",
      required : false,
      showIf : (dataModel: LksgData): boolean => dataModel?.social?.childLabor?.employmentUnderLocalMinimumAgePrevention === 'Yes',
      certificateRequiredIfYes : false
      ...
      description : "Is the control of official documents (e.g. identity documents and certificates) such a measure?",
      component : "YesNoFormField",
      required : false,
      showIf : (dataModel: LksgData): boolean => dataModel?.social?.childLabor?.employmentUnderLocalMinimumAgePrevention === 'Yes',
      certificateRequiredIfYes : false
    ...
    fields : [ {
      ...
      description : "Is a formal hiring process, including employment contracts in the employee's local language, with appropriate wage and termination clauses, such a measure?",
      component : "YesNoFormField",
      required : false,
      ...
      description : "Is ensuring the free movement of employees through doors and windows that can be opened to leave the building/premises of your company at any time such a measure?",
      component : "YesNoFormField",
      required : false,
      showIf : (dataModel: LksgData): boolean => dataModel?.social?.forcedLaborSlavery?.forcedLaborAndSlaveryPreventionMeasures === 'Yes',
      certificateRequiredIfYes : false
    ...
    fields : [ {
      ...
      component : "YesNoFormField",
      required : false,
      showIf : (dataModel: LksgData): boolean => dataModel?.social?.withholdingAdequateWages?.adequateWageBeingWithheld === 'Yes',
      certificateRequiredIfYes : false
    }, {
      name : "adequateLivingWage",
      label : "Adequate Living Wage",
      description : "Does your company pay employees adequate wages? (the appropriate wage is at least the minimum wage set by the applicable law and is otherwise measured according to the law of the place of employment).",
      component : "YesNoFormField",
      required : false,
      showIf : (dataModel: LksgData): boolean => dataModel?.social?.withholdingAdequateWages?.adequateWageBeingWithheld === 'Yes',
      certificateRequiredIfYes : false
      ...
      description : "Has your company implemented the payment of wages through standardised and regular process flows?",
      component : "YesNoFormField",
      required : false,
      showIf : (dataModel: LksgData): boolean => dataModel?.social?.withholdingAdequateWages?.adequateWageBeingWithheld === 'Yes',
      certificateRequiredIfYes : false
      ...
      description : "Please list other measures (if available) you take to prevent the withholding adequate wages?",
      component : "InputTextFormField",
      required : false,
      showIf : (dataModel: LksgData): boolean => dataModel?.social?.withholdingAdequateWages?.adequateWageBeingWithheld === 'Yes'
    } ]
    ...
    fields : [ {
      ...
      description : "Is the subject area of behaviour in the event of and prevention of accidents addressed by this OSH Directive?",
      component : "YesNoFormField",
      required : false,
      showIf : (dataModel: LksgData): boolean => dataModel?.social?.disregardForOccupationalHealthSafety?.oshPolicy === 'Yes',
      certificateRequiredIfYes : false
      ...
      description : "Is the subject area of handling chemical, physical or biological substances addressed by this OSH Directive?",
      component : "YesNoNaFormField",
      required : false,
      showIf : (dataModel: LksgData): boolean => dataModel?.social?.disregardForOccupationalHealthSafety?.oshPolicy === 'Yes',
      certificateRequiredIfYes : false
      ...
      description : "Is the subject area of regulation of working hours, overtime and rest breaks be addressed by this OSH Directive?",
      component : "YesNoFormField",
      required : false,
      showIf : (dataModel: LksgData): boolean => dataModel?.social?.disregardForOccupationalHealthSafety?.oshPolicy === 'Yes',
      certificateRequiredIfYes : false
      ...
      description : "Is the subject area of training and instruction of employees with regard to occupational health and safety addressed by this OSH Directive?",
      component : "YesNoFormField",
      required : false,
      showIf : (dataModel: LksgData): boolean => dataModel?.social?.disregardForOccupationalHealthSafety?.oshPolicy === 'Yes',
      certificateRequiredIfYes : false
      ...
      description : "Is the number of incidents in which employees suffered work-related injuries with serious consequences less than 10 in the past fiscal year?",
      component : "YesNoFormField",
      required : false,
      showIf : (): boolean => true,
      certificateRequiredIfYes : false
      ...
      name : "oshTraining",
      label : "OSH Training",
      description : "Has your company introduced mandatory offers and training for employees to improve occupational safety?",
      component : "YesNoFormField",
      required : false,
      showIf : (): boolean => true,
      certificateRequiredIfYes : false
    ...
    fields : [ {
      ...
      description : "Does your company ensure that no discrimination is practised or other consequences taken against employees in the event of the formation, joining and membership of a trade union?",
      component : "YesNoFormField",
      required : false,
      showIf : (dataModel: LksgData): boolean => dataModel?.social?.disregardForFreedomOfAssociation?.freedomOfAssociation === 'Yes',
      certificateRequiredIfYes : false
      ...
      description : "Does your company ensure that trade unions are free to operate in accordance with the law of the place of employment?",
      component : "YesNoFormField",
      required : false,
      showIf : (dataModel: LksgData): boolean => dataModel?.social?.disregardForFreedomOfAssociation?.freedomOfAssociation === 'Yes',
      certificateRequiredIfYes : false
      ...
      description : "Do employees receive information about their rights as part of training and/or intranet, notices or company brochures?",
      component : "YesNoFormField",
      required : false,
      showIf : (): boolean => true,
      certificateRequiredIfYes : false
      ...
      name : "worksCouncil",
      label : "Works Council",
      description : "Does your company have a works council or an employee representative committee (if it can be set up in your company in accordance with local applicable legal provisions)?",
      component : "YesNoFormField",
      required : false,
      showIf : (): boolean => true,
      certificateRequiredIfYes : false
    ...
    fields : [ {
      ...
      description : "Does your company's management promote a work environment free from physical, sexual, mental and verbal abuse, threats or other forms of mistreatment? (e.g. diversity program)",
      component : "YesNoFormField",
      required : false,
      showIf : (): boolean => true,
      certificateRequiredIfYes : false
      ...
      description : "Does your company have a Equal Opportunities And Non-discrimination Policy? (If yes, please share the policy with us)",
      component : "YesNoFormField",
      required : false,
      showIf : (): boolean => true,
      certificateRequiredIfYes : true
    ...
    fields : [ {
      ...
      description : "Does your company have measures in place to prevent the degradation of soil structure caused by the use of heavy machinery?",
      component : "YesNoFormField",
      required : false,
      showIf : (dataModel: LksgData): boolean => dataModel?.social?.contaminationOfSoilWaterAirNoiseEmissionsExcessiveWaterConsumption?.harmfulSoilChange === 'Yes',
      certificateRequiredIfYes : false
    }, {
      name : "soilErosion",
      label : "Soil Erosion",
      ...
      description : "Does your company have measures in place to prevent the development of soil-borne diseases and pests and to maintain soil fertility?",
      component : "YesNoFormField",
      required : false,
      showIf : (dataModel: LksgData): boolean => dataModel?.social?.contaminationOfSoilWaterAirNoiseEmissionsExcessiveWaterConsumption?.harmfulSoilChange === 'Yes',
      certificateRequiredIfYes : false
      ...
      description : "Does your company have measures in place to prevent soil contamination by antibiotics and toxins?",
      component : "YesNoFormField",
      required : false,
      showIf : (dataModel: LksgData): boolean => dataModel?.social?.contaminationOfSoilWaterAirNoiseEmissionsExcessiveWaterConsumption?.harmfulSoilChange === 'Yes',
      certificateRequiredIfYes : false
      ...
      name : "waterSources",
      label : "Water Sources",
      description : "Does your company use water sources that are important for the local population or local agriculture?",
      component : "YesNoFormField",
      required : false,
      showIf : (dataModel: LksgData): boolean => dataModel?.social?.contaminationOfSoilWaterAirNoiseEmissionsExcessiveWaterConsumption?.excessiveWaterConsumption === 'Yes',
      certificateRequiredIfYes : false
    ...
    fields : [ {
      ...
      description : "Is your company, as a result of the acquisition, development and/or other use of land, forests and/or bodies of water, which secures a person's livelihood, at risk of \n O an unlawful eviction\n O carrying out an unlawful taking of land, forests and/or water?",
      component : "YesNoFormField",
      required : false,
      showIf : (): boolean => true,
      certificateRequiredIfYes : false
    ...
    fields : [ {
      ...
      description : "Does your company use private and/or public security forces to protect company projects or similar?",
      component : "YesNoFormField",
      required : false,
      showIf : (): boolean => true,
      certificateRequiredIfYes : false
      ...
      description : "Does your company have measures in place to prevent security forces during an operation from O violate the prohibition of torture and/or cruel, inhuman and/or degrading treatment O damages life or limb O impairs the right to organize and the freedom of association?",
      component : "YesNoFormField",
      required : false,
      ...
      description : "(Only in the case of state security forces) Before the security forces were commissioned, was it checked whether serious human rights violations by these units had already been documented?",
      component : "YesNoNaFormField",
      required : false,
      showIf : (dataModel: LksgData): boolean => dataModel?.social?.useOfPrivatePublicSecurityForcesWithDisregardForHumanRights?.useOfPrivatePublicSecurityForcesAndRiskOfViolationOfHumanRights === 'Yes',
      certificateRequiredIfYes : false
      ...
      description : "(Only in the case of private security forces) Have the contractual relationships with the security guards been designed in such a way that they comply with the applicable legal framework?",
      component : "YesNoNaFormField",
      required : false,
      showIf : (dataModel: LksgData): boolean => dataModel?.social?.useOfPrivatePublicSecurityForcesWithDisregardForHumanRights?.useOfPrivatePublicSecurityForcesAndRiskOfViolationOfHumanRights === 'Yes',
      certificateRequiredIfYes : false
      ...
      description : "Please list any other measures (if available) you are taking to prevent the use of private/public security forces in violation of human rights?",
      component : "InputTextFormField",
      required : false,
      showIf : (dataModel: LksgData): boolean => dataModel?.social?.useOfPrivatePublicSecurityForcesWithDisregardForHumanRights?.useOfPrivatePublicSecurityForcesAndRiskOfViolationOfHumanRights === 'Yes'
    } ]
  ...
  subcategories : [ {
    ...
    fields : [ {
      ...
      description : "Are you involved in the manufacture, use, treatment, and/or import or export of products containing mercury?",
      component : "YesNoFormField",
      required : false,
      showIf : (): boolean => true,
      certificateRequiredIfYes : false
      ...
      description : "Is there a risk of manufacturing, importing or exporting products containing mercury that are not subject to the exemption under Annex A Part 1 of the Minamata Convention (BGBI. 2017 II p.610, 611)?",
      component : "YesNoFormField",
      required : false,
      ...
      description : "If there are products that are only contaminated with mercury: Is there a risk within your company that mercury waste will be disposed of contrary to the provisions of Article 11 of the Minamata Agreement (BGBI. 2017 II p. 610, 611)?",
      component : "YesNoFormField",
      required : false,
      showIf : (dataModel: LksgData): boolean => dataModel?.environmental?.useOfMercuryMercuryWasteMinamataConvention?.mercuryAddedProductsHandling === 'Yes',
      certificateRequiredIfYes : false
    ...
    fields : [ {
      ...
      description : "Do you use and/or produce persistent organic pollutants (POPs), i.e. chemical compounds that break down and/or transform very slowly in the environment?",
      component : "YesNoFormField",
      required : false,
      showIf : (): boolean => true,
      certificateRequiredIfYes : false
      ...
      description : "Is there a risk in your company that these organic pollutants fall under Article 3 paragraph 1 letter a and Annex A of the Stockholm Convention of 23 May 2001 on persistent organic pollutants (Federal Law Gazette 2002 II p. 803, 804) (POPs Convention) and are therefore banned?",
      component : "YesNoFormField",
      required : false,
      showIf : (dataModel: LksgData): boolean => dataModel?.environmental?.productionAndUseOfPersistentOrganicPollutantsPopsConvention?.persistentOrganicPollutantsProductionAndUse === 'Yes',
      certificateRequiredIfYes : false
      ...
      description : "In relation to the waste of these pollutants, is there a risk that they will be subject to the rules laid down in the applicable legal system in accordance with the provisions of Article 6(1)(d)(i) and (ii) of the POP -Convention (BGBI. 2002 II p. 803, 804) and will O not be handled / collected / stored / transported in an environmentally sound manner O not be disposed of in an environmentally friendly manner, i.e. if possible disposed of in such a way that the persistent organic pollutants contained therein are destroyed or irreversibly converted?",
      component : "YesNoFormField",
      required : false,
      showIf : (dataModel: LksgData): boolean => dataModel?.environmental?.productionAndUseOfPersistentOrganicPollutantsPopsConvention?.persistentOrganicPollutantsProductionAndUse === 'Yes',
      certificateRequiredIfYes : false
      ...
      description : "Does your company have processes or measures in place to ensure the lawful handling of (hazardous) waste?",
      component : "YesNoFormField",
      required : false,
      showIf : (dataModel: LksgData): boolean => dataModel?.environmental?.productionAndUseOfPersistentOrganicPollutantsPopsConvention?.persistentOrganicPollutantsProductionAndUse === 'Yes',
      certificateRequiredIfYes : false
    ...
    fields : [ {
      ...
      description : "Is there a risk in your company that: hazardous waste within the meaning of the Basel Convention (Article 1 Paragraph 1, BGBI. 1994 II p. 2703, 2704) or other wastes that require special consideration (household waste, residues from incineration of household waste) (Article 1(2)) are transported across borders?",
      component : "YesNoFormField",
      required : false,
      showIf : (): boolean => true,
      certificateRequiredIfYes : false
      ...
      description : "Do you dispose of hazardous waste within the meaning of the Basel Convention (Article 1 Paragraph 1, BGBI. 1994 II p. 2703, 2704)?",
      component : "YesNoFormField",
      required : false,
      showIf : (): boolean => true,
      certificateRequiredIfYes : false
      ...
      description : "Are you at risk of having this waste imported from a country that is not a party to the Basel Convention?",
      component : "YesNoFormField",
      required : false,
