export const sfdrKpisNameMappings = {
  ...
  inorganicPollutantsInTonnes: "Inorganic Pollutants",
  airPollutantsInTonnes: "Air Pollutants",
  ozoneDepletionSubstancesInTonnes: "Ozone Depletion Substances",
  carbonReductionInitiatives: "Carbon Reduction Initiatives",
  highImpactClimateSectorEnergyConsumptionNaceAInGWh: "High Impact Climate Sector Energy Consumption NACE A",
  highImpactClimateSectorEnergyConsumptionNaceBInGWh: "High Impact Climate Sector Energy Consumption NACE B",
  highImpactClimateSectorEnergyConsumptionNaceCInGWh: "High Impact Climate Sector Energy Consumption NACE C",
  highImpactClimateSectorEnergyConsumptionNaceDInGWh: "High Impact Climate Sector Energy Consumption NACE D",
  highImpactClimateSectorEnergyConsumptionNaceEInGWh: "High Impact Climate Sector Energy Consumption NACE E",
  highImpactClimateSectorEnergyConsumptionNaceFInGWh: "High Impact Climate Sector Energy Consumption NACE F",
  highImpactClimateSectorEnergyConsumptionNaceGInGWh: "High Impact Climate Sector Energy Consumption NACE G",
  highImpactClimateSectorEnergyConsumptionNaceHInGWh: "High Impact Climate Sector Energy Consumption NACE H",
  highImpactClimateSectorEnergyConsumptionNaceLInGWh: "High Impact Climate Sector Energy Consumption NACE L",
  nonRenewableEnergyConsumptionInGWh: "Non-Renewable Energy Consumption",
  nonRenewableEnergyConsumptionCoalInGWh: "Non-Renewable Energy Consumption Coal",
  nonRenewableEnergyConsumptionCrudeOilInGWh: "Non-Renewable Energy Consumption Crude Oil",
  nonRenewableEnergyConsumptionFossilFuelsInGWh: "Non-Renewable Energy Consumption Fossil Fuels",
  nonRenewableEnergyConsumptionLigniteInGWh: "Non-Renewable Energy Consumption Lignite",
  nonRenewableEnergyConsumptionNaturalGasInGWh: "Non-Renewable Energy Consumption Natural Gas",
  nonRenewableEnergyConsumptionNuclearEnergyInGWh: "Non-Renewable Energy Consumption Nuclear Energy",
  nonRenewableEnergyConsumptionOtherInGWh: "Non-Renewable Energy Consumption Other",
  nonRenewableEnergyProductionInGWh: "Non-Renewable Energy Production",
  renewableEnergyConsumptionInGWh: "Renewable Energy Consumption",
  renewableEnergyProductionInGWh: "Renewable Energy Production",
  totalHighImpactClimateSectorEnergyConsumptionInGWh: "Total High Impact Climate Sector Energy Consumption",
  enterpriseValue: "Enterprise Value",
  fossilFuelSectorExposure: "Fossil Fuel Sector Exposure",
  scope1InTonnes: "Scope 1",
  scope2InTonnes: "Scope 2",
  scope3InTonnes: "Scope 3",
  ...
  workdaysLostInDays: "Workdays Lost",
  ...
  hazardousWasteInTonnes: "Hazardous Waste",
  ...
  wasteNonRecycledInTonnes: "Waste Non Recycled",
  emissionsToWaterInTonnes: "Emissions To Water",
  waterConsumptionInCubicMeters: "Water Consumption",
  waterManagementPolicy: "Water Management Policy",
  waterReusedInCubicMeters: "Water Reused",
...
export const sfdrKpisInfoMappings = {
  ...
  inorganicPollutantsInTonnes: "Amount of emissions of Inorganic Pollutants",
  airPollutantsInTonnes: "Amount of emissions of Air Pollutants",
  ozoneDepletionSubstancesInTonnes: "Amount of emissions of Ozone Depletion Substances",
  ...
  highImpactClimateSectorEnergyConsumptionNaceAInGWh: "Total energy consumption per high impact climate sector",
  highImpactClimateSectorEnergyConsumptionNaceBInGWh: "Total energy consumption per high impact climate sector",
  highImpactClimateSectorEnergyConsumptionNaceCInGWh: "Total energy consumption per high impact climate sector",
  highImpactClimateSectorEnergyConsumptionNaceDInGWh: "Total energy consumption per high impact climate sector",
  highImpactClimateSectorEnergyConsumptionNaceEInGWh: "Total energy consumption per high impact climate sector",
  highImpactClimateSectorEnergyConsumptionNaceFInGWh: "Total energy consumption per high impact climate sector",
  highImpactClimateSectorEnergyConsumptionNaceGInGWh: "Total energy consumption per high impact climate sector",
  highImpactClimateSectorEnergyConsumptionNaceHInGWh: "Total energy consumption per high impact climate sector",
  highImpactClimateSectorEnergyConsumptionNaceLInGWh: "Total energy consumption per high impact climate sector",
  nonRenewableEnergyConsumptionInGWh: "Value of energy consumed from non-renewable energy sources",
  nonRenewableEnergyConsumptionCoalInGWh: "Energy consumption by non-renewable energy sources such as coal",
  nonRenewableEnergyConsumptionCrudeOilInGWh: "Energy consumption by non-renewable energy sources such as crude oil",
  nonRenewableEnergyConsumptionFossilFuelsInGWh: "Total amount of non-renewable energy consumption",
  nonRenewableEnergyConsumptionLigniteInGWh: "Energy consumption by non-renewable energy sources such as lignite",
  nonRenewableEnergyConsumptionNaturalGasInGWh:
    "Energy consumption by non-renewable energy sources such as natural gas",
  ...
  nonRenewableEnergyProductionInGWh: "Value of energy produced from non-renewable energy sources",
  renewableEnergyConsumption: "Value of energy consumed from renewable energy sources",
  renewableEnergyProductionInGWh: "Value of energy produced from renewable energy sources",
  totalHighImpactClimateSectorEnergyConsumptionInGWh: "Total energy consumption per high impact climate sector",
  enterpriseValue:
  ...
  workdaysLostInDays: "Number of workdays lost to injuries, accidents, fatalities or illness",
  ...
  wasteNonRecycledInTonnes: "Tonnes of non-recycled waste generated by the company.",
  emissionsToWaterInTonnes: "Tonnes of Emissions To Water generated by the company.",
  waterConsumptionInCubicMeters: "Amount of water consumed by the company",
  waterManagementPolicy: "Does the company have a policies and procedures for water management?",
  waterReusedInCubicMeters: "Amount of water reused/reclaimed by the company",
