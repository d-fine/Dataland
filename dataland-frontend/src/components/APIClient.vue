          ...
          <div class="card-content ">
            ...
            <div class="row">
              <div class="input-field col s12 m6">
                <input type="text" v-model="data.id" class="autocomplete" placeholder="Search by ID"/>
                <button class="btn btn-sm btn-primary" @click="getDataById">Get by Id</button>
              </div>
              <div class="input-field col s12 m6 ">
                <input type="text" v-model="data.name" class="autocomplete" placeholder="Search by Name"/>
