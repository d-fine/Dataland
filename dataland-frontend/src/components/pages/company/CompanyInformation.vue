  ...
  <div v-if="companyInfo" class="container">
    <div class="row">
      <div class="col m12 s12">
        ...
        <ResultTable v-if="response" entity="Available Datasets" :data="response.data" route="/data/eutaxonomies/" :headers="['Data ID', 'Data Type']" linkKey="Data Type" linkID="Data ID" />
      </div>
    </div>
  </div>
</template>
