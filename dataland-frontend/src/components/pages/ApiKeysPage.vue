<template>
  ...
  >
    ...
    Are you sure you want to Regenerate the your API Key? <b>If you confirm, your previous token will be invalidated and your applications will stop working.</b>
    <template #footer>
  ...
  <TheContent class="surface-800 flex">
      <div class="col-12 text-left pb-0">
        <BackButton />
        <h1>API</h1> <Button @click="thereIsApiKey = !thereIsApiKey" label="There is API key" class="align-self-end" ></Button>
      </div>
    ...
    <div v-if="thereIsApiKey && !waitingForData">
      <div class="col-12 md:col-8 lg:col-6">
        <MessageComponent severity="success" :closable="false" class="border-2">
          <template #text-info>
            <div class="col-12">
              Make sure to copy your API Key now. You will not be able to access it again.
            </div>
            <div class="my-2">
        ...
        <MessageComponent severity="block" class="border-2">
          <template #text-info>
            If you don't have acess to your API Key you can generate a new one.
          </template>
...
export default defineComponent({
  name: "ApiKeysPage",
  components: { TheContent, TheHeader, MiddleCenterDiv, BackButton, MarginWrapper, Button, Dialog, InputText, ApiKeyCard, MessageComponent },
  setup() {
    return {
...
<style scoped>
.coppy-button {cursor:pointer}
.p-inputtext:enabled:focus {box-shadow: none}
</style>
