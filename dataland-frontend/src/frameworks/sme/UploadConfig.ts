...
export const smeDataModel = [    {
            ...
            },
        {
                ...
                },
            {
                ...
                component: "NumberFormField",
                required: false,
                showIf: (dataset: SmeData):boolean => dataset.basic?.workforceGeneralCharacteristics?.measureEmployees == "=full-time equivalents",
                ...
                },
            {
                ...
                component: "NumberFormField",
                required: false,
                showIf: (dataset: SmeData):boolean => dataset.basic?.workforceGeneralCharacteristics?.measureEmployees == "=head count",
