...
export const smeDataModel = [    {
            ...
            },
        {
            ...
            fields: [
                ...
                description: "Please disclose your total energy consumption in MWh (in the reporting period) for\n- fossil fuels ",
                ...
                },
            {
                ...
                description: "- electricity as reflected in utility billings. If available distinguish between renewable and non\x02renewable sources.",
            ...
            },
        {
            ...
            fields: [
                ...
                description: "Please disclose, if applicable, the pollutants (with respective amounts in kg) you emit to air, water and soil in your own operations.",
            ...
            },
        {
            ...
            fields: [
                ...
                description: "Please, provide a list of relevant company sites adjoint to key biodiversity areas (including their country, area in hectares, adjoint biodiversity area, and level of adjointness).",
            ...
            },
        {
                ...
                },
            {
                ...
                component: "NumberFormField",
                required: false,
                showIf: (dataset: SmeData):boolean => dataset.basic?.workforceGeneralCharacteristics?.measureEmployees == "FullTimeEquivalents",
                ...
                },
            {
                ...
                component: "NumberFormField",
                required: false,
                showIf: (dataset: SmeData):boolean => dataset.basic?.workforceGeneralCharacteristics?.measureEmployees == "HeadCount",
                ...
                },
            {
                ...
                description: "Please list your employees presented by the country they work in. (Use full-time equivalents or head count according to your initial choice.)",
            ...
            },
        {
            ...
            value: "Weekly" ,
                ...
                component: "RadioButtonsFormField",
                required: false,
                showIf: (dataset: SmeData):boolean => (parseInt(dataset.basic?.workforceGeneralCharacteristics?.numberEmployeesHead ?? dataset.basic?.workforceGeneralCharacteristics?.numberEmployeesFullTime)) >= 150,
    
                },
            {
                name: "grossPayMale",
                label: "Gross pay male",
                description: "Now taking into account all your employees, according to your choice of timeframe, please provide the gross pay for male respectively for female employees. ",
                ...
                },
            {
                ...
                description: "Taking into account all your employees and your choice of timeframe, please provide the number of average work hours (per week/year) by male respectively by female employees. ",
                ...
                },
            {
                ...
                description: "Please state the total and average numbers of annual training hours per employee, broken down by gender, that are related to the development of skills and competences, whether acquired through formal or informal forms of capacity-building.",
