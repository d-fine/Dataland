...
import {formatSmeEmployeesPerCountryForDisplay, formatSmeWasteClassificationObjectForDisplay, formatSmeSiteAndAreaForDisplay, formatSmePollutionEmissionForDisplay, formatSmeSubsidiaryForDisplay} from "@/components/resources/dataTable/conversion/sme/SmeDisplayValueGetters";
        ...
        ,
          children: [    {
            ...
            },
            {
              ...
              explanation: "Please list your employees presented by the country they work in. (Use full-time equivalents or head count according to your initial choice.)",
              shouldDisplay: (): boolean => true
            ,
              valueGetter: (dataset: SmeData): AvailableMLDTDisplayObjectTypes => formatSmeEmployeesPerCountryForDisplay(dataset.basic?.workforceGeneralCharacteristics?.employeesPerCountry, "Employees Per Country")
            ,
            },
            ],
        ...
        ,
          children: [    {
            ...
            },
            {
              ...
              shouldDisplay: (dataset: SmeData): boolean => (parseInt(dataset.basic?.workforceGeneralCharacteristics?.numberEmployeesHead ?? dataset.basic?.workforceGeneralCharacteristics?.numberEmployeesFullTime)) >= 150
            ,
              valueGetter: (dataset: SmeData): AvailableMLDTDisplayObjectTypes => {
            const mappings = {
                Annual: "annual",
