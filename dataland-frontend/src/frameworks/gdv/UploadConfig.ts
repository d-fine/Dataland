...
export const gdvDataModel: Category[] = [
    ...
    subcategories: [
      {
        ...
        fields: [
          ...
          {
            name: "treibhausgas-berichterstattungUndPrognosen",
      ...
      },
      {
        ...
        fields: [
          ...
          {
            name: "umsatz/investitionsaufwandFürNachhaltigeAktivitäten",
    ...
    subcategories: [
      ...
      },
      {
        ...
        fields: [
          ...
          {
            name: "überwachungDerEinkommensungleichheit",
      ...
      {
        name: "auswirkungenAufAnteilBefristerVerträgeUndFluktuation",
        label: "Auswirkungen auf Anteil befrister Verträge und Fluktuation",
        fields: [],
      },
      {
        name: "budgetFürSchulung/Ausbildung",
  ...
  },
  {
    ...
    subcategories: [
      ...
      {
        name: "veröffentlichteUnternehmensrichtlinien",
