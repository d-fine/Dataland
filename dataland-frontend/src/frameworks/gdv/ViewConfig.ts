...
export const GdvViewConfiguration: MLDTConfig<GdvData> = [    {
    ...
    ,
      children: [    {
        ...
        ,
          valueGetter: (dataset: GdvData): AvailableMLDTDisplayObjectTypes => formatStringForDatatable(dataset.allgemein?.statusE)
        ,
        },
        {
          type: "cell",
          label: "Einzelheiten zu den Rechtsstreitigkeiten E",
          explanation: "Bitte erläutern Sie Einzelheiten zu den Rechtsstreitigkeiten.",
          shouldDisplay: (dataset: GdvData): boolean => dataset.allgemein?.rechtsstreitigkeitenMitBezugZuE == "Yes"
        ,
          valueGetter: (dataset: GdvData): AvailableMLDTDisplayObjectTypes => formatStringForDatatable(dataset.allgemein?.einzelheitenZuDenRechtsstreitigkeitenE)
        ,
        },
        {
          type: "cell",
        ...
        ,
          valueGetter: (dataset: GdvData): AvailableMLDTDisplayObjectTypes => formatStringForDatatable(dataset.allgemein?.statusS)
        ,
        },
        {
          type: "cell",
          label: "Einzelheiten zu den Rechtsstreitigkeiten S",
          explanation: "Bitte erläutern Sie Einzelheiten zu den Rechtsstreitigkeiten.",
          shouldDisplay: (dataset: GdvData): boolean => dataset.allgemein?.rechtsstreitigkeitenMitBezugZuS == "Yes"
        ,
          valueGetter: (dataset: GdvData): AvailableMLDTDisplayObjectTypes => formatStringForDatatable(dataset.allgemein?.einzelheitenZuDenRechtsstreitigkeitenS)
        ,
        },
        {
          type: "cell",
        ...
        ,
          valueGetter: (dataset: GdvData): AvailableMLDTDisplayObjectTypes => formatStringForDatatable(dataset.allgemein?.statusG)
        ,
        },
        {
          type: "cell",
          label: "Einzelheiten zu den Rechtsstreitigkeiten G",
          explanation: "Bitte erläutern Sie Einzelheiten zu den Rechtsstreitigkeiten.",
          shouldDisplay: (dataset: GdvData): boolean => dataset.allgemein?.rechtsstreitigkeitenMitBezugZuG == "Yes"
        ,
          valueGetter: (dataset: GdvData): AvailableMLDTDisplayObjectTypes => formatStringForDatatable(dataset.allgemein?.einzelheitenZuDenRechtsstreitigkeitenG)
        ,
        },
        {
          type: "cell",
      ...
      children: [    {
        ...
        ,
          children: [    {
              ...
              shouldDisplay: (dataset: GdvData): boolean => dataset.general?.masterData?.berichtsPflicht == "Yes"
            ,
              valueGetter: (dataset: GdvData): AvailableMLDTDisplayObjectTypes => formatYesNoValueForDatatable(dataset.umwelt?.taxonomie?.taxonomieBerichterstattung)
            ,
            },
            ],
