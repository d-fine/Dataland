  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        valueGetter: (dataset: GdvData): AvailableMLDTDisplayObjectTypes =>
          formatStringForDatatable(dataset.allgemein?.statusE),
      },
      {
        type: "cell",
        ...
        shouldDisplay: (dataset: GdvData): boolean => dataset.allgemein?.rechtsstreitigkeitenMitBezugZuE == "Yes",
        valueGetter: (dataset: GdvData): AvailableMLDTDisplayObjectTypes =>
          formatStringForDatatable(dataset.allgemein?.einzelheitenZuDenRechtsstreitigkeitenE),
      },
      {
        type: "cell",
      ...
      },
      {
        ...
        valueGetter: (dataset: GdvData): AvailableMLDTDisplayObjectTypes =>
          formatStringForDatatable(dataset.allgemein?.statusS),
      },
      {
        type: "cell",
        ...
        shouldDisplay: (dataset: GdvData): boolean => dataset.allgemein?.rechtsstreitigkeitenMitBezugZuS == "Yes",
        valueGetter: (dataset: GdvData): AvailableMLDTDisplayObjectTypes =>
          formatStringForDatatable(dataset.allgemein?.einzelheitenZuDenRechtsstreitigkeitenS),
      },
      {
        type: "cell",
      ...
      },
      {
        ...
        valueGetter: (dataset: GdvData): AvailableMLDTDisplayObjectTypes =>
          formatStringForDatatable(dataset.allgemein?.statusG),
      },
      {
        type: "cell",
        ...
        shouldDisplay: (dataset: GdvData): boolean => dataset.allgemein?.rechtsstreitigkeitenMitBezugZuG == "Yes",
        valueGetter: (dataset: GdvData): AvailableMLDTDisplayObjectTypes =>
          formatStringForDatatable(dataset.allgemein?.einzelheitenZuDenRechtsstreitigkeitenG),
      },
      {
        type: "cell",
        label: "ESG-Rating",
        ...
        children: [
          {
            ...
            shouldDisplay: (dataset: GdvData): boolean => dataset.general?.masterData?.berichtsPflicht == "Yes",
            valueGetter: (dataset: GdvData): AvailableMLDTDisplayObjectTypes =>
              formatYesNoValueForDatatable(dataset.umwelt?.taxonomie?.taxonomieBerichterstattung),
          },
        ],
      },
    ],
