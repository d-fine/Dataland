...
export const GdvViewConfiguration: MLDTConfig<GdvData> = [    {
    ...
    ,
      children: [    {
        ...
        */
        ...
        return formatListOfStringsForDatatable(dataset.allgemein?.sektor?.map(it => 
           getOriginalNameFromTechnicalName(it, mappings)), 'Sektor')}
        ,
        },
        {
          type: "cell",
        ...
        */
        ...
        dataset.allgemein?.frequenzDerBerichterstattung ? getOriginalNameFromTechnicalName(dataset.allgemein?.frequenzDerBerichterstattung, mappings) : ""
        )
        }
        ,
        },
        ...
        */
        ...
        return formatStringForDatatable(
        dataset.allgemein?.anreizmechanismenFuerDasManagementUmwelt ? getOriginalNameFromTechnicalName(dataset.allgemein?.anreizmechanismenFuerDasManagementUmwelt, mappings) : ""
        )
        }
        ,
        },
        ...
        */
        ...
        return formatStringForDatatable(
        dataset.allgemein?.anreizmechanismenFuerDasManagementSoziales ? getOriginalNameFromTechnicalName(dataset.allgemein?.anreizmechanismenFuerDasManagementSoziales, mappings) : ""
        )
        }
        ,
        },
        ...
        */
        ...
        return formatStringForDatatable(
        dataset.allgemein?.statusZuE ? getOriginalNameFromTechnicalName(dataset.allgemein?.statusZuE, mappings) : ""
        )
        }
        ,
        },
        ...
        */
        ...
        return formatStringForDatatable(
        dataset.allgemein?.statusZuS ? getOriginalNameFromTechnicalName(dataset.allgemein?.statusZuS, mappings) : ""
        )
        }
        ,
        },
        ...
        */
        ...
        return formatStringForDatatable(
        dataset.allgemein?.statusZuG ? getOriginalNameFromTechnicalName(dataset.allgemein?.statusZuG, mappings) : ""
        )
        }
        ,
        },
        ...
        ,
          children: [    {
            ...
            },
            {
              ...
              shouldDisplay: (): boolean => true
            ,
              valueGetter: (dataset: GdvData): AvailableMLDTDisplayObjectTypes => formatGdvYearlyDecimalTimeseriesDataForTable(dataset.umwelt?.treibhausgasemissionen?.treibhausgasBerichterstattungUndPrognosen, {scope1:{label:"Scope 1",unitSuffix:"tCO2-Äquiv."},scope2:{label:"Scope 2",unitSuffix:"tCO2-Äquiv."},scope3:{label:"Scope 3",unitSuffix:"tCO2-Äquiv."}}, 'Treibhausgas-Berichterstattung und Prognosen')
            ,
            },
            ],
        ...
        ,
          children: [    {
            ...
            },
            {
              ...
              shouldDisplay: (): boolean => true
            ,
              valueGetter: (dataset: GdvData): AvailableMLDTDisplayObjectTypes => formatGdvYearlyDecimalTimeseriesDataForTable(dataset.umwelt?.energieverbrauch?.berichterstattungEnergieverbrauch, {energieverbrauch:{label:"Energieverbrauch",unitSuffix:"GWh"},verbrauchErneuerbareEnergien:{label:"Verbrauch erneuerbare Energien",unitSuffix:"%"},erzeugungErneuerbareEnergien:{label:"Erzeugung erneuerbare Energien",unitSuffix:"%"}}, 'Berichterstattung Energieverbrauch')
            ,
            },
            ],
        ...
        ,
          children: [    {
            ...
            },
            {
              ...
              shouldDisplay: (): boolean => true
            ,
              valueGetter: (dataset: GdvData): AvailableMLDTDisplayObjectTypes => formatGdvYearlyDecimalTimeseriesDataForTable(dataset.umwelt?.energieeffizienzImmobilienanlagen?.berichterstattungEnergieverbrauchVonImmobilienvermoegen, {energieeffizienteImmobilienanlagen:{label:"energieeffiziente Immobilienanlagen",unitSuffix:"%"}}, 'Berichterstattung Energieverbrauch von Immobilienvermoegen')
            ,
            },
            ],
        ...
        ,
          children: [    {
            ...
            },
            {
              ...
              shouldDisplay: (): boolean => true
            ,
              valueGetter: (dataset: GdvData): AvailableMLDTDisplayObjectTypes => formatGdvYearlyDecimalTimeseriesDataForTable(dataset.umwelt?.wasserverbrauch?.berichterstattungWasserverbrauch, {wasserverbrauch:{label:"Wasserverbrauch",unitSuffix:"l"},emissionenInWasser:{label:"Emissionen in Wasser",unitSuffix:"t"}}, 'Berichterstattung Wasserverbrauch')
            ,
            },
            ],
        ...
        ,
          children: [    {
            ...
            },
            {
              ...
              shouldDisplay: (): boolean => true
            ,
              valueGetter: (dataset: GdvData): AvailableMLDTDisplayObjectTypes => formatGdvYearlyDecimalTimeseriesDataForTable(dataset.umwelt?.abfallproduktion?.berichterstattungAbfallproduktion, {abfallmenge:{label:"Abfallmenge",unitSuffix:"t"},anteilRecycelterAbfallmenge:{label:"Anteil der recycelten Abfallmenge",unitSuffix:"%"},anteilGefaehrlicherAbfallmenge:{label:"Anteil gefährlicher Abfall an Gesamtmenge",unitSuffix:"%"}}, 'Berichterstattung Abfallproduktion')
            ,
            },
            {
              type: "cell",
              label: "Recycling im Produktionsprozess",
              explanation: "Bitte geben Sie an, wie hoch der Anteil an Recyclaten (bereitsrecyceltes wiederverwertetes Material) im Produktionsprozess für das aktuelle Kalenderjahr, die letzten drei Jahren sowie die Prognosen für die kommenden drei Jahre.",
              shouldDisplay: (): boolean => true
            ,
              valueGetter: (dataset: GdvData): AvailableMLDTDisplayObjectTypes => formatGdvYearlyDecimalTimeseriesDataForTable(dataset.umwelt?.abfallproduktion?.recyclingImProduktionsprozess, {anteilAnRecyclaten:{label:"Anteil an Recyclaten",unitSuffix:"%"}}, 'Recycling im Produktionsprozess')
            ,
            },
            ],
        ...
        ,
          children: [    {
            ...
            },
            {
              ...
              shouldDisplay: (): boolean => true
            ,
              valueGetter: (dataset: GdvData): AvailableMLDTDisplayObjectTypes => formatGdvYearlyDecimalTimeseriesDataForTable(dataset.umwelt?.fossileBrennstoffe?.berichterstattungEinnahmenAusFossilenBrennstoffen, {anteilEinnahmenAusFossilenBrennstoffen:{label:"Anteil der Einnahmen aus fossilen Brennstoffen",unitSuffix:"%"}}, 'Berichterstattung Einnahmen aus fossilen Brennstoffen')
            ,
            },
            ],
        ...
        ,
          children: [    {
            ...
            */
            ...
            return formatStringForDatatable(
            dataset.umwelt?.taxonomie?.taxonomieBerichterstattung ? getOriginalNameFromTechnicalName(dataset.umwelt?.taxonomie?.taxonomieBerichterstattung, mappings) : ""
            )
            }
            ,
            },
            ...
            },
            {
              ...
              shouldDisplay: (): boolean => true
            ,
              valueGetter: (dataset: GdvData): AvailableMLDTDisplayObjectTypes => formatGdvYearlyDecimalTimeseriesDataForTable(dataset.umwelt?.taxonomie?.umsatzInvestitionsaufwandFuerNachhaltigeAktivitaeten, {umsatzInvestitionsaufwandAusNachhaltigenAktivitaeten:{label:"Umsatz/Investitionsaufwand für nachhaltige Aktivitäten",unitSuffix:"Mio. €"}}, 'Umsatz\/Investitionsaufwand f\u00FCr nachhaltige Aktivit\u00E4ten')
            ,
            },
            ],
    ...
    ,
      children: [    {
        ...
        ,
          children: [    {
            ...
            },
            {
              ...
              shouldDisplay: (): boolean => true
            ,
              valueGetter: (dataset: GdvData): AvailableMLDTDisplayObjectTypes => formatGdvYearlyDecimalTimeseriesDataForTable(dataset.soziales?.einkommensgleichheit?.ueberwachungDerEinkommensungleichheit, {geschlechtsspezifischesLohngefaelle:{label:"Geschlechtsspezifisches Lohngefälle",unitSuffix:"%"},einkommensungleichheitsverhaeltnis:{label:"Einkommensungleichheitsverhältnis",unitSuffix:"%"},ceoEinkommenungleichheitsverhaeltnis:{label:"CEO-Einkommensungleichheitsverhältnis",unitSuffix:"%"}}, '\u00DCberwachung der Einkommensungleichheit')
            ,
            },
            ],
        ...
        ,
          children: [    {
            ...
            */
            ...
            return formatStringForDatatable(
            dataset.soziales?.audit?.artDesAudits ? getOriginalNameFromTechnicalName(dataset.soziales?.audit?.artDesAudits, mappings) : ""
            )
            }
            ,
            },
        ...
        },
        {
          ...
          shouldDisplay: (): boolean => true
        ,
          valueGetter: (dataset: GdvData): AvailableMLDTDisplayObjectTypes => formatGdvYearlyDecimalTimeseriesDataForTable(dataset.soziales?.anzahlDerBetroffenenMitarbeiter, {anzahlUnbefristeteVertraege:{label:"Anzahl der unbefristeten Verträge",unitSuffix:""},anzahlvonAenderungBetroffeneVertraege:{label:"Anzahl der von Änderung betroffenen Verträge",unitSuffix:""}}, 'Anzahl der betroffenen Mitarbeiter')
        ,
        },
        {
          type: "cell",
          ...
          shouldDisplay: (): boolean => true
        ,
          valueGetter: (dataset: GdvData): AvailableMLDTDisplayObjectTypes => formatGdvYearlyDecimalTimeseriesDataForTable(dataset.soziales?.auswirkungenAufAnteilBefristerVertraegeUndFluktuation, {anzahlbefristeteVertraege:{label:"Anzahl der befristeten Verträge",unitSuffix:""},fluktuation:{label:"Fluktuation",unitSuffix:"%"}}, 'Auswirkungen auf Anteil befrister Vertr\u00E4ge und Fluktuation')
        ,
        },
        {
          type: "cell",
          ...
          shouldDisplay: (): boolean => true
        ,
          valueGetter: (dataset: GdvData): AvailableMLDTDisplayObjectTypes => formatGdvYearlyDecimalTimeseriesDataForTable(dataset.soziales?.budgetFuerSchulungAusbildung, {budgetProMitarbeiterProJahr:{label:"Budget pro Mitarbeiter und Jahr",unitSuffix:"€"}}, 'Budget f\u00FCr Schulung\/Ausbildung')
        ,
        },
        ],
    ...
    },
    {
      ...
      shouldDisplay: (): boolean => true
    ,
      valueGetter: (dataset: GdvData): AvailableMLDTDisplayObjectTypes => formatGdvYearlyDecimalTimeseriesDataForTable(dataset.unfallrate, {haeufigkeitsrateVonArbeitsunfaellen:{label:"Häufigkeitsrate von Arbeitsunfällen mit Zeitverlust",unitSuffix:"%"}}, 'Unfallrate')
    ,
    },
    ];