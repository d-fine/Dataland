...
export const GdvViewConfiguration: MLDTConfig<GdvData> = [    {
      ...
      children: [    {
        ...
        ,
          children: [    {
              ...
              shouldDisplay: (dataset: GdvData): boolean => dataset.negativeAktivitaetenFuerDieBiologischeVielfalt == "Yes"
            ,
            ...
            },
            {
              ...
              shouldDisplay: (dataset: GdvData): boolean => dataset.positiveAktivitaetenFuerDieBiologischeVielfalt == "Yes"
            ,
    ...
    },
    {
      ...
      shouldDisplay: (dataset: GdvData): boolean => dataset.general?.masterData?.gueltigkeitsDatum == "Yes"
    ,
      valueGetter: (dataset: GdvData): AvailableMLDTDisplayObjectTypes => formatYesNoValueForDatatable(dataset.negativeAktivitaetenFuerDieBiologischeVielfalt)
    ,
    },
    {
      type: "cell",
      ...
      shouldDisplay: (dataset: GdvData): boolean => dataset.general?.masterData?.gueltigkeitsDatum == "Yes"
    ,
      valueGetter: (dataset: GdvData): AvailableMLDTDisplayObjectTypes => formatYesNoValueForDatatable(dataset.positiveAktivitaetenFuerDieBiologischeVielfalt)
    ,
    },
    {
      type: "section",
