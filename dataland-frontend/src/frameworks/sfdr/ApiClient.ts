...
export class SfdrApiClient implements PublicFrameworkDataApi<SfdrData> {
  ...
  postExportJobCompanyAssociatedDataByDimensions(
    ...
    return this.openApiDataController.postExportJobCompanyAssociatedSfdrDataByDimensions({reportingPeriods, companyIds, fileFormat}, keepValueFieldsOnly, includeAliases, options);
  }
  ...
  postExportLatestJobCompanyAssociatedDataByDimensions(
     ...
     includeAliases?: boolean,
     options?: AxiosRequestConfig): AxiosPromise<ExportJobInfo> {
    return this.openApiDataController.postExportLatestJobCompanyAssociatedSfdrDataByDimensions({companyIds, fileFormat}, keepValueFieldsOnly, includeAliases, options);
  }
