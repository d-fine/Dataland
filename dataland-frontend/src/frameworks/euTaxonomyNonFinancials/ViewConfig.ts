          ...
          },
          {
            ...
            valueGetter: (dataset: EutaxonomynonfinancialsData): AvailableMLDTDisplayObjectTypes =>
              wrapDisplayValueWithDatapointInformation(
                formatYesNoValueForDatatable(dataset.general?.general?.euTaxonomyActivityLevelReporting?.value),
                "EU Taxonomy Activity Level Reporting",
                dataset.general?.general?.euTaxonomyActivityLevelReporting,
              ),
          },
          {
            type: "cell",
            ...
            shouldDisplay: (): boolean => true,
            valueGetter: (dataset: EutaxonomynonfinancialsData): AvailableMLDTDisplayObjectTypes =>
              formatYesNoValueForDatatable(dataset.general?.general?.nfrdMandatory),
          },
        ],
      },
    ],
        ...
        children: [
          {
            ...
            shouldDisplay: (): boolean => true,
            valueGetter: (dataset: EutaxonomynonfinancialsData): AvailableMLDTDisplayObjectTypes =>
              formatNumberForDatatable(dataset.revenue?.revenue?.totalRevenue, ""),
          },
          {
            type: "cell",
            ...
            shouldDisplay: (): boolean => true,
            valueGetter: (dataset: EutaxonomynonfinancialsData): AvailableMLDTDisplayObjectTypes =>
              formatNumberForDatatable(dataset.revenue?.revenue?.eligibleRevenue, ""),
          },
          {
            type: "cell",
            ...
            shouldDisplay: (): boolean => true,
            valueGetter: (dataset: EutaxonomynonfinancialsData): AvailableMLDTDisplayObjectTypes =>
              formatNumberForDatatable(dataset.revenue?.revenue?.alignedRevenue, ""),
          },
          {
            type: "cell",
          ...
          },
          {
            ...
            shouldDisplay: (): boolean => true,
            valueGetter: (dataset: EutaxonomynonfinancialsData): AvailableMLDTDisplayObjectTypes =>
              formatNumberForDatatable(dataset.revenue?.revenue?.nonAlignedRevenue, ""),
          },
          {
            type: "cell",
            ...
            shouldDisplay: (): boolean => true,
            valueGetter: (dataset: EutaxonomynonfinancialsData): AvailableMLDTDisplayObjectTypes =>
              formatNumberForDatatable(dataset.revenue?.revenue?.nonEligibleRevenue, ""),
          },
          {
            type: "cell",
        ...
        children: [
          {
            ...
            shouldDisplay: (): boolean => true,
            valueGetter: (dataset: EutaxonomynonfinancialsData): AvailableMLDTDisplayObjectTypes =>
              formatNumberForDatatable(dataset.capex?.capex?.totalCapex, ""),
          },
          {
            type: "cell",
            ...
            shouldDisplay: (): boolean => true,
            valueGetter: (dataset: EutaxonomynonfinancialsData): AvailableMLDTDisplayObjectTypes =>
              formatNumberForDatatable(dataset.capex?.capex?.eligibleCapex, ""),
          },
          {
            type: "cell",
            label: "Aligned CapEx",
            ...
            shouldDisplay: (): boolean => true,
            valueGetter: (dataset: EutaxonomynonfinancialsData): AvailableMLDTDisplayObjectTypes =>
              formatNumberForDatatable(dataset.capex?.capex?.alignedCapex, ""),
          },
          {
            type: "cell",
            label: "Substantial Contribution to Climate Change Mitigation",
          ...
          },
          {
            ...
            shouldDisplay: (): boolean => true,
            valueGetter: (dataset: EutaxonomynonfinancialsData): AvailableMLDTDisplayObjectTypes =>
              formatNumberForDatatable(dataset.capex?.capex?.nonAlignedCapex, ""),
          },
          {
            type: "cell",
            ...
            shouldDisplay: (): boolean => true,
            valueGetter: (dataset: EutaxonomynonfinancialsData): AvailableMLDTDisplayObjectTypes =>
              formatNumberForDatatable(dataset.capex?.capex?.nonEligibleCapex, ""),
          },
          {
            type: "cell",
        ...
        children: [
          {
            ...
            shouldDisplay: (): boolean => true,
            valueGetter: (dataset: EutaxonomynonfinancialsData): AvailableMLDTDisplayObjectTypes =>
              formatNumberForDatatable(dataset.opex?.opex?.totalOpex, ""),
          },
          {
            type: "cell",
            label: "Eligible OpEx",
            ...
            shouldDisplay: (): boolean => true,
            valueGetter: (dataset: EutaxonomynonfinancialsData): AvailableMLDTDisplayObjectTypes =>
              formatNumberForDatatable(dataset.opex?.opex?.eligibleOpex, ""),
          },
          {
            type: "cell",
            label: "Aligned OpEx",
            ...
            shouldDisplay: (): boolean => true,
            valueGetter: (dataset: EutaxonomynonfinancialsData): AvailableMLDTDisplayObjectTypes =>
              formatNumberForDatatable(dataset.opex?.opex?.alignedOpex, ""),
          },
          {
            type: "cell",
            label: "Substantial Contribution to Climate Change Mitigation",
          ...
          },
          {
            ...
            shouldDisplay: (): boolean => true,
            valueGetter: (dataset: EutaxonomynonfinancialsData): AvailableMLDTDisplayObjectTypes =>
              formatNumberForDatatable(dataset.opex?.opex?.nonAlignedOpex, ""),
          },
          {
            type: "cell",
            ...
            shouldDisplay: (): boolean => true,
            valueGetter: (dataset: EutaxonomynonfinancialsData): AvailableMLDTDisplayObjectTypes =>
              formatNumberForDatatable(dataset.opex?.opex?.nonEligibleOpex, ""),
          },
          {
            type: "cell",
            label: "Enabling OpEx",
