        ...
        children: [
          {
            ...
            valueGetter: (dataset: EutaxonomyNonFinancials202673Data): AvailableMLDTDisplayObjectTypes =>
              formatEuTaxonomyNonFinancialsEligibleOrAlignedActivitiesDataForTable(
                dataset.revenue?.eligibleOrAlignedActivities?.eligibleOrAlignedActivities,
                'Eligible or Aligned Activities',
                'revenue'
              ),
            uploadComponentName: 'EligibleOrAlignedActivitiesFormField',
            dataPointTypeId:
              'extendedEuTaxonomyEligibleOrAlignedActivitiesComponentRevenueEligibleOrAlignedActivitiesEligibleOrAlignedActivities',
          },
        ],
      },
    ],
        ...
        children: [
          {
            ...
            valueGetter: (dataset: EutaxonomyNonFinancials202673Data): AvailableMLDTDisplayObjectTypes =>
              formatEuTaxonomyNonFinancialsEligibleOrAlignedActivitiesDataForTable(
                dataset.capex?.eligibleOrAlignedActivities?.eligibleOrAlignedActivities,
                'Eligible or Aligned Activities',
                'capex'
              ),
            uploadComponentName: 'EligibleOrAlignedActivitiesFormField',
            dataPointTypeId:
              'extendedEuTaxonomyEligibleOrAlignedActivitiesComponentCapexEligibleOrAlignedActivitiesEligibleOrAlignedActivities',
          },
        ],
      },
    ],
        ...
        children: [
          {
            ...
            valueGetter: (dataset: EutaxonomyNonFinancials202673Data): AvailableMLDTDisplayObjectTypes =>
              formatEuTaxonomyNonFinancialsEligibleOrAlignedActivitiesDataForTable(
                dataset.opex?.eligibleOrAlignedActivities?.eligibleOrAlignedActivities,
                'Eligible or Aligned Activities',
                'opex'
              ),
            uploadComponentName: 'EligibleOrAlignedActivitiesFormField',
            dataPointTypeId:
              'extendedEuTaxonomyEligibleOrAlignedActivitiesComponentOpexEligibleOrAlignedActivitiesEligibleOrAlignedActivities',
          },
        ],
      },
    ],
