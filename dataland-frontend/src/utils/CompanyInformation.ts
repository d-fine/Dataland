...
} from "@/utils/SearchCompaniesForFrameworkDataPageDataRequester.ts";
 ...
 */
export async function getCompanyInformation(companyId: string, apiClientProvider: ApiClientProvider): Promise<
    {
...
async function getParentCompany(parentCompanyLei: string, hasParentCompany: boolean):
