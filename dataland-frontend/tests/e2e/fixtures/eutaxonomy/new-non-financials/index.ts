import { type NewEuTaxonomyDataForNonFinancials } from "@clients/backend";
import { generateFixtureDataset } from "@e2e/fixtures/FixtureUtils";
import { generateNewEuTaxonomyDataForNonFinancials } from "./NewEuTaxonomyDataForNonFinancialsFixtures";
import fs from "fs";
import { generateNewEuTaxonomyForNonFinancialsPreparedFixtures } from "@e2e/fixtures/eutaxonomy/new-non-financials/NewEuTaxonomyDataForNonFinancialsPreparedFixtures";
...
export function exportFixturesNewEuTaxonomyForNonFinancials(): void {
  const companyInformationWithNewEuTaxonomyDataForNonFinancials =
    generateFixtureDataset<NewEuTaxonomyDataForNonFinancials>(generateNewEuTaxonomyDataForNonFinancials, 150);
