  ...
  return {
    general: {
        general: {
            ...
            fiscalYearDeviation: dataGenerator.randomExtendedDataPoint(dataGenerator.valueOrNull(pickOneElement(Object.values(SfdrGeneralGeneralFiscalYearDeviationOptions)))),
    ...
    environmental: {
        greenhouseGasEmissions: {
            ...
            carbonFootprintInTonnesPerMillionEUREnterpriseValue: dataGenerator.randomExtendedDataPoint(dataGenerator.randomFloat()),
            ghgIntensityInTonnesPerMillionEURRevenue: dataGenerator.randomExtendedDataPoint(dataGenerator.randomFloat()),
            ghgIntensityScope1InTonnesPerMillionEURRevenue: dataGenerator.randomExtendedDataPoint(dataGenerator.randomFloat()),
            ghgIntensityScope2InTonnesPerMillionEURRevenue: dataGenerator.randomExtendedDataPoint(dataGenerator.randomFloat()),
            ghgIntensityScope3InTonnesPerMillionEURRevenue: dataGenerator.randomExtendedDataPoint(dataGenerator.randomFloat()),
            ghgIntensityScope4InTonnesPerMillionEURRevenue: dataGenerator.randomExtendedDataPoint(dataGenerator.randomFloat()),
    ...
    social: {
        socialAndEmployeeMatters: {
            ...
            boardGenderDiversitySupervisoryBoardInPercent: dataGenerator.randomExtendedDataPoint(dataGenerator.randomFloat(0, 100)),
            boardGenderDiversityBoardOfDirectorsInPercent: dataGenerator.randomExtendedDataPoint(dataGenerator.randomFloat(0, 100)),
