  ...
  return {
    ...
    allgemein: {
        ...
        sektoren: {
            ...
            auflistungDerSektoren: dataGenerator.valueOrNull(pickSubsetOfElements(["A", "B", "C", "D", "E", "F", "G", "H", "L"])),
        },
        esgBerichte: {
            ...
            aktuelleBerichte: dataGenerator.valueOrNull(generateArray(() => dataGenerator.guaranteedBaseDataPoint(dataGenerator.guaranteedShortString()), 1, 5, 0)),
        },
        akkreditierungen: {
            ...
            weitereAkkreditierungen: dataGenerator.valueOrNull(generateArray(() => dataGenerator.guaranteedBaseDataPoint(dataGenerator.guaranteedShortString()), 1, 5, 0)),
        },
    ...
    umwelt: {
        treibhausgasemissionen: {
            ...
            treibhausgasBerichterstattungUndPrognosen: dataGenerator.randomDecimalYearlyTimeseriesData(["scope1", "scope2", "scope3"]),
        },
        ...
        energieverbrauch: {
            ...
            berichterstattungEnergieverbrauch: dataGenerator.randomDecimalYearlyTimeseriesData(["energieverbrauch", "verbrauchErneuerbareEnergien", "erzeugungErneuerbareEnergien"]),
        },
        energieeffizienzImmobilienanlagen: {
            ...
            berichterstattungEnergieverbrauchVonImmobilienvermoegen: dataGenerator.randomDecimalYearlyTimeseriesData(["energieeffizienteImmobilienanlagen"]),
        },
        wasserverbrauch: {
            unternehmensGruppenStrategieBzglWasserverbrauch: dataGenerator.randomShortString(),
            berichterstattungWasserverbrauch: dataGenerator.randomDecimalYearlyTimeseriesData(["wasserverbrauch", "emissionenInWasser"]),
        },
        abfallproduktion: {
            unternehmensGruppenStrategieBzglAbfallproduktion: dataGenerator.randomShortString(),
            berichterstattungAbfallproduktion: dataGenerator.randomDecimalYearlyTimeseriesData(["abfallmenge", "anteilRecycelterAbfallmenge", "anteilGefaehrlicherAbfallmenge"]),
        ...
        fossileBrennstoffe: {
            ...
            berichterstattungEinnahmenAusFossilenBrennstoffen: dataGenerator.randomDecimalYearlyTimeseriesData(["anteilEinnahmenAusFossilenBrennstoffen"]),
        },
        taxonomie: {
            ...
            umsatzInvestitionsaufwandFuerNachhaltigeAktivitaeten: dataGenerator.randomDecimalYearlyTimeseriesData(["umsatzInvestitionsaufwandAusNachhaltigenAktivitaeten"]),
        },
    },
    soziales: {
        ...
        einkommensgleichheit: {
            ...
            ueberwachungDerEinkommensungleichheit: dataGenerator.randomDecimalYearlyTimeseriesData(["geschlechtsspezifischesLohngefaelle", "einkommensungleichheitsverhaeltnis", "ceoEinkommenungleichheitsverhaeltnis"]),
        },
        ...
        anzahlDerBetroffenenMitarbeiter: dataGenerator.randomDecimalYearlyTimeseriesData(["anzahlUnbefristeteVertraege", "anzahlvonAenderungBetroffeneVertraege"]),
        auswirkungenAufAnteilBefristerVertraegeUndFluktuation: dataGenerator.randomDecimalYearlyTimeseriesData(["anzahlbefristeteVertraege", "fluktuation"]),
    ...
    unternehmensfuehrungGovernance: {
        ...
        veroeffentlichteUnternehmensrichtlinien: dataGenerator.valueOrNull(pickSubsetOfElements(["Anti-Korruption", "Verhaltenskodex", "Interessenkonflikte", "Datenschutz", "Diversit\u00E4t & Inklusion", "Faire Behandlung von Kunden", "Zwangsarbeit", "Gesundheit und Sicherheit", "Mgt von Umweltgefahren", "Verantwortungsvolles Marketing", "Whistleblowing", "other"])),
