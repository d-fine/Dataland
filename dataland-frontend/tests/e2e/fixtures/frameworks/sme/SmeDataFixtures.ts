  ...
  return {
    basic: {
        ...
        practicesForTransitioningTowardsAMoreSustainableEconomy: {
            undertakenMeasures: dataGenerator.valueOrNull(generateArray(() => dataGenerator.guaranteedBaseDataPoint(dataGenerator.guaranteedShortString()), 1, 5, 0)),
        },
        ...
        resourceUseCircularEconomyAndWasteManagement: {
            ...
            wasteClassification: dataGenerator.randomArray(() => dataGenerator.generateRandomSmeWasteClassificationObject(), 0, 3),
        },
        ...
        workersInTheValueChainAffectedCommunitiesConsumersAndEndUsers: {
            negativeEffects: dataGenerator.valueOrNull(generateArray(() => dataGenerator.guaranteedBaseDataPoint(dataGenerator.guaranteedShortString()), 1, 5, 0)),
