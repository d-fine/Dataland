...
import {LksgGeneralProductionspecificMarketOptions, LksgGeneralMasterdataShareOfTemporaryWorkersOptions, type LksgData} from "@clients/backend";
  ...
  return {
    general: {
        ...
        productionSpecific: {
            ...
            specificProcurement: dataGenerator.valueOrNull(pickSubsetOfElements(["ShortLivedAndChangingBusinessRelationships", "HighPricePressure", "TightlyTimedOrShortTermAdjustedDeliveryDeadlinesAndConditionsWithSuppliers", "NoneOfTheAbove"])),
        },
    ...
    governance: {
        ...
        grievanceMechanismOwnOperations: {
            ...
            complaintsRiskPosition: dataGenerator.randomArray(() => dataGenerator.generateLksgGrievanceMechanismAssessment(), 1, 5),
        ...
        certificationsPoliciesAndResponsibilities: {
            ...
            flaFairLaborCodeAndComplianceBenchmarksForAgriculture: dataGenerator.randomBaseDataPoint(dataGenerator.guaranteedYesNo()),
            flaFairLaborCodeAndComplianceBenchmarksForManufacturing: dataGenerator.randomBaseDataPoint(dataGenerator.guaranteedYesNo()),
        ...
        generalViolations: {
            ...
            humanRightsOrEnvironmentalViolationsDefinition: dataGenerator.randomArray(() => dataGenerator.generateLksgRiskOrViolationAssessment(), 1, 5),
            highRiskCountriesRawMaterials: dataGenerator.randomYesNo(),
            highRiskCountriesRawMaterialsLocation: dataGenerator.valueOrNull(pickSubsetOfElements([ "DE", "AL", "AZ", "GB", "US", "DK"])),
            ...
            highRiskCountriesProcurementName: dataGenerator.valueOrNull(pickSubsetOfElements([ "DE", "AL", "AZ", "GB", "US", "DK"])),
        },
    },
    social: {
        childLabor: {
    ...
    environmental: {
        ...
        exportImportOfHazardousWasteBaselConvention: {
            ...
            hazardousWasteTransportPreventionOtherMeasures: dataGenerator.randomBaseDataPoint(dataGenerator.guaranteedYesNo()),
