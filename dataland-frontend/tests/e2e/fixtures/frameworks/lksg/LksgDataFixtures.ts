...
import {LksgGeneralProductionspecificSpecificProcurementOptions, LksgGeneralProductionspecificMarketOptions, LksgGeneralMasterdataShareOfTemporaryWorkersOptions, type LksgData} from "@clients/backend";
  ...
  return {
    general: {
        masterData: {
            ...
            shareOfTemporaryWorkers: dataGenerator.valueOrNull(pickOneElement(Object.values(LksgGeneralMasterdataShareOfTemporaryWorkersOptions))),
        ...
        productionSpecific: {
            ...
            subcontractingCompaniesCountries: dataGenerator.valueOrNull(pickSubsetOfElements(["Iso2Codes"])),
            ...
            specificProcurement: dataGenerator.valueOrNull(pickOneElement(Object.values(LksgGeneralProductionspecificSpecificProcurementOptions))),
        },
        productionSpecificOwnOperations: {
            ...
            procurementCategories: dataGenerator.randomArray(() => dataGenerator.generateProcurementCategory(), 0, 10),
        },
    },
    governance: {
        riskManagementOwnOperations: {
            ...
            identifiedRisks: dataGenerator.valueOrNull(pickSubsetOfElements(["LksgRiskPositions"])),
        ...
        grievanceMechanismOwnOperations: {
            ...
            complaintsRiskPosition: dataGenerator.valueOrNull(pickSubsetOfElements(["LksgRiskPositions"])),
        ...
        generalViolations: {
            ...
            humanRightsOrEnvironmentalViolationsDefinition: dataGenerator.valueOrNull(pickSubsetOfElements(["LksgRiskPositions"])),
            ...
            highRiskCountriesRawMaterialsLocation: dataGenerator.valueOrNull(pickSubsetOfElements(["Iso2Codes"])),
            highRiskCountriesActivity: dataGenerator.randomYesNo(),
            highRiskCountries: dataGenerator.valueOrNull(pickSubsetOfElements(["Iso2Codes"])),
            highRiskCountriesProcurement: dataGenerator.randomYesNo(),
            highRiskCountriesProcurementName: dataGenerator.valueOrNull(pickSubsetOfElements(["Iso2Codes"])),
        },
    },
    social: {
        childLabor: {
            ...
            employmentUnderLocalMinimumAgePreventionTraining: dataGenerator.randomBaseDataPoint(dataGenerator.guaranteedYesNo()),
        ...
        forcedLaborSlavery: {
            ...
            forcedLaborAndSlaveryPreventionOtherMeasures: dataGenerator.randomBaseDataPoint(dataGenerator.guaranteedYesNo()),
        ...
        unlawfulEvictionDeprivationOfLandForestAndWater: {
            ...
            unlawfulEvictionAndTakingOfLandOtherMeasures: dataGenerator.randomBaseDataPoint(dataGenerator.guaranteedYesNo()),
    ...
    environmental: {
        useOfMercuryMercuryWasteMinamataConvention: {
            ...
            mercuryAndMercuryWasteUsePreventionOtherMeasures: dataGenerator.randomBaseDataPoint(dataGenerator.guaranteedYesNo()),
        ...
        productionAndUseOfPersistentOrganicPollutantsPopsConvention: {
            ...
            persistentOrganicPollutantsUsePreventionOtherMeasures: dataGenerator.randomBaseDataPoint(dataGenerator.guaranteedYesNo()),
