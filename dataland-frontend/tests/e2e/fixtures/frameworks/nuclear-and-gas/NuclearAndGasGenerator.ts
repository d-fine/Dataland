...
import {
    type NuclearAndGasAlignedDenominator,
    type NuclearAndGasAlignedNumerator,
    type NuclearAndGasEligibleButNotAligned, NuclearAndGasEnvironmentalObjective,
    type NuclearAndGasNonEligible,
