  ...
  return {
    general: {
      ...
      methodik: {
        ...
        datenquelle: dataGenerator.randomBaseDataPoint(dataGenerator.guaranteedShortString()),
    ...
    environmental: {
      nachhaltigskeitsrisiken: {
        ...
        quelle: dataGenerator.randomBaseDataPoint(dataGenerator.guaranteedShortString()),
