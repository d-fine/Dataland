...
import { EsgQuestionnaireSozialesAuditArtDesAuditsOptions } from "@clients/backend/org/dataland/datalandfrontend/openApiClient/backend/model/esg-questionnaire-soziales-audit-art-des-audits-options";
import { EsgQuestionnaireAllgemeinEsgberichteFrequenzDerBerichterstattungOptions } from "@clients/backend/org/dataland/datalandfrontend/openApiClient/backend/model/esg-questionnaire-allgemein-esgberichte-frequenz-der-berichterstattung-options";
import { EsgQuestionnaireAllgemeinFuehrungsstandardsAnreizmechanismenFuerDasManagementUmweltOptions } from "@clients/backend/org/dataland/datalandfrontend/openApiClient/backend/model/esg-questionnaire-allgemein-fuehrungsstandards-anreizmechanismen-fuer-das-management-umwelt-options";
import { EsgQuestionnaireAllgemeinFuehrungsstandardsAnreizmechanismenFuerDasManagementSozialesOptions } from "@clients/backend/org/dataland/datalandfrontend/openApiClient/backend/model/esg-questionnaire-allgemein-fuehrungsstandards-anreizmechanismen-fuer-das-management-soziales-options";
import { EsgQuestionnaireUmweltTaxonomieTaxonomieBerichterstattungOptions } from "@clients/backend/org/dataland/datalandfrontend/openApiClient/backend/model/esg-questionnaire-umwelt-taxonomie-taxonomie-berichterstattung-options";
import { EsgQuestionnaireAllgemeinRechtsstreitigkeitenStatusZuGOptions } from "@clients/backend/org/dataland/datalandfrontend/openApiClient/backend/model/esg-questionnaire-allgemein-rechtsstreitigkeiten-status-zu-goptions";
import { EsgQuestionnaireAllgemeinRechtsstreitigkeitenStatusZuSOptions } from "@clients/backend/org/dataland/datalandfrontend/openApiClient/backend/model/esg-questionnaire-allgemein-rechtsstreitigkeiten-status-zu-soptions";
import { EsgQuestionnaireAllgemeinRechtsstreitigkeitenStatusZuEOptions } from "@clients/backend/org/dataland/datalandfrontend/openApiClient/backend/model/esg-questionnaire-allgemein-rechtsstreitigkeiten-status-zu-eoptions";
