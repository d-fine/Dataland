 ...
 */
export async function generateLksgFixture(numFixtures: number): Promise<FixtureData<LksgData>[]> {
  return await generateFixtureDataset<LksgData>(
    generateLksgData,
    numFixtures,
 ...
 */
export function generateLksgData(dataDate?: string): Promise<LksgData> {
  return new Promise<LksgData>((resolve) => {
    resolve({
      social: {
        general: {
