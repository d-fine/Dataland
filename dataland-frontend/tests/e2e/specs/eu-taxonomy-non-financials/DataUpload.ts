...
describeIf(
  ...
  function () {
     ...
     */
    function validateFileCanNotBeUploadedDialogIsOpenAndClose() {
     ...
     */
    function validateFileCanNotBeUploadedDialogIsClosed() {
      cy.contains(".p-dialog-content", "file cannot be selected").should("not.exist");
    }

    it.only("Check if the file upload info remove button works as expected and make sure the file content hashes" +
