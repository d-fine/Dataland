// cypress/component/DocumentMetaDataDialog.cy.js
...
describe('Component test for the Document Meta Data Dialog', () => {
  ...
  function mockRequestsOnMounted(): void {
    ...
    cy.intercept('**/api/companies/dummy-company-id-1', {
      body: dummyCompanyInformation1,
      times: 1,
    }).as('fetchFirstCompanyInformation');
    cy.intercept('**/api/companies/dummy-company-id-2', {
   ...
   */
  function mountDocumentMetaDataDialog(): Cypress.Chainable {
