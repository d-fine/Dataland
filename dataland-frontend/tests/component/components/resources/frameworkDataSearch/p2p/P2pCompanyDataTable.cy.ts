...
//TODO maybe this is can be removed if we only use one dataTable component
describe("Component test for P2pCompanyDataTable", () => {
  ...
  it("Check that certificate/policy download links are displayed as expected", () => {
    ...
    cy.mountWithPlugins(P2pCompanyDataTable, {
