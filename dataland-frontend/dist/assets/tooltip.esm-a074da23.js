import{W as m,ar as y,$ as d,a5 as v,ab as b,a0 as a,aa as h}from"./index-24faf217.js";var $=`
.p-tooltip {
    position:absolute;
    display:none;
    pointer-events:none;
...
`,_={root:"p-tooltip p-component",arrow:"p-tooltip-arrow",text:"p-tooltip-text"},O=m($,{name:"tooltip",manual:!0}),w=O.load,E=y.extend({css:{classes:_,loadStyle:w}});function T(o,t){return x(o)||H(o,t)||L(o,t)||S()}function S(){throw new TypeError(`Invalid attempt to destructure non-iterable instance.
...
//# sourceMappingURL=tooltip.esm-a074da23.js.map
