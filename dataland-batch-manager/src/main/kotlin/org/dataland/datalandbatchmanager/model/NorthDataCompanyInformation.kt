...
data class NorthDataCompanyInformation(
  @JsonProperty("Name") val companyName: String,
  @JsonProperty("Ort") val headquarters: String,
  @JsonProperty("PLZ") val headquartersPostalCode: String,
  @JsonProperty("LEI") val lei: String,
  @JsonProperty("Land") val countryCode: String,
  @JsonProperty("Register ID") val registerId: String,
  @JsonProperty("Straﬂe") val street: String?,
  @JsonProperty("USt.-Id.") val vatId: String,
  @JsonProperty("Status") val status: String,
  @JsonProperty("Branchencode") val sector: String?,
) : ExternalCompanyInformation {
  /**
   * function to transform a company information object from NorthData to the corresponding Dataland
   * object.
   *
  ...
  override fun toCompanyPost(): CompanyInformation {
    ...
    if (registerId != "")
      identifiers[IdentifierType.CompanyRegistrationNumber.value] = listOf(registerId)
  ...
  /**
   * Transform the North Data company information to a PATCH object that can be used to update the
   * information of the company using the Dataland API
   */
  override fun toCompanyPatch(conflictingIdentifiers: Set<String?>?): CompanyInformationPatch? {
    ...
    if (conflictingIdentifiers != null) {
      ...
      val hasRegisterId =
        conflictingIdentifiers.contains(IdentifierType.CompanyRegistrationNumber.value)
    ...
    if (!returnFullPatch) {
      return CompanyInformationPatch(sectorCodeWz = sector, identifiers = identifiers)
    }
  ...
  override fun getNameAndIdentifier(): String {
    return "$companyName " + " (RegisterID: $registerId, VatId: $vatId and LEI: $lei)"
  }
}
