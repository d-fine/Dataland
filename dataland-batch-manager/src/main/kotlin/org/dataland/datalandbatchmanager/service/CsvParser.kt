...
class CsvParser {
  ...
  private fun getCsvFromInputStream(zipInputStream: ZipInputStream): BufferedReader {
    ...
    require(foundCsv) { "The downloaded ZIP file does not contain a CSV file" }
  ...
  /**
   * Reads the zip file and checks for the contained zipped CSV file and returns the content as
   * buffered reader
   *
  ...
  fun getCsvStreamFromNorthDataZipFile(zipFile: File): BufferedReader {
    ...
    require(foundContainedZip) { "Could not find zipped CSV file in zip file" }
   ...
   */
  private final inline fun <reified T> readDataFromBufferedReader(
   ...
   */
  fun readGleifRelationshipDataFromBufferedReader(
    bufferedReader: BufferedReader
   ...
   * @return An iterable of the corresponding objects
   */
  fun readGleifCompanyDataFromBufferedReader(
    bufferedReader: BufferedReader
   ...
   * @return An iterable of the corresponding objects
   */
  fun readNorthDataFromBufferedReader(
    bufferedReader: BufferedReader
