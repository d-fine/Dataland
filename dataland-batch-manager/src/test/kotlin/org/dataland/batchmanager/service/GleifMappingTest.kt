...
class GleifMappingTest {
  ...
  private val expectedCompanyInformation =
    CompanyInformation(
      ...
      sector = null,
      website = null,
      identifiers = mapOf(IdentifierType.Lei.value to listOf(expectedGleifCompanyInformation.lei)),
    )
  ...
  fun `check that parsing the test file results in the expected company information objects`() {
    ...
    val companyInformation =
      GleifCompanyCombinedInformation(gleifCompanyInformation).toCompanyPost()
