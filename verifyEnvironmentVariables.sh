...
expected_vars=( \
  ...
  NOTIFICATION_RECEIVERS_BULK_DATA_REQUEST \
  NOTIFICATION_RECEIVERS_CC_BULK_DATA_REQUEST \
  NOTIFICATION_RECEIVERS_DATA_OWNERSHIP_REQUEST \
  NOTIFICATION_RECEIVERS_CC_DATA_OWNERSHIP_REQUEST \
)
