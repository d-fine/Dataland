...
dependencyResolutionManagement {
    versionCatalogs {
        create("libs") {
            ...
            library("dataland-edc-client", "org.dataland:dataland-edc-client:0.2.21-SNAPSHOT")
            ...
            library("jackson-dataformat-csv", "com.fasterxml.jackson.dataformat:jackson-dataformat-csv:2.13.4")
