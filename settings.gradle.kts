...
dependencyResolutionManagement {
    versionCatalogs {
        create("libs") {
            ...
            library("log4j", "org.apache.logging.log4j:log4j:3.0.0-alpha1")
            library("log4j-api", "org.apache.logging.log4j:log4j-api:3.0.0-alpha1")
            library("log4j-to-slf4j", "org.apache.logging.log4j:log4j-to-slf4j:3.0.0-alpha1")
