...
class MessageQueueUtils {
  /**
   * rejectMessageOnException is a wrapper function which provides a possibility to add a try catch
   * block to a function The catch will throw a MessageQueueRejectException
   *
