...
object QueueNames {
    ...
    const val QA_SERVICE_NON_SOURCEABILITY_EVENTS = "qa-service.nonSourceabilityLifecycle"
    const val BACKEND_DATA_PERSISTED = "backend.removeDataFromMemory"
    const val BACKEND_NON_SOURCEABILITY_EVENTS = "backend.nonSourceabilityLifecycle"
    ...
    const val DATA_SOURCING_SERVICE_NON_SOURCEABILITY_EVENTS = "data-sourcing-service.nonSourceabilityLifecycle"
