...
object RoutingKeyNames {
    ...
    const val NON_SOURCEABILITY_CREATED = "nonSourceabilityCreated"
    const val NON_SOURCEABILITY_AUTO_ACCEPTED = "nonSourceabilityAutoAccepted"
    const val NON_SOURCEABILITY_QA_ACCEPTED = "nonSourceabilityQaAccepted"
    const val NON_SOURCEABILITY_QA_REJECTED = "nonSourceabilityQaRejected"
