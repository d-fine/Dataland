...
ssh -L 6789:localhost:6789 -L 5433:localhost:5433 -L 5434:localhost:5434 -L 5435:localhost:5435 -L 5436:localhost:5436 -L 5437:localhost:5437 -L 5438:localhost:5438 -L 5439:localhost:5439 -N -f ubuntu@"$TARGETSERVER_URL"
