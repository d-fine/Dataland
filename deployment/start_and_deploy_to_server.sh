...
ssh ubuntu@$target_server_url "cd $location; sudo docker-compose pull; sudo docker-compose --profile $profile up -d --build; export REALDATA=$realdata; export REAL_TEASER_COMPANY_PERM_ID=$REAL_TEASER_COMPANY_PERM_ID;"
