...
/**
 * Basic configuration for the OpenAPI Swagger-UI available at /accounting/swagger-ui/index.html
 */
@OpenAPIDefinition(
    info =
        Info(
            title = "Dataland acounting service API documentation",
            version = "1.0.0",
        ),
    servers = [Server(url = "/accounting")],
)
@SecurityScheme(
