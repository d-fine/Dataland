...
sealed class DatalandAuthentication : Authentication {
  companion object {
    /**
     * Builds a new DatalandAuthentication object from the Spring Boot Authentication linked to the
     * current thread. Throws an exception if no authentication data can be retrieved
     */
