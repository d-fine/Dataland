...
tasks.register("generateQaServiceClient", org.openapitools.generator.gradle.plugin.tasks.GenerateTask::class) {
    ...
    outputDir.set("${layout.buildDirectory}/clients/qa-service")
...
tasks.register("generateDocumentManagerClient", org.openapitools.generator.gradle.plugin.tasks.GenerateTask::class) {
    ...
    outputDir.set("${layout.buildDirectory}/clients/document-manager")
...
tasks.register("generateCommunityManagerClient", org.openapitools.generator.gradle.plugin.tasks.GenerateTask::class) {
    ...
    outputDir.set("${layout.buildDirectory}/clients/community-manager")
...
sourceSets {
    ...
    main.kotlin.srcDir("${layout.buildDirectory}/clients/document-manager/src/main/kotlin")
    main.kotlin.srcDir("${layout.buildDirectory}/clients/qa-service/src/main/kotlin")
    main.kotlin.srcDir("${layout.buildDirectory}/clients/community-manager/src/main/kotlin")
}
