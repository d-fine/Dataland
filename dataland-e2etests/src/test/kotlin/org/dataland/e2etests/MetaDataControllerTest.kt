...
class MetaDataControllerTest {
    ...
    @Test
    fun `post companies and eu taxonomy data and check search for meta info with empty filters`() {
    ...
    @Test
    fun `post companies and eu taxonomy data and check search for meta info with filter on company ID`() {
    ...
    @Test
    fun `post companies and eu taxonomy data and check search for meta info with filter on data type`() {
    ...
    @Test
    fun `post companies and eu taxonomy data and check search for meta info with filters on company ID and data type`() {
