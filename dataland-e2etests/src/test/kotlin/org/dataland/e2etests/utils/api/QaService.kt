...
import org.dataland.datalandqaservice.openApiClient.api.DatasetJudgementControllerApi
...
object QaService {
    ...
    val datasetJudgementControllerApi = DatasetJudgementControllerApi(BASE_PATH_TO_QA_SERVICE)
}
