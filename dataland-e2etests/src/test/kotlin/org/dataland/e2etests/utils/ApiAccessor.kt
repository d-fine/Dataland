...
class ApiAccessor {
    ...
    private fun uploadForDataType(
        ...
        return when (dataType) {
            ...
            DataTypeEnum.newMinusEutaxonomyMinusNonMinusFinancials -> uploadCompanyAndFrameworkDataForOneFramework(
                listOfCompanyInformation = listOfCompanyInformation,
                listOfFrameworkData = testDataProviderForNewEuTaxonomyDataForNonFinancials
                    .getTData(numberOfDataSetsPerCompany),
