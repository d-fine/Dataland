...
class UnauthorizedMetaDataControllerApi {
  ...
  private fun transferJsonToListOfDataMetaInformation(
    inputString: String
  ...
  private fun buildGetDataMetaInfoRequest(dataId: String): Request {
    return Request.Builder().url("$BASE_PATH_TO_DATALAND_BACKEND/metadata/$dataId").get().build()
  }
