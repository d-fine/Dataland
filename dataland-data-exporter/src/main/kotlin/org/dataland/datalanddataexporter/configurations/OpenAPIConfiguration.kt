...
/**
 * Basic configuration for the OpenAPI Swagger-UI available at /data-exporter/swagger-ui/index.html
 */
@OpenAPIDefinition(
    info = Info(
        title = "Dataland Data Exporter API documentation",
        version = "1.0.0",
    ),
    servers = [Server(url = "/data-exporter")],
)
@SecurityScheme(
