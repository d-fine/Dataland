...
/** Basic configuration for the OpenAPI Swagger-UI available at /api-keys/swagger-ui/index.html */
@OpenAPIDefinition(
  info = Info(title = "Dataland API key manager API documentation", version = "1.0.0"),
