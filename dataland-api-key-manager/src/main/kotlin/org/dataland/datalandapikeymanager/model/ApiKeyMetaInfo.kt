...
/**
 * --- API model --- Class for defining the meta info associated to an API key
 *
...
data class ApiKeyMetaInfo(
  @field:JsonProperty(required = false) val keycloakUserId: String? = null,
  @field:JsonProperty(required = false) val keycloakRoles: List<String>? = null,
  @field:JsonProperty(required = false) val expiryDate: Long? = null,
  @field:JsonProperty(required = false) val active: Boolean? = null,
  @field:JsonProperty(required = false) val validationMessage: String? = null,
) {
  constructor(
