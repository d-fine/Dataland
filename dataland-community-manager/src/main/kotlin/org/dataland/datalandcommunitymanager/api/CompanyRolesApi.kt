...
interface CompanyRolesApi {
  ...
  @ApiResponses(
    value = [ApiResponse(responseCode = "200", description = "Successfully assigned company role.")]
  )
  @PostMapping(
  ...
  @ApiResponses(
    value =
      [
        ApiResponse(
          responseCode = "200",
          description = "Successfully retrieved company role assignments.",
        ),
        ApiResponse(
          responseCode = "404",
  ...
  @GetMapping(produces = ["application/json"], value = ["/company-role-assignments"])
  @PreAuthorize(
  ...
  @ApiResponses(
    value = [ApiResponse(responseCode = "200", description = "Successfully removed company role.")]
  )
  @DeleteMapping(
    produces = ["application/json"],
    value = ["/company-role-assignments/{role}/{companyId}/{userId}"],
  ...
  @PostMapping(value = ["/company-ownership/{companyId}"])
  ...
  @RequestMapping(method = [RequestMethod.HEAD], value = ["/company-ownership/{companyId}"])
  fun hasCompanyAtLeastOneOwner(@PathVariable("companyId") companyId: UUID)
}
