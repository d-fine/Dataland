...
/**
 * --- Generic API model --- DTO to represent the assignment of a company role for one company to
 * one user
 *
...
data class CompanyRoleAssignment(
  @field:JsonProperty(required = true) val companyRole: CompanyRole,
  @field:JsonProperty(required = true) val companyId: String,
  @field:JsonProperty(required = true) val userId: String,
)
