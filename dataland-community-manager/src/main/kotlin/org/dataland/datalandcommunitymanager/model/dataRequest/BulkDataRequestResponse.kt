 ...
 * a bulk data request to Dataland.
 *
...
data class BulkDataRequestResponse(
  ...
  @field:JsonProperty(required = true) val acceptedCompanyIdentifiers: List<String>,
  @field:JsonProperty(required = true) val rejectedCompanyIdentifiers: List<String>,
)
