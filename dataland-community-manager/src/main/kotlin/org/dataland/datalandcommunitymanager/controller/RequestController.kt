 ...
 *
 * @param bulkDataRequestManager service for all operations concerning the processing of data
 *   requests
 */
@RestController
...
class RequestController(
  ...
  override fun postBulkDataRequest(
    ...
    return ResponseEntity.ok(bulkDataRequestManager.processBulkDataRequest(bulkDataRequest))
  }
