...
class CompanyRolesManager(
  ...
  @Autowired
  private val companyOwnershipRequestedEmailMessageSender:
    CompanyOwnershipRequestedEmailMessageSender,
  @Autowired
  private val companyOwnershipAcceptedEmailMessageSender: CompanyOwnershipAcceptedEmailMessageSender,
) {
  ...
  /**
   * Returns a list of company role assignment entities for the specified companyRole, companyId and
   * userId
   *
  ...
  /**
   * Checks whether a specified user has the defined company role for a given company. If not, an
   * exception is thrown.
   *
  ...
  /**
   * Verifies if the specified company as at least one company owner. If not, it throws an
   * exception.
   *
  ...
  private fun assertAuthenticationViaJwtToken(
    userAuthentication: DatalandAuthentication
