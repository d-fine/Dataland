...
/**
 * Received entity when doing a database query to get aggregated info about the count of existing
 * data requests on Dataland.
 *
 ...
 * @param count the count of existing data requests for this framework, identifierType and
 *   identifierValue
 */
