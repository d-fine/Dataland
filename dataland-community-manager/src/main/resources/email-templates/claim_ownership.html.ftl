...
<table style="background-color: #ffffff; width: 600px; border: 0px solid #e3e3e3; font-family: Arial, Helvetica, sans-serif; font-size: 14px; text-align: left; border-collapse: collapse; padding: 0; margin: 0"><tbody>
    <tr style="background-color: #f6f6f6;">
        <td colspan="3" height="10" width="600">
            &nbsp;
        </td>
    </tr>
    <tr style="background-color: #f6f6f6;">
    ...
    <tr>
        <td>
            <table width="520" cellpadding="0" cellspacing="0" style="background-color: #f6f6f6; border-collapse: collapse">
                <tbody>
                <tr>
                    <td rowspan="17" width="20">&nbsp;</td>
                    <td colspan="3" width="480" height="20">&nbsp;</td>
                    <td rowspan="17" width="20">&nbsp;</td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="3" height="20" style="border-bottom:1px solid #e3e3e3">&nbsp;</td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="3" height="5" style="font-size: 5px;">&nbsp;</td>
                </tr>
                <tr>
    ...
    <tr>
        <td style="font-weight: bold;">What to do now?</td>
    </tr>
    <tr>
    <tr><td colspan="3" height="5" style="font-size: 5px;">&nbsp;</td></tr>
    </tr>
    ...
    <tr>
        <td>Claiming ownership process usually requires 1-2 business days.<br />
