...
<table style="background-color: #1b1b1b; width: 600px; border: 0px solid #e3e3e3; font-family: Arial, Helvetica, sans-serif; font-size: 18px; text-align: left; border-collapse: collapse; padding: 0; margin: 0">
    <tbody>
    <tr>
        <td rowspan="13"></td>
        <td colspan="3"></td>
