  ...
  private fun mockBuildingMessageAndSendingItToQueueForExternalMails() {
    `when`(
      ...
      .then() {
        ...
        assertEquals(
          TemplateEmailMessage.EmailAddressEmailRecipient(email = "alphabet@example.com"),
          arg1.receiver,
        )
        ...
        assertEquals(
          readableFrameworkNameMapping.getValue(DataTypeEnum.p2p),
          arg1.properties.getValue("dataType"),
        )
