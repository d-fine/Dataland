...
class DataRequestQueryManagerTest {
  ...
  private fun setupMocks() {
    ...
    `when`(keycloakUserControllerApiService.getUser(keycloakUserAlpha.userId))
      .thenReturn(keycloakUserAlpha)
    `when`(keycloakUserControllerApiService.getUser(keycloakUserBeta.userId))
      .thenReturn(keycloakUserBeta)
    `when`(keycloakUserControllerApiService.searchUsers(emailAddressSubstring))
