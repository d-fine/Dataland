...
class RequestPriorityAggregatorTest {
    ...
    private val dummyAggregatedRequests =
        listOf(
            ...
            AggregatedDataRequest(DataTypeEnum.lksg, "2023", companyIdHighPriority, RequestPriority.Low, "Open", 2),
            AggregatedDataRequest(DataTypeEnum.lksg, "2023", companyIdHighPriority, RequestPriority.Baseline, "Open", 1),
            AggregatedDataRequest(DataTypeEnum.lksg, "2023", companyIdHighPriority, RequestPriority.High, "Open", 1),
            AggregatedDataRequest(DataTypeEnum.lksg, "2023", companyIdHighPriority, RequestPriority.Urgent, "Open", 0),
            AggregatedDataRequest(DataTypeEnum.lksg, "2024", companyIdVeryHighPriority, RequestPriority.Low, "Open", 2),
