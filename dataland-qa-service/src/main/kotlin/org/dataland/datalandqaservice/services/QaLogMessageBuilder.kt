...
class QaLogMessageBuilder {
   ...
   */
  fun postQaReportMessage(dataId: String, reporterUserId: String): String {
  ...
  /**
   * Generates a message to inform that a request was received to mark a QA report as active or
   * inactive
   *
