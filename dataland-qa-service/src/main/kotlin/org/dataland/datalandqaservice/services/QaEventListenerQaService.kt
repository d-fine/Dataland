...
class QaEventListenerQaService(
  ...
  private data class ForwardedQaMessage(val identifier: String, val comment: String)
  ...
  /**
   * Method to retrieve message from dataStored exchange and constructing new one for qualityAssured
   * exchange
   *
  ...
  /**
   * Method to retrieve message from dataStored exchange and constructing new one for
   * quality_Assured exchange
   *
  ...
  fun assureQualityOfDocument(
    ...
    messageUtils.validateMessageType(type, MessageType.ManualQaRequested)
    val forwardedQaMessage =
      objectMapper.readValue(messageAsJsonString, ForwardedQaMessage::class.java)
