...
/**
 * Implements a utility function that can be used e.g., in PRE_AUTHORIZE for several one
 * authentication use-case.
 */
@Service("SecurityUtilsService")
class SecurityUtilsService(@Autowired val metaDataControllerApi: MetaDataControllerApi) {
