...
class QaReportEventListenerService(
  ...
  /**
   * Method that listens to the Request Received queue for potential data deletion messages and
   * deletes the corresponding QA reports accordingly
   *
  ...
  fun distributeIncomingRequests(
    ...
    logger.info(
      "Deleting all QA Reports associated with data id $dataId. CorrelationId: $correlationId"
    )
