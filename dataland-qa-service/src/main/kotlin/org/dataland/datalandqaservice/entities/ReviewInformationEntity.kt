...
data class ReviewInformationEntity(
  ...
  /**
   * Converts the ReviewInformationEntity into a ReviewInformationResponse that is used in a
   * response for a GET Request. The ReviewInformationResponse can optionally hide the
   * reviewerKeycloakId by setting showReviewerKeycloakId to false.
   */
