...
data class QaReportEntity(
  @Id @Column(name = "qa_report_id") val qaReportId: String,
  @Column(name = "qa_report", columnDefinition = "TEXT", nullable = false) var qaReport: String,
  @Column(name = "data_id", nullable = false) var dataId: String,
  @Column(name = "data_type", nullable = false) var dataType: String,
  @Column(name = "reporter_user_id", nullable = false) var reporterUserId: String,
  @Column(name = "upload_time", nullable = false) var uploadTime: Long,
  @Column(name = "active", nullable = false) var active: Boolean,
) {

  /**
   * Method to convert the QA report entity to a model containing the report and its meta
   * information
   *
  ...
  fun <ReportType> toFullApiModel(
    ...
    return QaReportWithMetaInformation(metaInfo = toMetaInformationApiModel(), report = report)
  }

  /**
   * Method to convert the QA report entity to a model containing only the meta information of the
   * report
   */
