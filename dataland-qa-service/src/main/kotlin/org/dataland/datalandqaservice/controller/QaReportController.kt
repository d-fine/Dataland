...
open class QaReportController<QaReportType>(
  ...
  override fun setQaReportStatus(
    ...
    val user = DatalandAuthentication.fromContext()
    logger.info(
      qaLogMessageBuilder.requestChangeQaReportStatus(qaReportId, dataId, statusPatch.active)
    )
  ...
  override fun getAllQaReportsForDataset(
    ...
    val apiModel = reportEntities.map { it.toFullApiModel(objectMapper, clazz) }
