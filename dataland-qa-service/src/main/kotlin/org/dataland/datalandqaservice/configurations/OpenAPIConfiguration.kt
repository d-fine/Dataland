...
/** Basic configuration for the OpenAPI Swagger-UI available at /qa/swagger-ui/index.html */
@OpenAPIDefinition(
  info = Info(title = "Dataland QA Service API documentation", version = "1.0.0"),
