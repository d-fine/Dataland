...
/**
 * --- API model --- QA report and the associated meta information
 *
...
data class QaReportWithMetaInformation<QaReportType>(
  @field:JsonProperty(required = true) val metaInfo: QaReportMetaInformation,
  @field:JsonProperty(required = true) val report: QaReportType,
)
