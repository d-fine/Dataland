 ...
 * @property isDataPointEligible `true` if the data point type is not excluded from automatic pre-approval.
...
data class PreApprovalCheckResults(
    ...
    val isDataPointEligible: Boolean,
     ...
     */
    fun passes(): Boolean = areAllQaReportsAccepted && passesRandomSampling && isDataPointEligible && passesSignificanceCheck
}
