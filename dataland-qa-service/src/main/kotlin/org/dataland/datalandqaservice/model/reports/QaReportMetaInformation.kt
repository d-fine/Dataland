...
/**
 * --- API model --- Meta information associated to a QA report in the QA data storage
 *
...
data class QaReportMetaInformation(
  ...
  @field:JsonProperty(required = true) val qaReportId: String,
  @field:JsonProperty() val reporterUserId: String?,
  @field:JsonProperty(required = true) val uploadTime: Long,
  @field:JsonProperty(required = true) val active: Boolean,
)
