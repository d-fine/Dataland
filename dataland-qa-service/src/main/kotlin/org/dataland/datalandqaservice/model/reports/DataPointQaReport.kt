 ...
 * @param dataPointId unique identifier to identify the data the report is associated with
 * @param dataPointType unique identifier to identify the data point the report is associated with
