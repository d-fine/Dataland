 ...
 * @param dataPointSchemaId The unique identifier of the data point type specification.
...
data class DataPointSpecification(
    ...
    fun validateIntegrity(database: SpecificationDatabase) {
        ...
        require(database.dataPointSchemas.containsKey(dataPointSchemaId)) {
